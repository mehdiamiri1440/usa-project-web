        ...
        <section class="parallax-section policy">
            ...
            <div class="container">
                <div class="  col-md-12 col-sm-12">
                    ...
                    <p class="text-right">باسکول، بستر تجاری آنلاین است که از طریق آن هر کاربر ثبت شده می تواند
                ...
                <div class=" col-md-12 col-sm-12">
                    ...
                    <p class="text-right">چت باسکول یک فضای ارتباطی عمومی بین اعضای باسکول است که با هدف تسهیل
                        ارتباط و معاملات ارائه شده‌ است. هرگونه استفاده از چت باسکول به معنی پذیرفتن ضوابط و شرایط
                        ذیل است:
                    </p>
                    <ul class="text-right">
                        <li> مکاتبات کاربران از طریق چت باسکول باید مربوط به آگهی خاص و در خصوص ارائه و یا دریافت
                            کالا و خدمات مورد اشاره باشد و استفاده از آن بابت مقاصد دیگر از جمله ارتباطات خصوصی مجاز
                            نیست.
                        </li>
                        <li> استفاده از چت باسکول صرفاً باید مربوط به معاملات باشد و باسکول ممکن است برای ایجاد
                        ...
                        <li> تعلیق شدن یا مسدود شدن کاربر به فراخور تخلف صورت گرفته و به تشخیص کارشناسان باسکول
                            صورت می‌گیرد.
                        </li>
                        ...
                        <li> هم‌چنین توصیه همیشگی باسکول به کاربران این است که از ارسال اطلاعات شخصی و خصوصی خود
                            که برای انجام معامله غیرضروری هستند، خودداری کنید.
                        </li>
                        <li> در صورتی که کاربری، شما را مسدود نموده و یا آگهی خود را از باسکول حذف نماید، اطلاعات
