              ...
              <li v-for="(buyAd, index) in buyAds" :key="index">
                      ...
                      <div class="buyer-text">
                        <div>
                          ...
                          <span
                            ...
                            v-else
                            v-text="
                              getConvertedNumbers(buyAd.requirement_amount)
                            "
                          ></span>
                ...
                <div v-else>
                  ...
                  <div class="buyAd-wrapper-item col-xs-12">
                    ...
                    <p
                      class="list-time col-sm-3 col-xs-12 text-center"
                      v-text="buyAd.register_date"
                    ></p>
          ...
          <div class="col-xs-12 wrapper-items" v-else-if="load">
            <ul class="list-unstyled">
              ...
              >
                ...
                <p
                  class="needs col-sm-4 col-xs-12 hidden-md hidden-lg hidden-sm"
                >
                  <span
                    class="
                      placeholder-content
