                    ...
                    <div class="  col-md-12 col-sm-12">
                        ...
                        <div class="  col-md-12 col-sm-12">
                            ...
                            <h3 class="text-center">
                                <router-link :to="{name : 'register'}" class="green-button"> هم اکنون عضو جامعه باسکول شوید
                                </router-link>
                            </h3>
                            <p>
                            ...
                            <div class="container about-us-icons">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-3">
                                        ...
                                        <p> عضوی از جامعه باسکول باشید، با اطلاع از آخرین تغییرات بازار، با قیمت و
                            ...
                            <h3 class="text-center">
                                <router-link :to="{name : 'help'}" class="green-button"> باسکول چگونه کار میکند؟
                                </router-link>
                            </h3>
                            <p class="text-right">
