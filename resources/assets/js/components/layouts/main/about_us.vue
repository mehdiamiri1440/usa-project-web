          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="col-md-12 col-sm-12">
              <p class="text-right">
                ...
                نمایشگاه های داخلی و بین المللی حوزه محصولات کشاورزی و سابقه ی
                حضور در بازار صادرات ایران شاهد مشکلات عدیده‌ای از قبیل : عدم
                دسترسی مناسب به محصولات با کیفیت، فقدان شبکه دسترسی برای
              ...
              <p>
                ...
                خریداران محصولات کشاورزی به یکدیگر جزم کرده ایم و تا زمانی که
                این هدف محقق نشود دست از تلاش شبانه روزی خود بر نخواهیم داشت.
              </p>
              <br />
              <h3 class="text-right">ارزش های باسکول برای فروشندگان</h3>
              <br />
              <ul class="text-right">
                <li>
                ...
                <li>با خریداران نام آشنا و معتبر معامله کنید.</li>
                <li>محصولات خود را به خریداران در سراسر ایران معرفی کنید.</li>
                <li>
              ...
              <br />
              <h3 class="text-right">ارزش های باسکول برای خریداران</h3>
              <br />
              <ul class="text-right">
                <li>
              ...
              <h3 class="text-center">
                <router-link :to="{ name: 'register' }" class="green-button"
                  >هم اکنون عضو جامعه باسکول شوید</router-link
                >
              </h3>
              <p></p>
              <br />
              <div class="container about-us-icons">
                <div class="row">
                  <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="about-us-icon">
                      <img src="../../../../img/about-us/1.jpg" alt />
                    </div>
                    <p>با خریداران نام آشنا و معتبر معامله کنید.</p>
                  </div>
                  <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="about-us-icon">
                      <img src="../../../../img/about-us/2.jpg" alt />
                    </div>
                    <p>محصولات خود را به خریداران در سراسر ایران معرفی کنید.</p>
                  </div>
                  <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="about-us-icon">
                  ...
                  <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="about-us-icon">
                      <img src="../../../../img/about-us/6.jpg" alt />
                    </div>
                    <p>
              ...
              <h3 class="text-center">
                <router-link :to="{ name: 'help' }" class="green-button"
                  >باسکول چگونه کار میکند؟</router-link
                >
              </h3>
              <p class="text-right">
