                    ...
                    <div id="accordion" role="tablist" aria-multiselectable="true" class="panel-group">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFirst" role="tabpanel" aria-labelledby="headingFirst"
                                ...
                                <div class="panel-body">
                                    <p>
                                        اینکوباک خدمات دسترسی به خریداران و فروشندگان مختلف، درخواست خرید و اطلاع از قیمت های بازار را به خریداران وتامین کنندگان ارائه میدهد.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo"
                                ...
                                <div class="panel-body">
                                    <p>
                                        در سامانه اینکوباک کشاورزان، باغداران، گلخانه داران، صاحبان سالن های سورت، بسته بندی و سردخانه بعنوان فروشنده می توانند ایفای نقش کنند. اینکوباک به فروشندگان جهت فروش بهینه و بدون واسطه کمک میکند. فروشندگان می توانند در سامانه اینکوباک، پروفایل شخصی خود را بسازند و محصولات خود را نیز ثبت کنند تا از این طریق به خریداران گسترده ای در سراسر کشور دست پیدا کنند.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFour" role="tabpanel" aria-labelledby="headingFour"
                                ...
                                <div class="panel-body">
                                    <ul>
                                        <li>ابتدا به سایت incobac.com مراجعه کرده و جهت ثبت نام دکمه ورود به سامانه یا <a href="/login" target="_blank">ورود/ثبت نام</a> کلیک کنید</li>
                                        <li>سپس در صفحه ورود روی دکمه ی <a href="/register" target="_blank">ثبت نام</a> کلیک کنید.</li>
                                        <li><p>
                            ...
                            <div id="collapseFive" role="tabpanel" aria-labelledby="headingFive"
                                ...
                                <div class="panel-body">
                                    <ul>
                                        ...
                                        <li>
                                            <p>
                                                درصورتی که تاکنون اطلاعات پروفایل خود را ارسال نکرده اید در قسمت ویرایش پروفایل موارد خواسته شده را پر کنید و ارسال نمایید. سپس منتظر تایید اطلاعات خود از سمت ناظران اینکوباک باشید.
                                            </p>
                                            ...
                                            <br/><br/>
                                            <div class="mobile-image">
                                                <img :src="img_mobile_6_3_help_page">
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            محصول شما پس از تایید ناظران اینکوباک در صفحه ی <a href="/product-list" target="_blank">لیست محصولات</a> نمایش داده می شود و خریداران میتوانند درخواست های خرید خود را برای شما ارسال کنند.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <br/><br/>
                                            <div class="mobile-image">
                                                <img :src="img_mobile_11_5_help_page">
                                            </div>
                                        </li>
                                        <li>
                                            <p>
                                            ...
                                            <img :src="img_12_help_page">
                                            <br/><br/>
                                            <div class="mobile-image">
                                                <img :src="img_mobile_12_help_page">
                                            </div>
                                        </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseEight" role="tabpanel" aria-labelledby="headingEight"
                                ...
                                <div class="panel-body">
                                    <p>
                                        خریداران و فروشندگان عزیز می توانند از طریق پیام رسان تجاری اینکوباک در هر لحظه (بدون ایجاد مزاحمت در اثر تعداد زیاد تماس) با یکدیگر ارتباط برقرار کنند، به صورت روزانه استعلام قیمت بگیرند و در صورت صلاح دید نسبت به برقراری تماس تلفنی اقدام کنند.
                                    </p>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSeven" role="tabpanel" aria-labelledby="headingSeven"
                                ...
                                <div class="panel-body">
                                    <p>
                                        عضویت در سامانه اینکوباک و استفاده از خدمات سیستمی سامانه اینکوباک (ساخت پروفایل، ثبت محصول، ثبت درخواست خرید و استعلام قیمت) در پکیج نوع اول رایگان است و برای ارتقای جایگاه خود، افزایش تعداد مشتریان و فروش خود میتوانید از دیگر پکیج های اینکوباک استفاده نمایید.
                                    </p>
                                </div>
                            </div>
                        </div>
