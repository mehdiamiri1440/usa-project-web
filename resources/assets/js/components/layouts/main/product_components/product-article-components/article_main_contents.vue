<style scoped>
    ...
    .main-article-contents h1, .main-article-contents h3 {
        font-size: 16px;
    ...
    @media screen and (max-width: 340px) {
        ...
        .main-article-contents-image-wrapper, .main-article-contents, .main-article-contents > a{
    ...
    <div class="main-article-contents-wrapper"
        ...
        <div class="main-article-contents">
                    ...
                    <svg width="24.965" height="30.574" viewBox="0 0 24.965 30.574">
                        <g id="incobac-icon" data-name="incobac" transform="translate(-273.1 -715.025)">
                            <path id="Subtraction_1" data-name="Subtraction 1"
                                  ...
                                  transform="translate(2237.1 709.808)" fill="#fff"/>
            ...
            <a :href="$parent.productUrl" @click="$parent.registerComponentStatistics('product',
                ...
                <h3 v-else class="article-title" v-html="getProductName()">
