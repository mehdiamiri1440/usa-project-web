...
@media screen and (max-width: 991px) {
  ...
  .wrapper-item, .default-square-item{
    border-radius: 0;
    box-shadow: none;
  }
  ...
  <div>
    ...
    <main id="main" class="container">
      <div class="row">
        ...
        <div v-for="item in 3" class="category-item col-xs-6 col-sm-4 col-md-3 pull-right">
          
         <div  class="wrapper-item" style="background-image : url('http://localhost:8000/assets/img/product.jpg')">
        ...
        <div v-for="item in 6" class="category-item col-xs-6 col-sm-4 col-md-3 pull-right">
