      ...
      <div class="row">
        <div class="radio-wrapper">
          ...
          <p class="error-message">
            <span
              v-if="$parent.errors.activityType"
              v-text="$parent.errors.activityType"
            ></span>
          </p>
        </div>
        <div class="row">
          <div class="col-xs-12 pull-right">
            ...
            <div class="input-wrapper activity-domain-wrapper">
              ...
              >
                ...
                <option
                  ...
                  :selected="$parent.step6.categoryId == category.id"
                ></option>
              </select>
            </div>
            ...
            <p class="error-message">
              <span
                v-if="$parent.errors.categoryId"
                v-text="$parent.errors.categoryId"
              ></span>
            </p>
          </div>
        </div>
        <div class="step-action text-left">
          <button
            ...
            :class="{
              active:
                !$parent.errors.activityType &&
                !$parent.errors.categoryId &&
                activityType &&
                categoryId,
            }"
  ...
  watch: {
    ...
    categoryId(categoryId) {
      if (categoryId == "") {
        ...
        this.$parent.step6.categoryId = categoryId;
        this.$parent.errors.categoryId = "";
      }
    },
  },
