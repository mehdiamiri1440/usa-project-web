...
<template>
  <div class="text-rtl from-wrapper">
    <form class="form-contents col-xs-12">
      <div class="row">
        <div class="row">
          <div class="col-xs-12 col-sm-6 pull-right">
            <label for="user-name">
              نام خود را وارد کنید<span class="red-text">*</span></label
            >
            <div class="input-wrapper user-information-wrapper">
              <input
                v-model="$parent.step3.name"
                :class="{
                  error: $parent.errors.name,
                  active: $parent.step3.name,
                }"
          ...
          <div class="col-xs-12 col-sm-6 pull-right">
            <label for="user-family">
              نام خانوادگی خود را وارد کنید<span class="red-text"
                >*</span
              ></label
            >
            <div class="input-wrapper user-information-wrapper">
              <input
                v-model="$parent.step3.family"
                :class="{
                  error: $parent.errors.family,
                  active: $parent.step3.family,
                }"
                id="user-family"
                type="text"
              ...
              <i
                class="fa fa-check-circle"
                v-if="$parent.step3.family && !$parent.errors.family"
              ></i>
              <i
        ...
        <div class="row">
          <div class="select-wrapper province-wrapper col-xs-6 pull-right">
            ...
            >
            <select
              @change="$parent.setProvince($event)"
              :class="{
          ...
          <div class="select-wrapper province-wrapper col-xs-6">
            ...
            >
            <select
              @change="$parent.setCity($event)"
              :class="{
                error: $parent.errors.city,
                active: $parent.step3.city,
              }"
              id="city"
            >
          ...
          <div class="row">
            ...
            <div class="radio-wrapper text-center">
              <div class="label-radio">
                <input
                  type="radio"
                  v-model="$parent.step3.activity_type"
                  value="0"
        ...
        <div class="col-xs-12 step-action text-center">
          <button
            ...
            :class="{
              active:
                ...
                !$parent.errors.province &&
                !$parent.errors.city &&
                $parent.step3.family &&
                $parent.step3.name &&
                $parent.step3.activity_type,
            }"
            @click.prevent="$parent.submitUserInformation()"
          >
            ثبت نام
          </button>
        </div>
