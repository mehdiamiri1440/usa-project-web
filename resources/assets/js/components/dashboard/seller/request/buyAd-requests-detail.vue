<style scoped>
    ...
    @media screen and (max-width: 768px) {
        ...
        #bd-prev-end-date-id, #bd-prev-first-date-id  {
            left: 0;
            bottom: inherit;
            top:-55px;
        }

        #bd-next-end-date-id , #bd-next-first-date-id{
            right: 0;
            bottom: inherit;
            top:-55px;
        }
                    ...
                    <form>
                        ...
                        <div class="fields col-xs-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="javascript:history.back()" class="black-bot col-xs-12 col-xs-6">بازگشت به صفحه قبل</a>
                            </div>
