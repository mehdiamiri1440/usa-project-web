                ...
                <div v-if="msg == ''">
                    <div class="contents col-xs-12">
                        ...
                        <p id="step1S12" v-if="pageStep == 12">
                            ...
                            <span v-if="transactionInfo.commission_persentage"><b> کمسیون باسکول برابر <span class="text-danger">{{transactionInfo.commission_persentage}}</span> درصد است.</b></span>
                            <span v-if="transactionInfo.commission_percentage"><b> کمسیون باسکول برابر <span class="text-danger">{{transactionInfo.commission_percentage}}</span>درصد است.</b></span><br/><br/>
