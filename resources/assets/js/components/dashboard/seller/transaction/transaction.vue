  ...
  <div>
    <section class="main-content col-xs-12" v-if="transactionInfo">
      ...
      <div id="step2" v-if="currentStep == 2">
        ...
        <div class="alert-message" v-if="msg == ''">
          <div class="alert-danger col-xs-12">بارگیری محصول را با شرایط زیر انجام دهید</div>
          <div class="contents col-xs-12">
            <div class="content-show">
              <p class="title-p">توضیحات باسکول</p>
              <p style="white-space:pre-wrap">{{transactionInfo.admin_notes}}</p>
              <p class="title-p">توضیحات خریدار</p>
              <p style="white-space:pre-wrap">{{transactionInfo.description}}</p>
            </div>
          </div>
        </div>
        <div class="alert-message" v-else>{{msg}}</div>
      ...
      <div id="step3" v-if="currentStep == 3">
        ...
        <div class="text-right alert-message">لطفا منتظر پرداخت طلبتان از سمت ما باشید.</div>
      </div>
      <!--end part 3-->
