  ...
  <section class="main-content col-xs-12">
    <form action="#" method="post" enctype="multipart/form-data">
      <div class="company_des col-xs-12">
        <label for="description"> شرح فعالیت من | شرکت: </label>
      ...
      <div class="image_company col-xs-12">
        <div class="col-xs-12 col-sm-6">
          <label> تصاویر مربوطه <span>(محصولات | شرکت | کارکنان)</span> </label>

          <div class="row">
            <div class="images-content col-xs-12">
              <article
                class="image-item col-xs-4"
        ...
        <div class="col-xs-12 col-sm-6">
          <label>
            افزودن تصاویر مربوطه <span>(محصولات | شرکت | کارکنان)</span>
          </label>
          <UploadFile
      ...
      <div class="image-certificates col-xs-12">
        <div class="col-xs-12 col-sm-6">
          <label>
            ...
            <span>(گواهی های ثبت شرکت | گواهی های استاندارد محصول)</span>
          </label>
      ...
      <input
        ...
        value="ثبت تغییرات"
        type="button"
        @click="RegisterComplementaryProfileInfo"
      />
    </form>
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    RegisterComplementaryProfileInfo: function () {
      ...
      if (
        this.currentUser.profile.is_company == null ||
        this.currentUser.profile.public_phone == null
      ) {
      ...
      axios
        .post("/user/profile_modification", formData, {
          headers: {
