            ...
            <div class="item-content-wrapper">
              <div class="content-wrapper">
                <p class="header-title">
                  ...
                  <span>چرا ارتقا عضویت؟</span>
                </p>
                <p>
                  فروشندگان ویژه به
                  <span class="green-text"> خریداران واقعی بیشتری </span>
                  دسترسی دارند.
                </p>
              </div>
            </div>
