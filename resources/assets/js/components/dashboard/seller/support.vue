...
.support-wrapper > div.shadow-content {
  border-radius: 8px;
  padding: 60px 15px;
}

.support-wrapper > div.shadow-content h3 {
  margin: 20px 0 30px;
  line-height: 1.618;
}

.support-wrapper > div.shadow-content h4 {
  margin-bottom: 18px;
  color: #21ad93;
  letter-spacing: 2px;
}
...
<template>
  <section class="main-content col-xs-12">
    <div class="support-wrapper">
      <div class="bg-white shadow-content">
        <div class="buskool-icon">
          <svg
        ...
        <h3>شماره تماس های پشتیبانی باسکول</h3>
        <h4><i class="fa fa-phone"></i> 09178928266</h4>
        <h4><i class="fa fa-phone"></i> ‌09118413054</h4>
      </div>
    </div>
  </section>
</template>
