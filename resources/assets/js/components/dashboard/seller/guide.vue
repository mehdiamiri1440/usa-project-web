        ...
        <li class="title_list_help">
          ...
          <ol class="list-group">
            ...
            <li>
              ...
              <router-link :to="{name : 'profileBasicSeller'}">ویرایش پروفایل</router-link>نسبت به تکمیل و به روز رسانی پروفایل خود اقدام کنید.
            </li>
            <li>
              به قسمت
              <router-link :to="{name : 'registerProductSeller'}">ثبت محصول</router-link>رفته و اطلاعات محصولات خود را بصورت کامل پر کنید. این محصولات بهمراه
              جزییات در صفحه پروفایل شخصی شما به خریداران نمایش داده می شود.
            </li>
            <li>
              پیشنهاد های خرید از سوی خریداران را میتوانید در قسمت
              <router-link :to="{name : 'buyAdRequestsSeller'}">درخواست ها</router-link>مشاهده کنیدو در صورت داشتن آمادگی جهت تامین محصول، قیمت پیشنهادی،
            ...
            <li>
              ...
              <router-link :to="{name : 'messagesSeller'}">پیام ها</router-link>قرار دارد.
            </li>
