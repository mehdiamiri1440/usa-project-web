...
.image-upload-wrapper .edit-image {
  border-radius: 12px;
  overflow: hidden;
}
        ...
        >
          <div class="image">
            ...
            <div class="actions-content">
              ...
              <a class="delete" href="#" @click.prevent="$refs.upload.remove(file)">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <a href="#" @click.prevent="editFile.show = false" data-dismis class="close-modal">
          ...
          <div class="col-xs-12">
            <div class="modal-footer">
              <div class="col-xs-12 col-sm-6 pull-right">
                <button @click.prevent="onEditorFile" type="submit" class="btn btn-crop">برش تصویر</button>
              </div>
...
export default {
  ...
  methods: {
    ...
    inputFile(newFile, oldFile) {
      if (newFile && oldFile) {
        ...
        if (newFile.active && !oldFile.active) {
          this.uploadRef.push(
            this.$refs.upload.files[this.uploadRef.length].file
          );
    ...
    onEditorFile() {
      ...
      for (var i = 0; i < this.uploadRef.length; i++) {
        if (
          this.uploadRef[i].name == data.file.name &&
          this.uploadRef[i].size == this.uploadRef[i].size
        ) {
          this.uploadRef.splice(i, 1);
        }
      }
