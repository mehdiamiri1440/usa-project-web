		 ...
		 <div class="form-contents ">
			    	...
			    	<div class=" col-xs-12 ">
				     	...
				     	<div class="text-input-wrapper  ">
				     		...
				     		<p>
                                خریدار محترم برای اطلاع از آخرین قیمت محصولات و پیداکردن محصول مناسب، علاوه بر جستوجو در <br/><a href="/product-list"> لیست محصولات </a><br/>میتوانید درخواست خرید خود را در اینجا ثبت کنید تا کشاورزان و تامین کنندگان اینکوباک به شما پاسخ دهند.
				     			<br/>
				     			<br/>
