            ...
            <div class="contents col-xs-12">
                ...
                <h2>قرارداد همکاری در خرید و فروش</h2>
                        <p id="step1S1" v-if="pageStep == 1">
                            ...
                            <span>1-1 طرف اول: شرکت سهامی خاص فناوران توسعه تجارت ارم به شماره ثبت 49233 که از این پس باسکول نامیده میشود.</span><br/>
                            ...
                            <span>2-1 تنظیم همکاری و روابط قراردادی طرفین در خصوص همکاری باسکول با خریدار و فروشنده جهت خرید و فروش کالا و محصولات فروشنده از طریق ارائه این محصولات در وبسایت ایجاد شده توسط باسکول به نشانی buskool.com. بدیهی است با توجه به اینکه مالکیت محصولات ارائه شده در سایت متعلق به باسکول نبوده و باسکول صرفاً ارائه دهنده بستر اینترنتی جهت فروش محصولات فوق می باشد لذا مسئولیت کلیه اوصاف محصول اعم از نوع، بسته بندی، قیمت و هرگونه اطلاعات ذکر شده در رابطه با محصول بر عهده فروشنده است.

                            </span><br/><br/>
                            <span>2-2 باسکول بر اساس اطلاعات ذکر شده در سایت اقدام به صدور فاکتور برای خریدار می نماید که این فاکتور در اختیار خریدار قرار می گیرد و مبنای رسیدگی به کلیه اختلافات حاصله  قرارداد حاضر و فاکتور مذکور می باشد.</span><br/><br/>
                            <span>2-3 با توجه به شرایط خاص هر معامله، هزینه های مربوط به حمل و نقل و بیمه کالاهای مورد معامله ممکن است بر عهده خریدار یا فروشنده قرار گیرد که این امر در قرارداد حاضر قید و مورد تایید طرف متعهد قرار می گیرد در هر صورت باسکول نسبت به هزینه های فوق الذکر از خود سلب مسئولیت می‌نماید.
                            </span><br/><br/>

                            <span><b>ماده 3 :مکانیسم اجرایی عملیات خرید و فروش</b></span><br/><br/>
                            <span>3-1 خریدار و فروشنده با پذیرش قرارداد حاضر می توانند از بستر اینترنتی ارائه شده توسط طرف اول (پلتفرم باسکول) جهت سفارش و ارائه محصولات استفاده نمایند.
                            </span><br/>

                        </p>
                        <p id="step1S2" v-if="pageStep == 2">
                            <span>3-2 خریدار درخواست خود را از طریق سفارش کالا به صورت الکترونیکی برای باسکول ارسال و باسکول تقاضای خرید خریدار را از طریق ایمیل یا seller center به فروشندگان مرتبط اعلام می نماید.
                            </span><br/><br/>
                            ...
                            <span>3-5 پس از تایید قرارداد توسط خریدار و فروشنده، فاکتور پیش پرداخت توسط باسکول برای خریدار صادر گردیده و خریدار بایستی ظرف مدت یک روز نسبت به پرداخت آن اقدام نماید.
                            </span><br/><br/>
                        ...
                        <p id="step1S3" v-if="pageStep == 3">
                            ...
                            <span>تبصره - باسکول زیرساخت و ابزار ساخت محتوا را به صورت رایگان در اختیار فروشندگان قرار می دهد.
                            </span><br/><br/>
                        ...
                        <p id="step1S6" v-if="pageStep == 6">
                            ...
                            <span>6-2 باسکول خدمات بازرسی محصولات را از طریق ارائه کارشناس کیفیت محصول قبل از بارگیری کالا ارائه می نماید، بدین شرح که لیست آیتم ها و اوصاف و شرایطی که بایستی توسط بازرس باسکول مورد بررسی قرار گیرد به صورت احصایی و متناسب با هر معامله در قرارداد مربوط به آن معامله قید می‌گردد.</span><br/><br/>
                            <span>6-3 باسکول نسبت به تطابق اوصاف ذکر شده در بند فوق مشترکاً همراه با فروشنده مطابق بند 4-6 مسئول می باشد و نسبت به سایر اوصاف و شرایط هیچ گونه مسئولیتی نداشته و چنانچه خسارتی حادث گردد فروشنده مسئول می باشد.</span><br/><br/>
                            <span>6-4 باسکول موظف به مدیریت و انتخاب فضا و ظاهر وب سایت می باشد.</span><br/><br/>
                            <span>6-5 باسکول متعهد می گردد جهت مدیریت موجودی و بهای کالا در سایت باسکول پنل نرم افزاری seller center را در اختیار فروشنده قرار دهد و همچنین آموزش های مربوطه را به فروشنده ارائه نماید .
                            </span><br/><br/>
                            <span>6-6 باسکول در خصوص حمل و نقل و بیمه کالای مورد معامله هیچ گونه مسئولیت و تعهدی ندارد. </span><br/><br/>
                            <span><b>ماده 7. کمیسیون دریافتی از فروشنده</b></span><br/><br/>
                            <span>7-1 کمیسیون باسکول معادل ریالی و درصدی معین از مبلغ کل معامله طبق پیوست قرارداد می باشد. کمیسیون پیش از احتساب مالیات بر ارزش افزوده کالا محاسبه می گردد.
                            </span><br/><br/>
                            <span>7-2 مبلغ کمیسیون باسکول مشمول قانون مالیات بر ارزش افزوده می باشد که مبلغ آن به صورت حساب های اضافه واریز شده و دریافت می گردد.</span><br/><br/>
                        </p>
                        <p id="step1S7" v-if="pageStep == 7">
                            ...
                            <span>7-4 مسئولیت دریافت وجه سفارشات از خریداران بر عهده باسکول می باشد.</span><br/><br/>
                            <span>7-5 باسکول حداکثر تا هفت روز کاری بهای محصولات فروش رفته را (به غیر از سفارشات عودت داده شده یا سفارشات مورد شکایت و در حال بررسی) که از خریدار دریافت کرده پس از کسر کمیسیون و سایر هزینه ها و مبالغ ذکر شده در قرارداد و پس از محاسبه به فروشنده پرداخت خواهد نمود.
                            </span><br/><br/>
                            ...
                            <span>8-1حق الزحمه باسکول معادل ریالی و درصدی معین از مبلغ کل معامله طبق فاکتورهای قرارداد می باشد. حق الزحمه پیش از احتساب مالیات بر ارزش افزوده کالا محاسبه می گردد.
                            </span><br/><br/>
                            <span>8-2 مسئولیت دریافت وجه سفارشات از خریداران بر عهده باسکول می باشد.
                            </span><br/><br/>
                            <span>8-3 باسکول حداکثر تا هفت روز کاری بهای محصولات فروش رفته را (به غیر از سفارشات عودت داده شده یا سفارشات مورد شکایت و بررسی) که از خریدار دریافت کرده پس از کسر کمیسیون و سایر هزینه ها و مبالغ ذکر شده در قرارداد و پس از محاسبه به فروشنده پرداخت خواهد نمود.
                        ...
                        <p id="step1S8" v-if="pageStep == 8">
                            ...
                            <span>10-1 چنانچه معامله میان خریدار و فروشنده به عللی از علل قانونی منجر به فسخ گردد، باسکول مستحق دریافت کمیسیون مقرر برای آن معامله می باشد.
                            </span><br/><br/>
                        ...
                        <p id="step1S9" v-if="pageStep == 9">
                            <span>12-3 هیچ یک از مواد یا مفاد قرارداد حاضر به معنای شراکت یا وجود رابطه کارگر و کارفرمایی فی‌مابین فروشنده و باسکول و نیز خریدار و باسکول نبوده و نخواهد بود.</span><br/><br/>
                            <span>12-4 هیچ گونه تغییری در این توافقنامه معتبر نیست مگر با توافق کتبی یا الکترونیکی طرفین قرارداد.</span><br/><br/>
                            <span>12-5 خریدار و فروشنده اعلام می دارند مالکیت نرم افزار seller center متعلق به باسکول است.</span><br/><br/>
                            <span><b>ماده 13. حقوق مالکیت فکری</b></span><br/><br/>
                            <span>13-1 مالکیت سورس کدها و پلتفرم باسکول متعلق به باسکول می باشد و طرف دوم و سوم صرفاً اجازه بهره برداری از این پلتفرم را مطابق مفاد این قرارداد و سطح دسترسی اجازه داده شده توسط این قرارداد دارا می باشد. </span><br/><br/>
                            <span>13-2 مالکیت داده های تحصیل شده از طریق پلتفرم باسکول، تحلیل این داده ها، فروش نتایج تحلیل داده و استفاده پژوهشی و هرگونه استفاده دیگر از آنها با رعایت محرمانگی و عدم افشای اسرار صرفاً به باسکول تعلق داشته و طرف دوم و سوم هیچگونه حقی در این زمینه نخواهد داشت.</span><br/><br/>
