...
<template>
  <div>
    <h2 class="title-contents">حوزه فعالیت</h2>

    <div class="form-contents col-xs-12">
      <div class="row">
        <label for="activityType">نوع فعالیت خود را مشخص کنید</label>
        ...
        <label for="activity-domain">حوزه فعالیت خود را مشخص کنید</label>
        ...
        <div class="input-wrapper activity-domain-wrapper">
          ...
          >
            ...
            <option
              v-for="category in $parent.step4.categoryList"
              :selected="$parent.step4.categoryId == category.id"
