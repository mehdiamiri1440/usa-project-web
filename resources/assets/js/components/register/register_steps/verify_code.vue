    ...
    <div class="form-contents col-xs-12">
      <div class="row">
          ...
          <div class="row">
            <div class="col-xs-3">
              <input
                v-model="verifycode1"
                :class="{
                  error: $parent.errors.verification_code[0],
                  active: verifycode1.length,
                }"
                id="verify-code-1"
                type="number"
                class="dire"
        ...
        <p class="error-message">
          <span
            v-if="$parent.errors.verification_code[0]"
