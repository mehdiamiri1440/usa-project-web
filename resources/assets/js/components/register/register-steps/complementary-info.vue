  ...
  >
    ...
    <div class="row">
      <div class="user-phone-number-wrapper">
        <div class="row">
          <div class="input-wrapper col-xs-12 col-sm-6 pull-right">
            ...
            <i
              ...
              v-if="$parent.step3.name && !$parent.errors.name"
            ></i>
    ...
    <div class="row">
      <div class="select-wrapper province-wrapper col-xs-6 pull-right">
        <label class="input-title" for="last-name"
      ...
      <div class="select-wrapper province-wrapper col-xs-6">
        <label class="input-title" for="last-name"
        ...
        <p class="error-message">
          <span v-if="$parent.errors.city" v-text="$parent.errors.city"></span>
        </p>
      </div>
    </div>

    <div class="select-wrapper activity-domain-wrapper">
      <label class="input-title" for="last-name"
    ...
    <button
      ...
      @click.prevent="$parent.submitForm()"
    >
      ثبت نام
      <i
