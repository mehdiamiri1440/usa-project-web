  ...
  methods: {
    ...
    raiseSendMessageModal: function(){
      ...
      if(window.localStorage.getItem('contact') && window.localStorage.getItem('pathname')){
        ...
        textInput.innerHTML = '<input id="inputMsg" type="text" placeholder="پیامی بگذارید..." dir="rtl" v-model="self.msg"/>';
    ...
    raiseElevatorModal: function(){
      ...
      price.innerHTML = '<h1 class="green-text">تومان <span>25,000</span></h1><br/><p class="swal-text">با استفاده از نردبان، محصول شما تا زمان دریافت محصول تازه تر در همان دسته بندی، به عنوان اولین محصول نمایش داده می‌شود.</p>';
    ...
    raiseDeleteProductModal: function(){
      ...
      swal({
          title: "حذف محصول",
          text:
            "آیا میخواید این محصول را حذف کنید؟",
          // content: closeIconBtn,
          className: "custom-swal-with-cancel",
          buttons: {
            delete: {
    ...
    raiseRegisterProductLimitModal: function(){
      ...
      content.innerHTML = '<p dir="rtl">سقف تعداد محصولات ثبت شده شما پر شده است.</p><br/><p class="red-text" dir="rtl"><b>برای ثبت محصولات جدید، لطفا عضویت خود را ارتقا دهید.</b></p>';
      swal({
    ...
    raiseBuyAdReplyLimitModal: function(){
      ...
      let content = document.createElement("div");
      content.innerHTML = '<p dir="rtl">ظرفیت روزانه پاسخ به درخواست های خرید شما پر شده است.</p><br/><p class="red-text" dir="rtl"><b>برای افزایش ظرفیت، لطفا عضویت خود را ارتقا دهید.</b></p>';
      swal({
