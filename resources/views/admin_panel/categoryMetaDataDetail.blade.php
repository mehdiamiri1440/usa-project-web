...
@section('main_content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{route('admin_panel_edit_meta_content_to_a_category')}}" method="post">
      <div class="row">        
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                        ...
                        <tr>
                            <td class="col-xs-2"><b>زمان ثبت </b></td>
                            <td class="col-xs-10">{{$data->created_at}}</td>
                        </tr>
                        <tr>
                            <td class="col-xs-2"><b>متن توضیحات (باید تگ ها داخلش بیاد))</b></td>
                             <td class="col-xs-10">
                                <div class="form-group">
                                    <textarea type="text" name="content" class="form-control" rows="40">{{$data->content}}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="col-xs-2"><b>هر دسته بندی حداکثر یک اسکیما باید داشته باشد)اسکیما(</b></td>
                             <td class="col-xs-10">
                                <div class="form-group">
                                    <textarea type="text" name="schema" class="form-control" rows="10">{{$data->schema_object}}</textarea>
                                </div>
                            </td>
                        </tr>
          ...
          <!-- /.box -->
            ...
            <div class="row">             
                    <div class="col-xs-3 col-xs-offset-1">
                        <input type="hidden" name="meta_data_id" value="{{$data->id}}">
                        <button type="submit" class="btn btn-success btn-block">ویرایش</button>
                    </div> 
                    @if($data->is_visible == false)
                      <div class="col-xs-3 col-xs-offset-1">
                        <a href="{{'/admin/make-content-visible/' . $data->id }}" >انتشار محتوا</a>
                      </div> 
                    @else
                      <div class="col-xs-3 col-xs-offset-1">
                        <a href="{{'/admin/make-content-invisible/' . $data->id }}" >عدم انشار محتوا</a>
                      </div>
                    @endif               
            </div>  
        </form>
