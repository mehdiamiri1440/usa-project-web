      ...
      <div class="row">        
              ...
              <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-xs-10">
                                {{$transaction->deliver_at}}
                            </td>
                        </tr>
                        <tr>
                            <td class="col-xs-2"><b>تاریخ شروع موجودی</b></td>
                            <td class="col-xs-10">{{$transaction->date_from}}</td>
                        </tr>
                        <tr>
                            <td class="col-xs-2"><b>تاریخ پایان موجودی</b></td>
                            <td class="col-xs-10">{{$transaction->date_to}}</td>
                        </tr>
                        <tr>
                            <td class="col-xs-2"><b>توضیحات</b></td>
                             <td class="col-xs-10">
            ...
            <form>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <textarea class="form-control" type="text" id="admin-notes" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                <br/>
        ...
        @elseif($transaction->transaction_status == '0000000000000011' || $transaction->transaction_status == '0000000000000111')
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <button type="button" class="btn btn-primary" onClick="submitFactorForm(4)">صدور فاکتور</button>
                    </div>
                </div>
            </form>
        ...
        @elseif($transaction->transaction_status == '0000000000011111')
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <button type="button" class="btn btn-primary" onClick="submitFactorForm(6)">صدور فاکتور</button>
                    </div>
                </div>
            </form>
...
<script>   
    ...
    function submitTransactionInitiateForm()
    {
        ...
        var data = {
            ...
            commission_persentage: toLatinNumbers($('#commission-percentage').val()),
