    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="https:\\blog.buskool.com" class="smoothScroll">وبلاگ</a></li>
                ...
                <div id="accordion" role="tablist" aria-multiselectable="true" class="panel-group">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" role="tabpanel" aria-labelledby="headingOne"
                            ...
                            <div class="panel-body">
                                <p>
                                    باسکول بستر هوشمند و الکترونیکی خرید و فروش عمده محصولات کشاورزی (میوه-تره بار-خشکبار) است که خدمات پرداخت امن، قراردادهای حقوقی و بازرسی و کنترل کیفی را به خریداران و تامین کنندگان ارائه میدهد
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div role="tab" id="headingTwo" class="panel-heading"><h4 class="panel-title"><a
                                    ...
                                    خدمات باسکول برای تامین کنندگان چیست؟
                                </a></h4></div>
                        <div id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo"
                             class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    در سامانه باسکول کشاورزان، باغداران، گلخانه داران، صاحبان سالن های سورت، بسته بندی و سردخانه بعنوان فروشنده می توانند ایفای نقش کنند. باسکول به فروشندگان جهت فروش بهینه و بدون واسطه کمک میکند. فروشندگان می توانند در سامانه باسکول، پروفایل شخصی خود را بسازند و محصولات خود را نیز ثبت کنند تا از این طریق به خریداران گسترده ای در سراسر کشور دست پیدا کنند. از دیگر مزیت های باسکول برای فروشندگان شیوه پرداخت امانی و نقد می باشد که از این طریق از کلاهبرداری ها جلوگیری می شود.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" role="tabpanel" aria-labelledby="headingThree"
                            ...
                            <div class="panel-body">
                                <p>
                                    تجار، خریداران عمده و بنکداران به عنوان خریدار می توانند در سامانه باسکول ثبت نام کرده و فعالیت کنند. باسکول به خریداران امکان ساخت پروفایل تجاری، ثبت درخواست خرید و استعلام قیمت، پرداخت امانی و بازرسی محصول جهت کنترل کیفی را ارائه میدهد. خریداران در سامانه باسکول با لیست متعددی از محصولات و تامین کنندگان تایید شده مواجه می شوند که به راحتی می توانند به مقایسه بپردازند.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFour" role="tabpanel" aria-labelledby="headingFour"
                            ...
                            <div class="panel-body">
                                <ul>
                                    <li>ابتدا به سایت buskool.com مراجعه کرده و جهت ثبت نام دکمه ورود به سامانه یا <a href="{{route('login_page')}}" target="_blank">ورود/ثبت نام</a> کلیک کنید</li>
                        ...
                        <div id="collapseFive" role="tabpanel" aria-labelledby="headingFive"
                            ...
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li>
                                        <p>درصورتی که تاکنون اطلاعات پروفایل خود را ارسال نکرده اید در قسمت ویرایش پروفایل موارد خواسته شده را پر کنید و ارسال نمایید. سپس منتظر تایید اطلاعات خود از سمت ناظران باسکول باشید. مادامیکه اطلاعات شما احراز نشود قادر به ثبت محصول یا آگهی فروش نیستید.
                                        </p>
                                    ...
                                    <li>
                                         محصول شما پس از تایید ناظران باسکول در صفحه ی <a href="{{route('product-list')}}" target="_blank">لیست محصولات</a> نمایش داده می شود و خریداران میتوانند درخواست های خرید خود را برای شما ارسال کنند.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div role="tab" id="headingSix" class="panel-heading"><h4 class="panel-title"><a
                                   ...
                                   چگونه درخواست خرید خود را در باسکول ثبت کنم؟
                                </a></h4></div>
                        <div id="collapseSix" role="tabpanel" aria-labelledby="headingSix"
                            ...
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li>
                                        <p>درصورتی که تاکنون اطلاعات پروفایل خود را ارسال نکرده اید در قسمت ویرایش پروفایل موارد خواسته شده را پر کنید و ارسال نمایید. سپس منتظر تایید اطلاعات خود از سمت ناظران باسکول باشید. مادامیکه اطلاعات شما احراز نشود قادر به ثبت درخواست خرید نیستید.
                                        </p>
                                    ...
                                    <li>
                                        درخواست شما پس از تایید ناظران باسکول برای تامین کنندگان مربوطه ارسال میشود تا قیمت ، تصاویر و سایر جزییات محصولشان را برایتان ارسال کنند.برای مشاهده ی پاسخ ها قسمت درخواست های من را کلیک کنید
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseNine" role="tabpanel" aria-labelledby="headingNine"
                            ...
                            <div class="panel-body">
                                <p>
                                    باسکول جهت تسهیل فعالیت خریداران، صرفه جویی در هزینه ها و زمان، مکانیزم کنترل کیفی بر مبنای درخواست خریدار را طراحی کرده است. باسکول بنا بر نیاز خریداران خدمات نظارت بر آماده سازی بار، سورت و بسته بندی را جهت کنترل کیفی ارائه میدهد. همچنین در صورتی که نیاز به گواهی های بازرسی باشد، باسکول از طریق شرکتهای بازرسی که جزو همکاران ویژه باسکول هستند اقدام می نماید.
                                </p>
                            </div>
                        </div>
                    </div>
