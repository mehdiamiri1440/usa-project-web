<div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div name="fadeIn" delay="0.5s" duration="1s" :iteration="1" :offset="0" animateClass="animated" :begin="false">
          ...
          <div class="search-wrapper">
            <div class="hero-search-input">
              <nav class="custom-mega-menu hidden-xs">
                <ul>
                  <li>
                    <button class="open-categories hidden-lg">
      ...
      <div class="row">
        <div class="banner-item-wrapper">
          <div class="pull-right col-xs-3">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'حبوبات')  }}" class="banner-item banner-item-1">
          ...
          <div class="pull-right col-xs-9">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'میوه')  }}" class="banner-item banner-item-2">
              <div class="banner-contents">
                <p>میوه</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-3">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'ادویه')  }}" class="banner-item banner-item-3">
              <div class="banner-contents">
                <p>ادویه</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-6">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'صیفی')  }}" class="banner-item banner-item-4">
              <div class="banner-contents">
                <p>صیفی</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-3">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'غلات')  }}" class="banner-item banner-item-5">
              <div class="banner-contents">
                <p>غلات</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-6">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'خشکبار')  }}" class="banner-item banner-item-6">
              <div class="banner-contents">
                <p>خشکبار</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-3">
            <a href="{{'/product-list/category/'  . str_replace(' ', '-', 'دامپروری')  }}" class="banner-item banner-item-7">
              <div class="banner-contents">
                <p>دامپروری</p>
                <div>
                  مشاهده همه
          ...
          <div class="pull-right col-xs-3">
            <a class="banner-more-categories" href="/product-list">
              <div class="banner-contents">
                <p>
        ...
        <div class="mobile-banner">
          <div class="banner-item-wrapper">
            ...
            <div class="col-xs-3 pull-right">
              <a href="{{'/product-list/category/'  . str_replace(' ', '-', $subcategory->category_name)  }}" class="banner-item">
                <?php
                $banner_class = '';
                ...
                ?>
                <div class="item-image <?php echo $banner_class; ?> "></div>
                <p class="item-text">
            ...
            <div class="col-xs-3 pull-right">
              <a href="/product-list" class="banner-item all-banners">
      ...
      <div class="row">
        <div class="col-xs-12 pull-left col-md-9">
          ...
          <div class="col-xs-12 products-contents">
            <div class="row">
              ...
              ?>
                <div class="col-xs-6 grid-list col-sm-4 col-md-3 pull-right">
                  <article class="main-content-item ">
                    <a target="_blank" rel="nofollow" href="{{'/product-view/'  . str_replace(' ', '-', 'خرید-عمده-' .$product->subcategory_name) .'/' . str_replace(' ', '-', $product->category_name) . '/' .   $product->id  }}" class="main-article-contents-wrapper pointer-class is-user-valid-content">
                      ...
                      <a href="#" class="user-information-link">
                        <div class="user-information-content">
                          ...
                          <button class="verified-user" data-container="body" data-toggle="popover" data-placement="bottom">
        ...
        <div class="col-xs-12 col-md-3 pull-right">
          <div class="title-box">
            ...
            <a class="green-button" href="/register">ثبت نام رایگان
              <i class="fa fa-angle-left"></i>
            </a>
          </div>
        </div>
  ...
  <section id="register-request-section" class="container">
    <div class="section-wrapper col-xs-12">
      <div class="row">
        <div class="text-right col-xs-12 form-contents-wrapper">
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-md-6 pull-right">
                  ...
                  <div class="text-input-wrapper">
                    <input id="product-type" type="text" placeholder="نوع محصول مورد نیاز خود را وارد کنید" />
                ...
                <div class="col-xs-12 col-md-6">
                  ...
                  <div class="text-input-wrapper">
                    <input id="requirement_amount" type="tel" placeholder="میزان نیازمندی را وارد کنید" pattern="[0-9]*" />
                    <i class="fa fa-edit"></i>
                  </div>
          ...
          <div class="row">
            ...
            ?>
              ...
              <h4 class="col-xs-6 col-sm-4 col-md-2 pull-right">
                <a href="{{'/product-list/category/'  . str_replace(' ', '-', $product) }}">
