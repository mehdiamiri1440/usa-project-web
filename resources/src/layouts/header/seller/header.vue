...
<script>
import ProfileInfo from "../../dashboard/seller/header/sub-com/profile_info.vue";
import HeaderMenuList from "../../dashboard/seller/header/sub-com/header-menu-list.vue";
import HeaderTop from "../../dashboard/seller/header/sub-com/header-top.vue";
import SwitchButtons from "../../dashboard/seller/header/sub-com/swith-buttons.vue";
