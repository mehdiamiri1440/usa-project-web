...
<script>
import ProfileInfo from "../../dashboard/buyer/header/sub-com/profile_info.vue";
import HeaderMenuList from "../../dashboard/buyer/header/sub-com/header-menu-list.vue";
import HeaderTop from "../../dashboard/buyer/header/sub-com/header-top.vue";
import SwitchButtons from "../../dashboard/buyer/header/sub-com/swith-buttons.vue";
