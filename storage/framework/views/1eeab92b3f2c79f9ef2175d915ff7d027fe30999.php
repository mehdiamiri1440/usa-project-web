          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $__currentLoopData = $sellAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sellAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($sellAd->category_name); ?></td>
                        <td><?php echo e($sellAd->sub_category_name); ?></td>
                        <td><?php echo e($sellAd->product_name); ?></td>                    
                        <td><?php echo e($sellAd->first_name . ' ' . $sellAd->last_name); ?></td>                    
                        <td><?php echo e($sellAd->created_at); ?></td>                    
                        <td><a href="<?php echo e(route($sellAd->confirmed ? 'admin_panel_load_confirmed_sellAd_by_id' : 'admin_panel_load_unconfirmed_sellAd_by_id',['sellAd_id' => $sellAd->id])); ?>">مشاهده جزییات</a></td>
                    </tr>
