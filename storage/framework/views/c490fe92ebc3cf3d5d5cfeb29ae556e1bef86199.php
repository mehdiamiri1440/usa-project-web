		...
		<div class="container">
			<div class="row">
				<div class=" wow bounceIn col-md-12 col-sm-12">
                        ...
                        <p class="text-right">باسکول، بستر تجاری آنلاین است که از طریق آن هر کاربر ثبت شده می تواند برای برقراری و حفظ، توسعه کسب و کار با دیگر تولید کنندگان و خریداران همکاری کند. شرایط و مقررات تشکیل شده در این صفحه مشخص می کند که چگونه باید وب سایت و خدمات مورد استفاده قرار گیرد و نهایتا روابط فی مابین باسکول و کاربران (ثبت شده یا ثبت نشده) آن را تنظیم میکند. لطفاً شرایط و مقررات حاضر را به دقت مطالعه کنید و در صورتی که قوانین وب سایت برای شما قابل قبول نیست استفاده خود را از وب سایت و یا خدمات باسکول به هر نحو متوقف کنید.
در استفاده از خدمات وب سایت باسکول فرض بر این است که عملاً این شرایط و مقررات و تغییرات بعدی آن را پذیرفته اید، در این صورت هیچ ادعایی ناشی از استفاده مداوم شما از این سایت و ادعای عدم مطالعه یا آگاهی شما از این مقررات و تغییرات بعدی آن مسموع نخواهد بود.
شرایط درج درخواست خرید یا فروش در سامانه باسکول:
                    </p>
                        <ul class="text-right">
                    ...
                    <p>
به منظور بهبود فرآیند تأیید و انتشار درخواست ها، سامانه باسکول ممکن است در مواردی بر اساس قوانین، متن درخواست شما را به طور جزئی تغییر دهد.
                        </p>
				</div>
            </div>
		</div>
