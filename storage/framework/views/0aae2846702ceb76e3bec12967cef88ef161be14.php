<?php $__env->startSection('header_links'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('index/css/help.css')); ?>">
                    ...
                    <div id="accordion" role="tablist" aria-multiselectable="true" class="panel-group">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFour" role="tabpanel" aria-labelledby="headingFour"
                                ...
                                <div class="panel-body">
                                    <ul>
                                        <li>ابتدا به سایت incobac.com مراجعه کرده و جهت ثبت نام دکمه ورود به سامانه یا <a href="<?php echo e(route('login_page')); ?>" target="_blank">ورود/ثبت نام</a> کلیک کنید</li>
                                        <li>سپس در صفحه ورود روی دکمه ی <a href="<?php echo e(route('register_page')); ?>" target="_blank">ثبت نام</a> کلیک کنید.</li>
                                        <li><p>
                                                در صفحه ی ثبت نام  ابتدا شماره تلفن همراه خود را وارد کنید سپس دکمه ی ارسال پیامک را بزنید.
                                            </p>
                                            <img src="<?php echo e(asset('assets/img/help/2.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                        <li><p>
                                                کد تایید ارسال شده به تلفن همراهتان را وارد کنید سپس دکمه ی بررسی کد را بزنید.
                                            </p>
                                            <img src="<?php echo e(asset('assets/img/help/3.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                        <li><p>
                                                مشخصات کاربری خود را وارد کنید و دکمه ی ثبت مشخصات را بزنید.
                                            </p>
                                            <img src="<?php echo e(asset('assets/img/help/4.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                        <li><p>
                                                درپایان نوع کاربری و حوزه فعالیت خود را وارد کرده و دکمه ی ثبت نام را کلیک کنید
                                            </p>
                                            <img src="<?php echo e(asset('assets/img/help/5.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFive" role="tabpanel" aria-labelledby="headingFive"
                                ...
                                <div class="panel-body">
                                    <ul>
                                        <li>
                                            <p>ابتدا وارد سامانه شوید.<a href="<?php echo e(route('login_page')); ?>">لینک ورود</a>
                                            </p>
                                        </li>
                                        <li>
                                            ...
                                            <img src="<?php echo e(asset('assets/img/help/6.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                        <li>
                                            <p>در سمت راست پنل خود لینک ثبت محصول را کلیک کنید.(در پنل فروشندگان)</p>
                                            <img src="<?php echo e(asset('assets/img/help/8.jpg')); ?>">
                                            <br/><br/>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            محصول شما پس از تایید ناظران اینکوباک در صفحه ی <a href="<?php echo e(route('product-list')); ?>" target="_blank">لیست محصولات</a> نمایش داده می شود و خریداران میتوانند درخواست های خرید خود را برای شما ارسال کنند.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSix" role="tabpanel" aria-labelledby="headingSix"
                                ...
                                <div class="panel-body">
                                    <ul>
                                        <li>
                                            ابتدا وارد سامانه شوید.<a href="<?php echo e(route('login_page')); ?>">لینک ورود</a>
                                        </li>
                                        <li>
                                            ...
                                            <img src="<?php echo e(asset('assets/img/help/11.jpg')); ?>">
                                            <br/>
                                            <br/>
                                        </li>
                                        <li>
                                            ...
                                            <img src="<?php echo e(asset('assets/img/help/12.jpg')); ?>">
                                            <br/>
                                            <br/>
                                        </li>
