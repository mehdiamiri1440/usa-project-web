<?php $__env->startSection('header_links'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('index/css/pricing_table.css')); ?>">
    <style>
        .policy ul li {
            line-height: 1.618;
            margin: 15px 0;
                ...
                <div class="col-xs-12 animated"
                    ...
                    <table class="wow fadeInUp   pricing-table ">
                        ...
                        <tr>
                            ...
                            <th class="head-secend-package">
                                <div class="main-pricing-icon">
                                    <img src="<?php echo e(asset('index/images/Group_38.png')); ?>">
                            ...
                            <th class="head-secend-package">
                                <div class="main-pricing-icon">
                                    <img src="<?php echo e(asset('index/images/Group_36.png')); ?>">
                            ...
                            <th class="head-secend-package">
                                <div class="main-pricing-icon">
                                    <img src="<?php echo e(asset('index/images/Group_34.png')); ?>">
...
<script src="<?php echo e(asset('index/js/pricing.js')); ?>"></script>
<?php $__env->stopSection(); ?>
