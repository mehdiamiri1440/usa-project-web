...
<head>
    ...
    <style>
        body, html {
            background-image: url("<?php echo e(asset('images/login_back_03.jpg')); ?>");
            height: 100%;
...
<div class="container-fluid">
    <div class="container">
        <img src="<?php echo e(url('assets/img/404.jpg')); ?>">
        <div class="buttons">
            <div>
            ...
            <div>
                <a href="<?php echo e(url()->previous()); ?>" class="botton-inco">
                    بازگشت به صفحه قبل
                </a>
            </div>
        </div>
