    ...
    <section class="content">
      <div class="row">        
          <div class="box">
            ...
            <form method="GET" action="<?php echo e(Request::is('admin/sellAd') ? route('admin_panel_sellAd') : route('admin_panel_sellAd_list')); ?>">
              <div class="row">
            ...
            <div class="box-body">
              ...
              <div align="center">
                <?php echo e($sellAds->appends($_GET)->render("pagination::default")); ?>
