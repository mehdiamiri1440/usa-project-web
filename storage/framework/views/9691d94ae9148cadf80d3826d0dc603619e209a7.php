...
<script>   
    ...
    {   
        ...
        $.ajax({
            url:"<?php echo e(route('initiate_instant_transaction')); ?>",
            data: data,
            type:'POST',
            datatype:'json'
        })
        .done(function(json){
            ...
            window.location.href = "<?php echo e(route('admin_panel_waiting_to_initiate_transactions_list')); ?>";
        })
    ...
    { 
        ...
        $.ajax({
            url:"<?php echo e(route('action_controller')); ?>",
            data:data,
            type: 'POST',
            dataType: 'json',
        })
        .done(function(json){
            alert('submited!');
            if(actionId == 4){
                window.location.href = "<?php echo e(route('admin_panel_waiting_for_prepayment_factor_issuance_list')); ?>";
            }
            else if(actionId == 6){
               window.location.href = "<?php echo e(route('admin_panel_waiting_for_payment_factor_issuance_list')); ?>"; 
            }
    ...
    function submitTransactionTerminationSignal()
    {
        ...
        .done(function(json){
            ...
            window.location.href = "<?php echo e(route('admin_panel_waiting_for_termination_transaction_list')); ?>" ;
        })
        .fail(function(xhr,status,errorThrown){
           // 
        });
