          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $__currentLoopData = $sell_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sell_offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($sell_offer->first_name . ' ' . $sell_offer->last_name); ?></td>
                    <td><?php echo e($sell_offer->date_from); ?></td>
                    <td><?php echo e($sell_offer->date_to); ?></td>
                    <td><?php echo e($sell_offer->price); ?></td>                    
                    <td><?php echo e($sell_offer->deliver_at); ?></td>                    
                    <td><?php echo e($sell_offer->created_at); ?></td>                    
                    <td><a href="<?php echo e(route('admin_panel_load_sell_offer_by_id',['id' => $sell_offer->id])); ?>">مشاهده جزییات</a></td>
                </tr>
