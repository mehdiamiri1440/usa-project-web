            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td><?php echo e($profile->user_info->first_name . ' ' . $profile->user_info->last_name); ?></td>
                    <td><?php echo e($profile->register_date); ?></td>
                    <td><?php echo e($profile->user_info->is_buyer ? 'خریدار' : 'فروشنده'); ?></td>                    
                    <td><a href="<?php echo e("/admin/profile-detail/".$profile->id); ?>">مشاهده جزییات</a></td>
                </tr>
