              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo e(route('admin_panel_load_user_notes_by_id',['user_id' => $user->id])); ?>">ثبت/مشاهده  توضیحات</a>
                        <span class="pull-left-container">
                            <span class="label pull-left bg-red"><b><?php echo e($user->note_count); ?></b></span>
                        </span>
                        </td>
                    </tr>
