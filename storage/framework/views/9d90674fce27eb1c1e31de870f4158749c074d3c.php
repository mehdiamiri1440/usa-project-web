    ...
    <section class="content">
      <div class="row">        
          <div class="box">
            ...
            <form method="GET" action="<?php echo e(Request::is('admin/buyAd') ? route('admin_panel_buyAd') : route('admin_panel_buyAd_list')); ?>">
              <div class="row">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $__currentLoopData = $buyAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buyAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($buyAd->category_name); ?></td>
                        <td><?php echo e($buyAd->sub_category_name); ?></td>
                        <td><?php echo e($buyAd->name); ?></td>                    
                        <td><?php echo e($buyAd->first_name . ' ' . $buyAd->last_name); ?></td>                    
                        <td><?php echo e($buyAd->created_at); ?></td>                                    
                        <td><a href="<?php echo e(route($buyAd->confirmed ? 'admin_panel_load_confirmed_buyAd_by_id' : 'admin_panel_load_unconfirmed_buyAd_by_id',['buyAd_id' => $buyAd->id])); ?>">مشاهده جزییات</a></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </table>
              <div align="center">
                <?php echo e($buyAds->appends($_GET)->render("pagination::default")); ?>
