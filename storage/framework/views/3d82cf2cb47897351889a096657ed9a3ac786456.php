<?php $__env->startSection('header_links'); ?>
    <script src="<?php echo e(asset('assets/js/owl.carousel.min.js')); ?>" xmlns:v-bind="http://www.w3.org/1999/xhtml"
    ...
    <?php if($profile_photo): ?>
        ...
        <meta property="og:image:secure_url" itemprop="image" content="<?php echo e(asset('storage/'.$profile_photo)); ?>">
    <?php else: ?>
        <meta property="og:image" itemprop="image" content="<?php echo e(asset('assets/img/logo-inco-mobile.png')); ?>">
        <meta property="og:image:secure_url" itemprop="image" content="<?php echo e(asset('assets/img/logo-inco-mobile.png')); ?>">
    <?php endif; ?>
                    ...
                    <div class="image_user_wrapper col-xs-4">
                        <div class="user-image">
                            <div v-if="profileOwner.profile.profile_photo">
                                <img v-bind:src=" '<?php echo e(url('storage')); ?>/' + profileOwner.profile.profile_photo">
                            </div>
                            <div v-else>
                    ...
                    <div class="col-xs-6" :class="{'active':profileDescription}">
                        <a @click="
                            ...
                            <div class="inside-links">
                                ...
                                <i class="fa fa-pencil-alt-square-o" aria-hidden="true"></i> توضیحات من
...
<?php $__env->startSection('script_tags'); ?>
    <script>
        var userName = "<?php echo e($user_name); ?>";
    </script>
    <script src="<?php echo e(asset('assets/js/profile/main-profile.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/profile/api-main-profile.js')); ?>"></script>
<?php $__env->stopSection(); ?>
