...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["img", "base", "popUpLoaded", "alt", "imageCount", "productUrl", "showLatestProducts"],
...
var render = function() {
  ...
  return _c("div", { staticClass: "main-article-image" }, [
    _c("h1", [
      _vm._v("\n    " + _vm._s(_vm.$parent.showLatestProducts) + "\n  ")
    ]),
    _vm._v(" "),
    _c("div", {
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.$parent.showLatestProducts,
          expression: "$parent.showLatestProducts"
        }
      ],
