...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    nextStep: function nextStep() {
      ...
      this.$parent.createCookie("confirmProduct", JSON.stringify(this.prconfirmProductoduct), 30);
      if (this.$parent.user_info.id) {
  ...
  methods: {
    init: function init() {
      ...
      axios.post("/user/profile_info").then(function (response) {
        _this.currentUser = response.data.profile;
      });
    },
