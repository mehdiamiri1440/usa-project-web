  ...
  methods: {
    ...
    convertUnits: function convertUnits(number) {
      ...
      if (number < 1000) {
        ...
        var kg = data.toString().split(".")[1];
        // kg = kg.replace(/^0+/, "");
        // console.log(ton, kg);
        // console.log("08".replace(/^0+/, ""));
        console.log(kg.toString().replace(/^0+/, ""));
        // return number / 1000 + " " + "تن";
      }
    }
  },
  mounted: function mounted() {
    ...
    _c("div", { staticClass: "form-contents col-xs-12" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-xs-6 pull-right" }, [
          ...
          _vm._v(" "),
          !_vm.$parent.errors.stock && _vm.$parent.stock_text
