              ...
              [
                ...
                _c("p", { staticClass: "error-message" }, [
                  _vm.$parent.errors.name
                    ? _c("span", {
                        domProps: {
                          textContent: _vm._s(_vm.$parent.errors.name)
                        }
                      })
                    : _vm._e()
                ])
  ...
  watch: {
    name: function name(text) {
      ...
      setTimeout(function () {
        ...
        _this.$parent.errors.name = "";
        if (text) {
          var error = _this.$parent.textValidator(text, "نام");
          if (error) {
            _this.$parent.errors.name = error;
            _this.$parent.validateErrors();
          } else {
            _this.$parent.step3.name = _this.name;
            _this.$parent.validateErrors();
          }
        } else {
          _this.$parent.step3.name = "";
        }
      }, 50);
    },
