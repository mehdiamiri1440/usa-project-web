...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setProvince: function setProvince(provinceId, provinceName) {
      ...
      if (!this.allCitiesList || !Array.isArray(this.allCitiesList) && !Object.entries(this.allCitiesList).length) this.allCitiesList = {};

      if (!Array.isArray(this.cities)) this.allCitiesList = Object.values(this.allCitiesList);
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-xs-12" }, [
          ...
          _c("div", { staticClass: "list-wrapper" }, [
            _vm._v(
              "\n          " +
                _vm._s(_vm.isProvince && _vm.provinces.length) +
                "\n          " +
                _vm._s(!_vm.isProvince && _vm.cities.length) +
                "\n          "
            ),
            _vm.isProvince && _vm.provinces
              ? _c(
                  "ul",
                  { ref: "isProvinces" },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    "$parent.productName": function $parentProductName(productName) {
      this.$parent.errors.productName = "";
      var error = this.$parent.textValidator(productName, "نوع محصول");
          ...
          [
            ...
            _c("label", { attrs: { for: "user-stock" } }, [
              ...
              _c("span", {
                staticClass: "light-green-text",
                domProps: {
                  textContent: _vm._s(this.$parent.product.main.product_name)
                }
              }),
              _vm._v("\n          نیاز دارید؟\n          "),
