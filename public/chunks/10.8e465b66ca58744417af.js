...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    userAutorizeForReview: function userAutorizeForReview() {
      this.$parent.setReviewUserPrfileId = this.profileOwner.user_info.id;

      this.$parent.getUserAutorizeForReview();
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    filterName: function filterName() {
      ...
      console.log(userName, splitUserName, nameLength);
      for (var i = 0; i < nameLength; i++) {
        if (i == 0) {
          filterUserName.push(splitUserName[i]);
        } else if (i == nameLength - 1) {
          filterUserName.push(splitUserName[i]);
        } else if (i < 5 && i != nameLength - 1) {
          filterUserName.push("*");
        }
      }
          ...
          _c("div", { staticClass: "review-likes-wrapper text-center" }, [
            _c("button", { staticClass: "review-likes" }, [
              _c("span", { staticClass: "like-icon" }, [
                _c("span", {
                  domProps: { textContent: _vm._s(_vm.review.likes) }
                }),
                _vm._v(" "),
                    ...
                    _c("div", { staticClass: "reviews-wrapper col-xs-12" }, [
                      _c("div", { staticClass: "header-reviews text-center" }, [
                        _c("div", { staticClass: "actions" }, [
                          _vm.$parent.userAllowedReviewData || !_vm.isMyProfile
                            ? _c(
                                "button",
                                {
