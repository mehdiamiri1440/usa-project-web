    ...
    return _c("div", { staticClass: "user-description-wrapper text-right" }, [
      ...
      _c(
        ...
        [
          _c("span", [
            _vm._v(
              "\n          فروش برنج طارم هاشمی از شالیزارهای آمل به سفره و یا مراکز فروش شما\n          به صورت مستقیم با قیمت مناسب ..کشت اول آماده فروش به مقداری که نیاز\n          دارید کشت دوم دو ماه آینده آماده میشود در صورت نیاز اطلاع دهید..\n          حداقل سفارش: 20..حداکثر:.....از شالیزار های آمل به سفره یا مغازه شما\n          به صورت جزئی و کلی .تبلیغ من برنج منه ک در صورت عدم رضایت پس گرفته\n          میشود.متاسفانه سودجویان باعث شدند اعتماد مردم از بین برود من در این\n          مجموعه کوچک سعی در اعتماد سازی دارم و میخواهم مشتریان عزیز تبلیغ\n          کننده محصولات من باشند.اعتقاد من این است کیفت وخالص بودن محصول و\n          صداقت در معامله باعث تدوام فروش است.برنج خالص طارم هاشمی..کلیه\n          محصولات از خانواده خودمه با خیال راحت خرید کنید..تخفیف و شرایط ویژه\n          برای کسانی که خرید بالای یک تن دارند.. برای ارتباط و خرید مستقیم\n          پیام ارسال کنید\n        "
            )
          ])
        ]
      ),
