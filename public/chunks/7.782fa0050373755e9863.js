...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "promotion-image-wrapper" }, [
      ...
      _vm._v(" "),
      _c("img", {
        attrs: { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../img/upgrade_rocket.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "" }
      })
    ])
  }
]
