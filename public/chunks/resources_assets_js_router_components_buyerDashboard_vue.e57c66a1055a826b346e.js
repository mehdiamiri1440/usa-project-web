...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    _router_router__WEBPACK_IMPORTED_MODULE_4__.eventBus.$on("resetTextSearch", function (event) {
...
/* harmony import */ var _router_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../router.js */ "./resources/assets/js/router/router.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    axios.post("/get_total_unread_messages_for_current_user").then(function (response) {
      ...
      _router_js__WEBPACK_IMPORTED_MODULE_1__.eventBus.$emit("messageCount", messageCount);
    })["catch"](function (error) {
      console.log("error", error);
    });
  },
