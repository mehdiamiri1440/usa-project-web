  ...
  methods: {
    ...
    setList: function setList(index, id, name) {
      ...
      if (this.sortCurrentStep == 0) {
        ...
        console.log(this.categories[this.categoryIndex].subcategories, index, this.categoryIndex);

        var subCategory = this.categories[this.categoryIndex].subcategories[index];
