          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.productName,
              expression: "$parent.product.productName"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا: مضافتی" },
          domProps: { value: _vm.$parent.product.productName },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "productName", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.maxSalePrice,
              expression: "$parent.product.maxSalePrice"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.product.maxSalePrice },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "maxSalePrice", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
