...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    ProductContents: __WEBPACK_IMPORTED_MODULE_1__product__["default"],
    UserInfo: __WEBPACK_IMPORTED_MODULE_2__user_info__["default"],
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    Carousel: __WEBPACK_IMPORTED_MODULE_0__carousel__["default"]
  },
  methods: {
    getNumberWithCommas: function getNumberWithCommas(number) {
      if (number || typeof number === "number") return number.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");else return "";
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    ProductCarousel: __WEBPACK_IMPORTED_MODULE_0__main_components_product_list_carousel__["default"],
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    RegisterNumber: __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_register_number__["default"],
    VerifiedCode: __WEBPACK_IMPORTED_MODULE_1__register_modal_steps_verified_code__["default"],
    PersonalInformation: __WEBPACK_IMPORTED_MODULE_2__register_modal_steps_personal_information__["default"],
    ChoseRoute: __WEBPACK_IMPORTED_MODULE_3__register_modal_steps_chose_route__["default"],
    Location: __WEBPACK_IMPORTED_MODULE_4__register_modal_steps_location__["default"],
    RegisterRequest: __WEBPACK_IMPORTED_MODULE_5__register_modal_steps_register_reuqest__["default"],
    RegisterLoader: __WEBPACK_IMPORTED_MODULE_6__register_modal_steps_register_loader__["default"]
  },
  data: function data() {
    return {
      isMobile: false,
