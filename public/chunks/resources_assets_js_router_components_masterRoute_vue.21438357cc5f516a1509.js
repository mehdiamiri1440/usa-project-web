...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mounted: function mounted() {
    this.$store.state.dashboardStore.subHeader = "submit header please";
  },
  methods: {
