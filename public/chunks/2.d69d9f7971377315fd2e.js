...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    "buyAd.requirement_amount": function buyAdRequirement_amount(value) {
      ...
      if (value) {
        if (value.length >= 13) {
          this.buyAd.requirement_amount = this.buyAd.requirement_amount.substring(0, 13);
        }
        ...
        if (!this.errors.requirement_amount) {
          this.requirement_amount = this.getNumberWithCommas(number);
                ...
                _c("div", { staticClass: "input-text-wrapper" }, [
                  !_vm.errors.requirement_amount
                    ? _c("p", { staticClass: "small-description-text" }, [
                        _vm.buyAd.requirement_amount_text
                          ? _c("span", {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_components_Product_grid_article__ = __webpack_require__(421);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_components_Product_grid_article___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__product_components_Product_grid_article__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    ProductGridArticle: __WEBPACK_IMPORTED_MODULE_2__product_components_Product_grid_article___default.a
  },
