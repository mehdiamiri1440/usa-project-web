                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.$parent.step3.activityype,
                        expression: "$parent.step3.activityype"
                      }
                    ],
                    attrs: { type: "radio", value: "0", name: "radio" },
                    domProps: {
                      checked: "0" == _vm.$parent.step3.activityType,
                      checked: _vm._q(_vm.$parent.step3.activityype, "0")
                    },
                    on: {
                      change: function($event) {
                        _vm.$set(_vm.$parent.step3, "activityype", "0")
                      }
                    }
                  }),
                  _vm._v(" "),
