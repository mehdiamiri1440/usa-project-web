  ...
  methods: {
    ...
    productNameValidator: function productNameValidator(name) {
      ...
      if (this.errors.product_name) {
        this.$parent.registerComponentStatistics("product-register-error", "product-name", "input:" + name + " error:" + this.errors.product_name);
      }
    },
    validateRegx: function validateRegx(input, regx) {
      return regx.test(input);
...
var render = function() {
  ...
  return _c("div", [
    _c("h2", { staticClass: "title-contents col-xs-12" }, [
      _vm.index == 0
        ? _c("img", {
            attrs: { src: __webpack_require__(860) }
          })
        : _vm.index == 1
          ? _c("img", {
              attrs: { src: __webpack_require__(861) }
            })
          : _vm.index == 2
            ? _c("img", {
                attrs: { src: __webpack_require__(862) }
              })
            : _vm._e(),
                ...
                _c(
                  "button",
                  {
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        _vm.$parent.selectedSubCategory(item.id)
                      }
                    }
                  },
                  [
