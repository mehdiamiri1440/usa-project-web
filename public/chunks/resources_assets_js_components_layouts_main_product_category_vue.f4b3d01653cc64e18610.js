...
var render = /*#__PURE__*/_withId(function (_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["id"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end article modal"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" \n    <ProductUserInfo\n      :profile_photo=\"product.profile_info.profile_photo\"\n      :user_info=\"product.user_info\"\n      :user_full_name=\"\n        product.user_info.first_name + ' ' + product.user_info.last_name\n      \"\n      :user_name=\"product.user_info.user_name\"\n      :current_user=\"currentUser\"\n      :product_id=\"product.main.id\"\n      :is_my_profile_status=\"isMyProfile\"\n    /> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ArticleMainContents, {
    productIndex: $props.productIndex,
