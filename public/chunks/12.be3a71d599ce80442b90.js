  ...
  methods: {
    sendVerificationCode: function sendVerificationCode() {
      ...
      axios.post("/send_verification_code", {
        ...
        _this.registerComponentStatistics("Register-Error", "phone-number-verification", "error:" + _this.errors.phone[0]);
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    "code.verifycode1": function codeVerifycode1(value) {
      if (value) {
        this.code.verifycode1 = this.validateVerifyNumber(value);
      }
    },
    "code.verifycode2": function codeVerifycode2(value) {
      if (value) {
        this.code.verifycode2 = this.validateVerifyNumber(value);
      }
    },
    "code.verifycode3": function codeVerifycode3(value) {
      if (value) {
        this.code.verifycode3 = this.validateVerifyNumber(value);
      }
    },
    "code.verifycode4": function codeVerifycode4(value) {
      if (value) {
        this.code.verifycode4 = this.validateVerifyNumber(value);
      }
    }
  }
});
