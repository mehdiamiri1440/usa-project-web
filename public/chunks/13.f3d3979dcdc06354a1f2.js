...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    showSampleImage: function showSampleImage(event) {
      console.log(event.target);
      event.target.classList.add("image-scale");
      $("body").append("<div class=\"overlay-bg-modal\">\n                <button class=\"image-close\">\n                  <i class=\"fas fa-times-circle\"></i>\n                </button>\n\n               \n              </div>");
      $(".overlay-bg-modal").append($('#sample_image'));
    },
    handleBackButtonForShowImage: function handleBackButtonForShowImage() {
      ...
      $(window).on("popstate", function (e) {
        $(".overlay-bg-modal").removeClass("bottom-0");
