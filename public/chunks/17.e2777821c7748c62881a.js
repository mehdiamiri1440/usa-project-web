...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    activityTypeValidator: function activityTypeValidator(activityType) {
      ...
      console.log(activityType, this.errors.activity_type);
      if (this.errors.activity_type) {
        this.registerComponentStatistics("Register-Error", "activity-type", "input:" + activity_type + " Error:" + this.errors.activity_type);
      }
    },
