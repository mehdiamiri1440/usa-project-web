          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.minSaleAmount,
              expression: "$parent.product.minSaleAmount"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.product.minSaleAmount },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.min_salePrice,
              expression: "$parent.product.min_salePrice"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.product.min_salePrice },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
