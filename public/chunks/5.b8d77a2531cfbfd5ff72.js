...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "form-contents  col-xs-12" }, [
        ...
        [
          _c(
            "file-upload",
            {
              ...
              model: {
                value: _vm.$parent.testProductFiles,
                callback: function($$v) {
                  _vm.$set(_vm.$parent, "testProductFiles", $$v)
                },
                expression: "$parent.testProductFiles"
              }
            },
            [
      ...
      _vm._v(
        "\n      " +
          _vm._s(_vm.$parent.productFiles) +
          "\n      " +
          _vm._s(_vm.$parent.testProductFiles) +
          "\n      \n      "
      ),
      _c("p", { staticClass: "error-message col-xs-12" }, [
