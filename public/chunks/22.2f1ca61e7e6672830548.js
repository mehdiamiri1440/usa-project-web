  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      $(".product-pricing .item-wrapper").each(function (index, element) {
        console.log(self.priceItem.priceItems, index);
        $(element).prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + self.priceItem.priceItems[index].helpDescription + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        $(".item-guid").tooltip();
      });
    });
  }
