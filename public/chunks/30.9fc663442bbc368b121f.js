...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    prices: function prices() {
      var activePackagePercentage = this.referralUsers.wallet_balance / this.prices["type-3"] * 100;
      console.log(activePackagePercentage, this.referralUsers.wallet_balanc, this.prices["type-3"]);
      $(".progress-tooltip").css("left", "calc(" + activePackagePercentage + "% - 21px)");
      $(".progress-bar").css("width", "calc(" + activePackagePercentage + "% + 6px)");
    }
  }
});
