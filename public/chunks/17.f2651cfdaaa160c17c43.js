...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  }, _defineProperty(_methods, "setScrollToBuyAd", function setScrollToBuyAd(id) {
    var element = $(id);
  ...
  }), _defineProperty(_methods, "infiniteScrollHandler", function infiniteScrollHandler() {
    var _this = this;
  ...
  }), _defineProperty(_methods, "feed", function feed() {
    var _this2 = this;
  ...
  }), _defineProperty(_methods, "activePhoneCall", function activePhoneCall(buyAdUserId, buyAdId) {
    var _this3 = this;
  ...
  }), _defineProperty(_methods, "hideReplyBtn", function hideReplyBtn(id) {
    var itemFirst = id + " span:first-child";
    var itemLast = id + " span:last-child";
    $(itemFirst).hide();
    $(itemLast).show();
  }), _defineProperty(_methods, "showReplyBtn", function showReplyBtn(id) {
    var itemFirst = id + " span:first-child";
    var itemLast = id + " span:last-child";
    $(itemLast).hide();
    $(itemFirst).show();
  ...
  }), _defineProperty(_methods, "getConvertedNumbers", function getConvertedNumbers(number) {
  ...
  }), _defineProperty(_methods, "scrollToTop", function scrollToTop() {
    window.scrollTo(0, 0);
  }), _defineProperty(_methods, "selectCategoryItem", function selectCategoryItem(category, url) {
