...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: ["productsInfo", "categoryId", "subCategoryId", "cityId", "categories", "resetLocation"],
  data: function data() {
    return {
      provinceChild: "",
      cityChild: "",
...
/* harmony default export */ __webpack_exports__["a"] = (_props$data$methods$m = {
...
}, _defineProperty(_props$data$methods$m, "mounted", function mounted() {
  this.init();
  var self = this;
  // this.$parent.scrollSet();
  document.fonts.ready.then(function () {
...
}), _defineProperty(_props$data$methods$m, "watch", {
  selectedProvince: function selectedProvince(province) {
    __WEBPACK_IMPORTED_MODULE_0__router_router__["b" /* eventBus */].$emit("selectedProvince", province);
    __WEBPACK_IMPORTED_MODULE_0__router_router__["b" /* eventBus */].$emit("selectedCity", "");
    this.selectedCity = "";
    if (province) {
  ...
  function() {
    ...
    return _c("div", { staticClass: "category-products-widget-default" }, [
      _c("ul", [
        _c("li", [
          _c("span", {
            staticClass: "placeholder-content h-25 content-full-width"
          }),
          _vm._v(" "),
          _c("span", {
            staticClass: "placeholder-content h-25 content-half-width"
          }),
          _vm._v(" "),
          _c("span", {
            staticClass: "placeholder-content h-25 content-default-width"
          })
        ])
      ])
    ])
  ...
  return _c(
    ...
    [
      ...
      _c("GeoLocationFilter", {
        attrs: { resetLocationFilter: _vm.resetLocation }
      })
    ],
    1
  )
