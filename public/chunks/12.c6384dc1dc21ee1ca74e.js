...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    verifycode1: function verifycode1(value) {
      if (value) {
        this.verifycode1 = this.validateVerifyNumber(value);
      }
    },
    verifycode2: function verifycode2(value) {
      if (value) {
        this.verifycode2 = this.validateVerifyNumber(value);
      }
    },
    verifycode3: function verifycode3(value) {
      if (value) {
        this.verifycode3 = this.validateVerifyNumber(value);
      }
    },
    verifycode4: function verifycode4(value) {
      if (value) {
        this.verifycode4 = this.validateVerifyNumber(value);
      }
    }
  }
});
