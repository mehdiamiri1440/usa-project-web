    ...
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        if (response.data.status === true) {
          ...
          _this2.errors.verification_code.push("کد وارد شده صحیح نیست یا منقضی شده است");
          _this2.registerComponentStatistics("Register-Error", "verification-code-wrong", "error:" + self.errors.verification_code[0]);
        }
      }).catch(function (error) {
