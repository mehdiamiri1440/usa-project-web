...
/* harmony import */ var vue_meta__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue-meta */ "./node_modules/vue-meta/dist/vue-meta.esm-browser.min.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props, _ref) {
    ...
    console.log(props); // console.log(context.attrs);
    ...
    //     {
    //       property: "og:title",
    //       content: "باسکول | خرید و فروش عمده و قیمت ",
    //     },
    //   ],
  ...
  methods: {
    ...
    setMetaInfo: function setMetaInfo() {
      ...
      var productDescription = this.product.main.description ? this.product.main.description.split("<hr/>").join("") : ""; // let pageUrl = this.getProductUrl();
      // let canonicalLink = window.location.host + pageUrl;

      (0,vue_meta__WEBPACK_IMPORTED_MODULE_5__.useMeta)({
        title: "My Example App",
        meta: [{
          name: "description",
          content: "description test"
          ...
          property: "og:description",
          content: "خرید و فروش عمده و قیمت " + " از بهترین تولیدکنندگان ایران - باسکول بازار آنلاین کشاورزی ایران"
        }, {
          property: "og:site_name",
          content: "باسکول بازارآنلاین خرید و فروش محصولات کشاورزی ایران"
        }, {
