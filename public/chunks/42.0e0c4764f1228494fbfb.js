...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    changePassword: function changePassword() {
      ...
      axios.post("/change_password", { current_password: this.cur, new_password: this.newPassword }).then(function (e) {
    ...
    resetNewPassword: function resetNewPassword() {
      this.newPassword = null;
      this.confirmPassword = null;
    }
  },
  watch: {
    currentPassword: function currentPassword(e) {
      if (e) {
