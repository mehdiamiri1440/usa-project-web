    ...
    _c("form", [
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("span", {
          ...
          domProps: { textContent: _vm._s(_vm.errors.product_type) }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("span", {
          staticClass: "text-danger",
          domProps: { textContent: _vm._s(_vm.errors.min_sale_amount) }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.min,
              expression: "$parent.product.min"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.product.min },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "min", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
