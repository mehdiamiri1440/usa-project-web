...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  }, _defineProperty(_methods, "stockValidator", function stockValidator(number) {
    this.errors.stock = "";
    var standardNumber = this.toLatinNumbers(number);
    if (standardNumber == "") {
      this.errors.stock = "لطفا میزان موجودی را وارد کنید";
  ...
  }), _defineProperty(_methods, "minSaleAmountValidator", function minSaleAmountValidator(number) {
  ...
  }), _defineProperty(_methods, "maxSalePriceValidator", function maxSalePriceValidator(number) {
  ...
  }), _defineProperty(_methods, "minSalePriceValidator", function minSalePriceValidator(number) {
