...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      linkHideStates: ["messenger/contacts", "messenger/buy-ads", "register-product/success", "buyAd-requests", "register-product", "pricing", "product-pricing", "buyad-pricing", "invited-users", "referral", "introductionDelsaSeller"],
      buttonIsActive: true,
      currentUser: {
        profile: {
          is_company: "",
