            ...
            if (newFile && !oldFile) {
                ...
                if (newFile.file && newFile.type.substr(0, 6) === 'image/' && this.autoCompress > 0 && this.autoCompress < newFile.size) {
                    ...
                    imageCompressor.compress(newFile.file, Options).then(function (file) {
                        Object(__WEBPACK_IMPORTED_MODULE_0__blueimp_load_image_js_index__["default"])(newFile.file, function (img) {
                            console.log(img);
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/apple/Desktop/buskool/incobac-new-cli/resources/assets/js/blueimp-load-image/js/index.js'");
