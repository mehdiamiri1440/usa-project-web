...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "row wrapper-section" }, [
      _c("div", { staticClass: "invitation-image-wrapper" }, [
        _c("img", {
          attrs: {
      ...
      _c("p", [
        _vm._v(
          "\n        با دعوت از همکاران خود به باسکول میتوانید کسب درآمد کنید. در صورتی که\n        همکار دعوت شده به جمع باسکول بپیوندد بعد از خرید هر کدام از سرویس های\n        غیر رایگان باسکول، نصف مبلغ خرید به کیف پول باسکول شما اضافه می شود.\n        همین حالا دعوت نامه را ارسال کنید.\n      "
        )
      ]),
      _vm._v(" "),
      _c("button", { staticClass: "send-invitation" }, [
...
module.exports = "/images/referral.jpg?19e429e470e9094e6ac19c448b3fc0d7";
