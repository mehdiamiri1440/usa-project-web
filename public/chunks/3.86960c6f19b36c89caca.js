...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    ...
    "$parent.product.minSaleAmount": function $parentProductMinSaleAmount(e) {
      this.errors.minSaleAmount = "";
      if (e) {
        this.minSaleAmountValidator(e);
      }
    },
    "$parent.product.min_salePrice": function $parentProductMin_salePrice(e) {
      this.errors.minSalePrice = "";
      if (e) {
        this.minSalePriceValidator(e);
      }
    },
    "$parent.product.maxSalePrice": function $parentProductMaxSalePrice(e) {
