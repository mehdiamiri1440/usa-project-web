...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      userStatistics: ""
    }, _defineProperty(_ref, "reviewCurrentStep", 0), _defineProperty(_ref, "successMessage", "نظر شما با موفقیت ثبت شد"), _defineProperty(_ref, "testProduct", []), _ref;
  },
  created: function created() {
  ...
  methods: {
    ...
    init: function init() {
      ...
      var self = this; // this.getProfileOwnerProducts();
    ...
    getProfileOwnerProducts: function getProfileOwnerProducts() {
      ...
      axios.post("/get_product_list_by_user_name", {
        ...
        _this3.testProduct = response.data.products;
      });
    },
    showProfileOwnerDescription: function showProfileOwnerDescription() {
      var _this4 = this;

      this.registerComponentStatistics("profileView", "profileDescription", "click on profile description"); // this.getProfileOwnerProducts();
