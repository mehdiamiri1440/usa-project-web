  ...
  data: function data() {
    return {
      ...
      step2: {
        ...
        now: null,
        verification: {
          verifycode1: step2.verification_code.substring(0, 1),
          verifycode2: step2.verification_code.substring(1, 2),
          verifycode3: step2.verification_code.substring(2, 3),
          verifycode4: step2.verification_code.substring(3, 4),
          currentCode: ""
        }
      },
