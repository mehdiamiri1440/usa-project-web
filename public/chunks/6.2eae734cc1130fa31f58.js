...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    openPhone: function openPhone() {
      ...
      console.log("ready for analytics when user login");
    ...
    routeToPage: function routeToPage(routeName) {
      ...
      console.log("when click on mahsol baraye forosh daram");
      this.$parent.registerComponentStatistics("", "", "");
    ...
    openLoginModal: function openLoginModal(isChat) {
      ...
      if (isChat) {
        ...
        console.log("click on chat button when user not logged in");
        this.$parent.registerComponentStatistics("", "", "");
      } else {
        // ready for analytics
        // click on phone call button when user not logged in
        console.log("click on phone call button when user not logged in");
        this.$parent.registerComponentStatistics("", "", "");
      }
    ...
    openChat: function openChat() {
      ...
      console.log("click on chat button when user login");
      this.$parent.registerComponentStatistics("", "", "");
      // this.closeModal();
