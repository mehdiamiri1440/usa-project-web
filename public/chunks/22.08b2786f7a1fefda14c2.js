...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_layouts_header_header__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_layouts_footer_footer__ = __webpack_require__(700);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setMenuClass: function setMenuClass(categories) {
    ...
    setSubMenuClass: function setSubMenuClass(categories) {
      var categoryLength = Object.keys(categories.subcategories).length;
      if (categoryLength <= 5) {
        return "col-sm-12";
      } else if (categoryLength <= 10) {
          ...
          [
            _c("div", { staticClass: "wrapper-nav" }, [
              _c("div", { staticClass: "search-input hidden-xs" }, [
                _c("div", { staticClass: "dropdown-categories" }, [
                  _vm._m(5),
                  _vm._v(" "),
                  _c(
                    "ul",
                            ...
                            _vm._l(category.subcategories, function(
                              ...
                              return _c(
                                "li",
                                {
                                  ...
                                  class: [_vm.setMenuClass(subCategory)]
                                },
                                [
                                  _c("a", {
                                    ...
                                    _vm._l(subCategory.subcategories, function(
                                      ...
                                      return _c(
                                        "li",
                                        {
                                          ...
                                          class: [
                                            _vm.setSubMenuClass(subCategory)
                                          ]
                                        },
                                        [
                                          _c("router-link", {
                          ...
                          _vm._l(subCategory.subcategories, function(
                            ...
                            return _c(
                              "li",
                              {
                                key: index + "last-sub-menu",
                                staticClass: "col-xs-12",
                                class: [_vm.setSubMenuClass(subCategory)]
                              },
                              [
                                _c("router-link", {
                                  staticClass: "sub-menu-title",
