...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setProvince: function setProvince(provinceId, provinceName) {
      ...
      this.cities = this.$parent.step3.provinceList.find(function (item) {
        return item.id == provinceId;
      }).cities;

      if (!this.cities || !Array.isArray(this.cities) && !Object.entries(this.cities).length) this.cities = {};

      if (!Array.isArray(this.cities)) this.cities = Object.values(this.cities);
