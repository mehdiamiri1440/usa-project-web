...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    openCategoriesModal: function openCategoriesModal(categoryname) {
      var categoryId = this.getGategoryIdByName(categoryname);
    ...
    getGategoryIdByName: function getGategoryIdByName(categoryName) {
      var itemId = void 0;

      itemId = this.categoryList.map(function (item) {
