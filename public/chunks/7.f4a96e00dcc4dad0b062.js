...
throw new Error("Cannot find module \"./location-components/select-cites.vue\"");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    SelectCities: __WEBPACK_IMPORTED_MODULE_1__location_components_select_cites_vue___default.a
  },
  props: ['categoryList'],
  data: function data() {
    return {
