...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      var textWrapper = document.getElementById("imageuploadify-message");
      var cameraIcon = document.createElement('i');
      cameraIcon.classList = "form-check form-check-inline";
      iconWrapper.innerHTML = "";
      iconWrapper.appendChild("<i class='fas fa-camera'></i>");
      iconWrapper.appendChild("<i class='fa fa-plus-square'></i>");
