...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleBackBtnClickOnDevices: function handleBackBtnClickOnDevices() {
      var self = this;
      console.log(window.history.state && !this.isFilterModalActive && !this.isSortModalActive);
      if (window.history.state && !this.isFilterModalActive && !this.isSortModalActive) {
