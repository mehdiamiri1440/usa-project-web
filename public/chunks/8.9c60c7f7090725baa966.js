...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    $("#register-modal").on("hidden.bs.modal", function (e) {
      if (_this10.$parent.currentUser.user_info) {
        _this10.openChatOrCall(_this10.$parent.currentUser);
      }
    });
  },
        ...
        _c("div", { staticClass: "collapse", attrs: { id: "stock" } }, [
          _c("label", { attrs: { for: "user-stock" } }, [
            ...
            _c("span", {
              staticClass: "light-green-text",
              domProps: {
                textContent: _vm._s(this.$parent.product.main.sub_category_name)
              }
            }),
            _vm._v(" "),
            _c("span", {
              staticClass: "light-green-text",
              domProps: { textContent: _vm._s(" از نوع ") }
            }),
            _vm._v(" "),
            _c("span", {
              staticClass: "light-green-text",
