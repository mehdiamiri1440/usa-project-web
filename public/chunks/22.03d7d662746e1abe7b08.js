    ...
    handelScroll: function handelScroll() {
      ...
      $(window).scroll(function () {
        ...
        if ($(window).scrollTop() > 60 && state > lastScroll) {
          navbar.addClass("scrollUp").removeClass("absolute-position");
        } else if ($(window).scrollTop() < 60 && state < lastScroll || $(window).scrollTop() > 60 && state < lastScroll) {
          navbar.removeClass("scrollUp").addClass("absolute-position");
        }
  ...
  return _c("div", [
    ...
    _c("nav", { staticClass: "navbar text-rtl" }, [
      ...
      _c("div", { staticClass: "container-fluid buskool-sub-menu hidden-xs" }, [
        _c(
          "ul",
          { staticClass: "nav navbar-right navbar-nav absolute-position" },
