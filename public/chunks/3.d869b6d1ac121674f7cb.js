...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    filledAllInput: function filledAllInput() {
      if (this.$parent.product.productـفغحث != "" && this.$parent.product.stock != "" && this.$parent.product.minSaleAmount != "" && this.$parent.product.minSalePrice != "" && this.$parent.product.maxSalePrice != "") {
        this.isActive = true;
        return true;
      } else {
        return false;
