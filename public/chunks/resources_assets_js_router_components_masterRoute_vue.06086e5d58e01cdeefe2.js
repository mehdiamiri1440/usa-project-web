...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var visible = false; // import { eventBus } from "../../../router/router";
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    eventBus.$on("submitSuccess", function ($event) {
      _this.popUpMsg = $event;
    });
    eventBus.$on("submiting", function ($event) {
      _this.submiting = $event;
    });
    eventBus.$on("isLoading", function ($event) {
      _this.isLoading = $event;
    });
    eventBus.$on("deleteButtonText", function (event) {
      _this.deleteButtonText = event;
    });
    eventBus.$on("cancelButtonText", function (event) {
      _this.cancelButtonText = event;
    });
    eventBus.$on("productId", function (event) {
      _this.productId = event;
    });
    eventBus.$on("textSearch", function (event) {
      _this.mainSearchBoxText = event;
    });
    eventBus.$on("messageCount", function (event) {
