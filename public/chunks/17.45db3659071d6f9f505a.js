...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    feed: function feed() {
      ...
      console.log(this.filterCategory ? true : false);
      var data = {};
      if (!this.filterCategory) {
        ...
        axios.post("/get_related_buyAds_list_to_the_seller", {
          ...
          if (response.data.buyAds.length > 0) {
            _this2.buyAds = _this2.allBuyAds.concat(response.data.buyAds);
            _this2.load = false;
          } else {
            self.continueToLoadProducts = false;
            self.load = false;
    ...
    filterBuyAdByCategory: function filterBuyAdByCategory() {
      ...
      console.log(this.filterCategory.id);
      if (this.filterCategory.id != 0) {
        this.continueToLoadProducts = true;
        this.buyAds = "";
