            ...
            if (newFile && !oldFile) {
                ...
                if (newFile.file && newFile.type.substr(0, 6) === 'image/' && this.autoCompress > 0 && this.autoCompress < newFile.size) {
                    ...
                    imageCompressor.compress(newFile.file, Options).then(function (file) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_blueimp_load_image___default.a.parseMetaData(file, {}
                        // maxWidth: 600,
                        // orientation: 1,
                        // canvas: false
                        ...
                        _this.$refs.upload.update(file, { error: '', file: file, size: file.size, type: file.type });
