    ...
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        if (response.data.status === true) {
          ...
          // this.goToStep(2);
          _this2.errors.step2.verification_code = "کد وارد شده صحیح نیست یا منقضی شده است";
        ...
        this.goToStep(2);
        this.errors.step2.verification_code = "وارد کردن کد الزامی است.";

        this.registerComponentStatistics("Register-Error", "verification-code-empty", "error:" + this.errors.verification_code[0]);
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reSendCode: function reSendCode() {
      this.currentCode = "";
      this.code.verifycode1 = "";
      this.code.verifycode2 = "";
      this.code.verifycode3 = "";
