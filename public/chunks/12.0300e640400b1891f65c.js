  ...
  watch: {
    "code.verifycode1": function codeVerifycode1(value) {
      if (value) {
        ...
        if (error) this.errors.verifycode1 = error;
      }
    },
    "code.verifycode2": function codeVerifycode2(value) {
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode2 = error;
      }
    },
    "code.verifycode3": function codeVerifycode3(value) {
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode3 = error;
      }
    },
    "code.verifycode4": function codeVerifycode4(value) {
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode4 = error;
      }
    }
  }
});
