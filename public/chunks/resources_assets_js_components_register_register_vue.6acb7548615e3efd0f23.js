...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    if (this.isUserLogin && this.userType == 1) {// if (this.isUserInInquirySubmissionProcess()) {
      // this.returnUserToPreviousPageAndChatBox(userInfo);
      // } else {
      // this.$router.push("/seller/register-product");
      // }
    } else if (this.isUserLogin && this.userType != 1) {// self.returnUserToPreviousPageAndChatBox(userInfo);
