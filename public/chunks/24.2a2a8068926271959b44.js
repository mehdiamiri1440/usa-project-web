...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setList: function setList(index, id, name) {
      this.dataList = [];
      if (this.sortCurrentStep == 0) {
        this.categoryIndex = index;

        this.modalTitle = name;
        this.dataList = Object.values(this.categories[this.categoryIndex].subcategories);
        this.sortCurrentStep = 1;
      } else if (this.sortCurrentStep == 1) {
        console.log(this.categories[this.categoryIndex].subcategories[id], id, this.categoryIndex);

        var subCategory = this.categories[this.categoryIndex].subcategories[id];
        // this.$parent.sortBuyAdRequests(subCategory);
        // this.sortResetData();
      }
      // console.log(this.categories[this.categoryIndex].subcategories, index);
      // console.log(this.categories[this.categoryIndex].subcategories[index]);
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "main-text" }, [
      _vm.$parent.dataList.length > 0 && _vm.$parent.sortCurrentStep == 0
        ? _c(
            "ul",
              ...
              return _c("li", { key: index }, [
                _c("button", {
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      _vm.$parent.setList(index, item.id, item.category_name)
                    }
                  }
                }),
                _vm._v(" "),
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.$parent.dataList.length > 0 && _vm.$parent.sortCurrentStep == 1
        ? _c(
            "ul",
            { staticClass: "form-check-wrapper" },
            _vm._l(_vm.$parent.dataList, function(item, index) {
