...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkCookie: function checkCookie() {
      ...
      console.log(this.active_pakage_type);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      cancelButtonText: "",
      ProductId: "",
      isFixAlert: this.$parent.isRequiredFixAlert
    };
  },
  methods: {
    init: function init() {
      ...
      axios.post("/user/profile_info").then(function (response) {
        _this.isLoading = false;
        _this.$parent.active_pakage_type = _this.currentUser.user_info.active_pakage_type;
        return _this.currentUser = response.data;
      });
    },
    RegisterBasicProfileInfo: function RegisterBasicProfileInfo() {
