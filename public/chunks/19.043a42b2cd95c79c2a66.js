...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    verificationButtonClick: function verificationButtonClick() {
      this.$parent.registerComponentStatistics("buyerProfileBasic", "route-to-verification", "route to verification page from completion profile");
      this.$router.push({ name: "profileBasicBuyerVeficiation" });
    },
    referralButtonClick: function referralButtonClick() {
      this.$parent.registerComponentStatistics("buyerProfileBasic", "open-share-invite-link", "click on buyer invite button");
      this.openShareModal();
    },
