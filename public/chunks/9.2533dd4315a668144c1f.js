...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setProvince: function setProvince(provinceId) {
      var provinceCities = this.$parent.provinceList.find(function (item) {
        return item.id == provinceId;
      }).cities;

      if (!provinceCities || !Array.isArray(provinceCities) && !Object.entries(provinceCities).length) this.cities = {};

      if (!Array.isArray(provinceCities)) this.cities = Object.values(provinceCities);
    ...
    itemsSearched: function itemsSearched() {
      ...
      if (this.isProvince) {
        ...
        return this.items.filter(function (item) {
          return item.city_name.indexOf(_this.searchText) >= 0;
        });
      }
    }
  },
        ...
        _c("div", { staticClass: "col-xs-12" }, [
          ...
          _c("div", { staticClass: "input-wrapper search-wrapper" }, [
            _c("input", {
              ...
              attrs: {
                id: "search",
                type: "text",
                placeholder: _vm.isProvince ? "جستجوی شهر" : "جستجوی استان"
              },
          ...
          _c("div", { staticClass: "list-wrapper" }, [
            _vm.isProvince
              ...
              : _c(
                  "ul",
                  _vm._l(_vm.cites, function(city, index) {
                    return _c("li", { key: index }, [
                      _c("button", {
  ...
  methods: {
    ...
    getProvinceList: function getProvinceList() {
      ...
      axios.post("/location/get_location_info", { cascade_list: true }).then(function (response) {
        return _this3.step3.provinceList = response.data.provinces;
      });
    },
    registerComponentStatistics: function registerComponentStatistics(categoryName, actionName, labelName) {
      gtag("event", actionName, {
