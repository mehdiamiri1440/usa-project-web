  ...
  return _c("div", [
    _c("h2", { staticClass: "title-contents col-xs-12" }, [
      _vm.$parent.categoryName == "میوه"
        ? _c("img", {
            attrs: { src: __webpack_require__(413) }
          })
  ...
  return _c("div", [
    _c(
      "article",
      {
        ...
        class: { "is-user-valid": _vm.active_pakage_type == 3 }
      },
      [
        _c("div", { staticClass: "user-information-wrapper row" }, [
        ...
        _c(
          "div",
          { staticClass: "main-article text-center" },
          [
            _c(
              "router-link",
              {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "section-title related-product" }, [
      ...
      _vm._v(" "),
      _c("p", [_vm._v("فروشندگان پیشنهادی از طرف باسکول برای محصول شما.")])
    ])
  },
  function() {
    var _vm = this
