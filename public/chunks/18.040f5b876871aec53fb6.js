...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    verificationButtonClick: function verificationButtonClick() {
      this.$parent.registerComponentStatistics("sellerProfileBasic", "route-to-verification", "route to verification page from completion profile");
      this.$router.push({ name: "profileBasicSellerVeficiation" });
    },
    referralButtonClick: function referralButtonClick() {
      this.$parent.registerComponentStatistics("sellerProfileBasic", "route-to-invite-page", "click on seller invite button");
