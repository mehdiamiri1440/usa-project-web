  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("img", {
          attrs: {
            src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../img/product-registration-restrictions-icon.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
            alt: ""
          }
        })
      ]
