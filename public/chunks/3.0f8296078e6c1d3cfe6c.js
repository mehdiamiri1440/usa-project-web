...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    productFormData: function productFormData() {
      ...
      $parent.product.stock = this.stock;
      $parent.product.min_sale_amount = this.min_sale_amount;
      $parent.product.min_sale_price = this.minSalePrice;
      $parent.product.max_sale_price = this.maxSalePrice;
