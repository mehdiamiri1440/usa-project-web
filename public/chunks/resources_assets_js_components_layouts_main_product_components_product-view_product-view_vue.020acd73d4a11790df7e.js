...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup() {
    ...
    useMeta(computed(function () {
      var _this$something$field, _this$something;

      return {
        title: (_this$something$field = (_this$something = _this.something) === null || _this$something === void 0 ? void 0 : _this$something.field) !== null && _this$something$field !== void 0 ? _this$something$field : "Default"
      };
    }));
  },
  components: {
