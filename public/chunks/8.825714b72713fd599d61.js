...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21b8afd2_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_invite_vue__ = __webpack_require__(953);
    ...
    getTotalPriceForPay: function getTotalPriceForPay(packageType) {
      ...
      switch (packageType) {
        case 1:
          ...
          break;
        case 3:
          if (prices["type-3-discount"]) {
            price = prices["type-3-discount"] / 10;
          } else {
            price = prices["type-3"] / 10;
          }
          break;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pricing_user_carousel__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pricing_tables_pricing_package_contents__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sweetalert_min_js__ = __webpack_require__(34);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0a2d8bd0_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pricing_table_seller_content_vue__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_beb261f8_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pricing_user_carousel_vue__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var render = function() {
  ...
  return _c("div", { staticClass: "col-xs-12" }, [
    ...
    _c(
      "div",
      { staticClass: "fix-botton-wraper hidden-sm hidden-md hidden-lg" },
      [
        _c(
          "button",
          {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__owl_carousel_min__ = __webpack_require__(173);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__invite_components_register_invited_user_vue__ = __webpack_require__(925);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_invited_user_steps_register_number__ = __webpack_require__(928);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_invited_user_steps_verified_code__ = __webpack_require__(932);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register_invited_user_steps_personal_information__ = __webpack_require__(936);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__register_invited_user_steps_location__ = __webpack_require__(940);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__register_invited_user_steps_activity_type__ = __webpack_require__(944);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__register_invited_user_steps_register_loader__ = __webpack_require__(948);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_device_uuid_lib_device_uuid__ = __webpack_require__(244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dashboard_seller_pricing_seller_page_pricing_table_seller_content_vue__ = __webpack_require__(282);
//
//
//
//
  ...
  methods: {
    ...
    sendVerificationCode: function sendVerificationCode() {
      ...
      axios.post("/send_verification_code", {
        ...
        _this2.registerComponentStatistics("Register", "send-verification-code", "verification-code-sent-to-user");
      }).catch(function (err) {
        _this2.step1.sendCode = false;
        ...
        _this2.registerComponentStatistics("Register-Error", "phone-number-verification", "error:" + _this2.errors.phone);
      });
    },
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        if (response.data.status === true) {
          ...
          _this3.registerComponentStatistics("Register-Error", "verification-code-wrong", "error:" + _this3.errors.verification_code);
        }
        ...
        _this3.registerComponentStatistics("Register-Error", "verification-code-empty", "error:" + _this3.errors.verification_code);
      });
    },
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f5f73d9_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_invited_user_vue__ = __webpack_require__(952);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27be26d7_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_number_vue__ = __webpack_require__(931);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2cdf5314_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_verified_code_vue__ = __webpack_require__(935);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3d8763ab_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_personal_information_vue__ = __webpack_require__(939);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_39a9ed7e_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_location_vue__ = __webpack_require__(943);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19845648_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_activity_type_vue__ = __webpack_require__(947);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
                ...
                [
                  _c(
                    "select",
                    {
                      ...
                      staticClass: "dire",
                      class: { error: _vm.$parent.errors.categoryId },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_50cf06a1_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_loader_vue__ = __webpack_require__(951);
