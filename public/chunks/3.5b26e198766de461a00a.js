...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    productFormData: function productFormData() {
      this.$parent.product.product_type = this.$parent.product.product_type;
      this.$parent.product.stock = this.$parent.product.stock;
      this.$parent.product.min_sale_amount = this.$parent.product.min_sale_amount;
      this.$parent.product.min_sale_price = this.$parent.product.min_sale_price;
      this.$parent.product.max_sale_price = this.$parent.product.max_sale_price;
    ...
    filledAllInput: function filledAllInput() {
      if (this.$parent.product.productName != "" && this.$parent.product.stock != "" && this.$parent.product.minSaleAmount != "" && this.$parent.product.minSalePrice != "" && this.$parent.product.maxSalePrice != "") {
        this.isActive = true;
        return true;
      } else {
        return false;
            ...
            class: [
              {
                active:
                  ...
                  this.$parent.product.productName != "" &&
                  this.$parent.product.stock != "" &&
                  this.$parent.product.minSaleAmount != "" &&
                  this.$parent.product.minSalePrice != "" &&
                  this.$parent.product.maxSalePrice != ""
              }
            ],
            on: {
              click: function($event) {
