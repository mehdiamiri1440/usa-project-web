...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {},
  watch: {
    "productType": function productType(e) {
      if (e) {
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.productType,
              expression: "$parent.product.productType"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا: مضافتی" },
          domProps: { value: _vm.$parent.product.productType },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "productType", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
