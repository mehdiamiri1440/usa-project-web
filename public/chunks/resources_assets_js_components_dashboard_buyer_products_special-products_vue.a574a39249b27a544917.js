...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    resetFilter: function resetFilter() {// reset text data from header for syncing
