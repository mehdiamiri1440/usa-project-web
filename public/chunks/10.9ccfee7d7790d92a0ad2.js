  ...
  methods: {
    ...
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        _this2.goToStep(2);
        _this2.errors.step2.verification_code = "وارد کردن کد الزامی است.";

        _this2.registerComponentStatistics("Register-Error", "verification-code-empty", "error:" + _this2.errors.verification_code[0]);
      });
    },
