...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setUserInfoStatistics: function setUserInfoStatistics() {
      var _this3 = this;

      $(".user-information-content").on("click", function () {
        console.log('user-name');
        _this3.$parent.registerComponentStatistics("product", "show-profile-by-name", "click on user name to show user profile");
      });
      $(".user-information-content-image").on("click", function () {
        console.log('user-photo');
        _this3.$parent.registerComponentStatistics("product", "show-profile-by-photo", "click on user photo to show user profile");
      });
    }
  },
  mounted: function mounted() {
    ...
    "$parent.product.user_info": function $parentProductUser_info() {
      ...
      if (this.$parent.product.user_info) {
        this.$nextTick(function () {
          ...
          _this5.userDescriptionStatus();
          _this5.setUserInfoStatistics();
        });
      }
    }
  }
