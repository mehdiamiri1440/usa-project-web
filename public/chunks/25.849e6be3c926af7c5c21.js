...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    ...
    activityType: function activityType(item) {
      ...
      if (this.name.length && this.family.length && this.$parent.errors.name == "" && this.$parent.errors.family == "" && this.$parent.step3.province && this.$parent.step3.city && this.$parent.step4.activity_type !== "" && this.$parent.step4.category_id !== "") {
        this.$parent.errorFlag = false;
      }
    }
  }
