...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("shareToSocialModal", {
        attrs: { shareModalUrl: _vm.baseUrl, shareModalText: _vm.shareText }
      }),
      _vm._v(" "),
              ...
              _c("p", {
                ...
                domProps: {
                  textContent: _vm._s(
                    _vm.baseUrl +
                      "invite/" +
                      _vm.currentUser.user_info.user_name
                  )
                }
              }),
              _vm._v(" "),
  ...
  function() {
    ...
    return _c(
      "button",
      {
        ...
        attrs: { "data-toggle": "modal", "data-target": "#share-modal" }
      },
      [
