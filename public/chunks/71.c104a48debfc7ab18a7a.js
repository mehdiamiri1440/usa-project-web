...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculatePrice: function calculatePrice(increase) {
      var number = Number(this.toLatinNumbers(this.price));
    ...
    _c(
      ...
      [
        ...
        _c("div", { staticClass: "payment-wrapper" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "payment-buttons" }, [
            _c(
              "button",
              {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "input-text-wrapper text-center" }, [
            _c("p", { staticClass: "error-message" }, [
              _vm.priceError
                ? _c("span", {
                    staticClass: "red-text",
                    domProps: { textContent: _vm._s(_vm.priceError) }
                  })
                : _vm._e()
            ])
          ]),
          ...
          _c(
            "div",
            {
              staticClass: "item-action text-center",
