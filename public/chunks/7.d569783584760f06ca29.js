...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "full-messaging-ceiling-image-wrapper" }, [
      _c("img", {
        attrs: {
          src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../img/my_requests_not_found.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
          alt: ""
        }
      })
    ])
