...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    openChat: function openChat(product) {
      ...
      if (this.current_user.user_info) {
        if (this.current_user.user_info.id !== this.user_info.id) {
          eventBus.$emit("ChatInfo", contact); // window.localStorage.setItem("contact", JSON.stringify(contact));
    ...
    deleteProduct: function deleteProduct() {
      ...
      eventBus.$emit("modal", "deleteProduct"); // $("#deleteModal").modal("show");
  ...
  methods: {
    ...
    copyProfileLinkToClipBoard: function copyProfileLinkToClipBoard(contentId) {
      ...
      if (this.isDeviceMobile()) {
        ...
        eventBus.$emit("shareModalUrl", _url);
      }
    },
