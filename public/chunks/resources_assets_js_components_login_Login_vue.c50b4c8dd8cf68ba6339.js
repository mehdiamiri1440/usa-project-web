...
/* harmony import */ var _login_steps_login_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login_steps/login_page */ "./resources/assets/js/components/login/login_steps/login_page.vue");
/* harmony import */ var _login_steps_forgot_password__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login_steps/forgot_password */ "./resources/assets/js/components/login/login_steps/forgot_password.vue");
/* harmony import */ var _login_steps_verify_code__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login_steps/verify_code */ "./resources/assets/js/components/login/login_steps/verify_code.vue");
/* harmony import */ var device_uuid_lib_device_uuid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! device-uuid/lib/device-uuid */ "./node_modules/device-uuid/lib/device-uuid.js");
/* harmony import */ var device_uuid_lib_device_uuid__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(device_uuid_lib_device_uuid__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    loginPage: _login_steps_login_page__WEBPACK_IMPORTED_MODULE_1__.default,
    ForgotPassword: _login_steps_forgot_password__WEBPACK_IMPORTED_MODULE_2__.default,
    VerifyCode: _login_steps_verify_code__WEBPACK_IMPORTED_MODULE_3__.default
  },
  ...
  methods: {
    ...
    doLogin: function doLogin() {
      ...
      var deviceInfo = new (device_uuid_lib_device_uuid__WEBPACK_IMPORTED_MODULE_4___default().DeviceUUID)();
      var deviceId = null;
    ...
    verifyCode: function verifyCode() {
      ...
      axios.post("/reset_password", {
        ...
        if (response.data.status === true) {
          self.errors = [];
          _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("modal", "passwordResetSuccess");
          self.currentStep = 1;
    ...
    returnUserToPreviousPageAndChatBox: function returnUserToPreviousPageAndChatBox(userInfo) {
      if (this.isUserInInquirySubmissionProcess()) {
        ...
        if (userInfo.id != _contact.contact_id) {
          ...
          _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("ChatInfo", _contact);
        } else {
          this.redirectUserToPanel(userInfo);
        }
      } else {
