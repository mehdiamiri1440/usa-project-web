...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
throw new Error("Cannot find module \"./fitler-modal-steps/fitler-content\"");
throw new Error("Cannot find module \"./fitler-modal-steps/fitler-content-deep-two\"");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    FitlerContent: __WEBPACK_IMPORTED_MODULE_0__fitler_modal_steps_fitler_content___default.a,
    FitlerContentDeepTwo: __WEBPACK_IMPORTED_MODULE_1__fitler_modal_steps_fitler_content_deep_two___default.a
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    submitsubCategory: function submitsubCategory(subCategory) {
      this.$parent.fitlerBuyAdRequests(subCategory);
