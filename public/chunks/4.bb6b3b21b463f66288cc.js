...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_dashboard_seller_pricing_seller_page_pricing_tables_pricing_package_contents__ = __webpack_require__(817);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    is_pricing_active: function (_is_pricing_active) {
      function is_pricing_active() {
        return _is_pricing_active.apply(this, arguments);
      }

      is_pricing_active.toString = function () {
        return _is_pricing_active.toString();
      };

      return is_pricing_active;
    }(function () {
      console.log("is active change");
      if (is_pricing_active == true) $("#pricing-modal").modal("show");
    })
  },
  mounted: function mounted() {
    var _this3 = this;
...
var render = function() {
  ...
  return _c("div", { staticClass: "col-xs-12" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "pull-right col-xs-12 col-sm-6 col-lg-6" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "pull-left col-xs-12 col-sm-6 col-lg-6" }, [
        _c("div", { staticClass: "item-wrapper wrapper-background" }, [
          _vm._m(2),
          _vm._v(" "),
          _c("div", { staticClass: "item-content" }, [
