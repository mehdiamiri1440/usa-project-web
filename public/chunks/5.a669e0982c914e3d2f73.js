...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    "$parent.product.main": function $parentProductMain() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_1__custom__["a" /* isElementShowInView */])(".related-product", function (isInView) {
        if (isInView) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return isElementShowInView; });
var isElementShowInView = function isElementShowInView(element) {
