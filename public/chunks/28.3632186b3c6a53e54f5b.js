  ...
  methods: {
    init: function init() {
      ...
      axios.post("/get_my_buyAds").then(function (response) {
        self.buyAds = response.data.buyAdsک;
        self.load = false;
      });
    },
    ...
    deleteBuyAd: function deleteBuyAd(id) {
      __WEBPACK_IMPORTED_MODULE_0__router_router__["b" /* eventBus */].$emit("buyAdId", 1);
  ...
  function() {
    ...
    return _c("div", { staticClass: "table-wrapper" }, [
      _c("table", [
        ...
        _vm._v(" "),
        _c("tr", [
          _c("td", [_vm._v("میزان نیاز مندی")]),
          _vm._v(" "),
          _c("td", [_vm._v("2,000 تن")])
        ]),
        _vm._v(" "),
        _c("tr", [
