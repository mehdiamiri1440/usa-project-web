...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    init: function init() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_5__scripts_custom__["a" /* isElementShownInView */])("#reviews-section", function (isInView) {
        if (isInView) {
          _this.getReviews();
        }
      }, 100);
      Object(__WEBPACK_IMPORTED_MODULE_5__scripts_custom__["a" /* isElementShownInView */])("#product-section", function (isInView) {
        if (isInView) {
