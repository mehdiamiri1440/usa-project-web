...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      console.log(this.$parent.checkCookie());
      if (this.$parent.checkCookie()) {
        this.getCookie("confirmProduct");
      } else {
        alert("in kharid monghazi shode ");
      }
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "confirm-product-contents" }, [
    _c("section", { staticClass: "product-section-wrapper" }, [
      !_vm.$parent.currentUser.user_info.id && !_vm.$parent.profileIsLoad
