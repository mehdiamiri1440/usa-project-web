...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_701aa952_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_product_category_vue__ = __webpack_require__(910);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getCategoryItem: function getCategoryItem(categories) {
      ...
      var _loop = function _loop(i) {
        var categoryName = _this5.getCategoryName();

        if (categories[i].category_name == categoryName) {
          _this5.selectedCategory = categories[i];
          return {
            v: void 0
          };
        } else {
          ...
          if (subCategoryItem) {
            _this5.selectedCategory = subCategoryItem;
            return {
              v: void 0
            };
          } else {
    ...
    selectedCategory: function selectedCategory(category) {
      ...
      if (category) {
        axios.post("/get_related_categories", {
          ...
          _this6.dataTags = response.data.category_names;
        });
      }
    },
