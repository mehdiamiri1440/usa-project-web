        ...
        axios.post("/user/add_product", formData, {
          ...
          if (response.status === 201) {
            ...
            if (response.data.product) {
              ...
              console.log(response.data.buyAds);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.$parent.buyAds.lenght != 0 && !_vm.$parent.load
    ? _c("div", [
        !_vm.$parent.load
          ? _c(
              "ul",
                ...
                return _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "list-title right-side col-sm-6 col-xs-12  "
                      },
                      [
                        _c("span", [_vm._v("\n\t\t\t\t\tخریدار\n\t\t\t\t\t")]),
                        _vm._v(" "),
  ...
  return _c("section", { staticClass: "main-content col-xs-12" }, [
    _vm.currentStep == 7
      ? _c("div", { staticClass: "row" }, [
          ...
          _vm._v(
            "\n    " +
              _vm._s(_vm.buyAds.lenght) +
              "\n    " +
              _vm._s(_vm.buyAds.lenght > 0) +
              "\n    "
          ),
          _vm.buyAds.lenght > 0
