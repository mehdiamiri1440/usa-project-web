...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    CategoryData: function CategoryData(e) {
      for (var i = 0; i < this.getcategory().length; i++) {
        ...
        console.log(this.getcategory()[i].category_name);
        if (this.getcategory()[i].category_id === e) {
          this.getcategory()[i].cat_child;
          console.log(this.getcategory()[i].cat_child);
        }
      }
    },
  ...
  mounted: function mounted() {
    this.mainCategories = this.getcategory();
  }
});
