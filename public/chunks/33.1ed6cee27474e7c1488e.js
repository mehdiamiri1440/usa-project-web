...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: _defineProperty({
    ...
    setScrollToBuyAd: function setScrollToBuyAd(id) {
      ...
      console.log("elemetn : " + (elementTop - (windowHeight - elementHeight) / 2), "elementHeight : " + elementHeight, "windowHeight : " + windowHeight, "elementTop : " + elementTop);
      $(".contact-body.my-contacts").animate({
        scrollTop: elementTop - (windowHeight - elementHeight) / 2 + 152
      }, 300);
    },
