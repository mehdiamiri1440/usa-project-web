...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.users, function(userItem, index) {
      return _c(
        "article",
        { key: index, staticClass: "carousel-item box-content" },
        [
          _c("div", { staticClass: "carousel-img" }, [
            _vm.isImageLoad && userItem.profile_photo
              ? _c(
                  "div",
                  [
                    _c("transition", [
                      _c("img", {
                        ...
                        attrs: { src: userItem.profile_photo },
          ...
          _vm._v(" "),
          userItem.first_name.length + userItem.last_name.length >= 20
                ...
                _c("h4", {
                  domProps: {
                    textContent: _vm._s(
                      userItem.first_name +
                        " " +
                        userItem.last_name.substring(0, 15) +
                        " ..."
                    )
                  }
                })
          ...
          _c("div", { staticClass: "stock-wrapper" }, [
            _c("span", {
              domProps: {
                textContent: _vm._s(userItem.province + " - " + userItem.city)
              }
            })
          ])
        ]
    ...
    _c("div", { staticClass: "row" }, [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("pricing-user-carousel", {
            attrs: { users: _vm.$parent.activeUsers }
          })
        ],
        1
      ),
