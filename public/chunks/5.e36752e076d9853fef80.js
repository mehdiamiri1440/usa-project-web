...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__custom__ = __webpack_require__(910);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    getRelatedProducts: function getRelatedProducts() {
      ...
      axios.post("/user/get_product_list", {
        ...
        _this.$nextTick(function () {
          ...
          _this.infiniteScrollHandler(productsSection);
        });
      });
    },
    feed: function feed() {
      ...
      axios.post("/user/get_product_list", {
        ...
        _this2.$nextTick(function () {
          var productsSection = $("div.items-wrapper:last-of-type");
          _this2.infiniteScrollHandler(productsSection);
        });

        self.loadMoreActive = false;
      });
    },
    infiniteScrollHandler: function infiniteScrollHandler(productsSection) {
      var _this3 = this;
  ...
  mounted: function mounted() {
    Object(__WEBPACK_IMPORTED_MODULE_1__custom__["a" /* findElementOffset */])("aside", function (element) {
      console.log(element);
    });
  },
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return findElementOffset; });
var findElementOffset = function findElementOffset(element) {
