...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      categoryList: "",
      buyAdPostCount: 20
    }, _defineProperty(_ref, "buyAdPostCount", 20), _defineProperty(_ref, "loadMoreActive", false), _defineProperty(_ref, "continueToLoadProducts", true), _defineProperty(_ref, "categoryId", 0), _ref;
  },
  methods: {
    init: function init() {
      this.load = true;
