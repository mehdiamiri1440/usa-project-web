            ...
            [
              _c("div", { staticClass: "title-contents" }, [
                _c("div", { staticClass: "user-image" }, [
                  _c("img", {
                    attrs: {
                      src: _vm.$parent.str + "/" + _vm.userProfilePhoto,
                      alt: ""
                    }
                  })
                ]),
              ...
              _c("div", { staticClass: "form-contents col-xs-12" }, [
                _c("div", { staticClass: "row" }, [
                  _c("div", { staticClass: "col-xs-12 pull-right" }, [
                    _c("p", { staticClass: "text-rtl red-text" }, [
                      _vm._v("استعلام شرایط فروش "),
                      _c("span", {
                        domProps: {
                          textContent: _vm._s(_vm.userProfileInfo.product_name)
                        }
                      })
                    ])
                  ]),
                  ...
                  _c("div", { staticClass: "col-xs-12 pull-right" }, [
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n              نیاز به دانستن چه جزییاتی درباره ی این محصول دارید؟\n            "
                        )
                      ]
                    ),
                    _vm._v(" "),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_product_list_carousel__ = __webpack_require__(281);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_view_product__ = __webpack_require__(477);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_view_user_info__ = __webpack_require__(487);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_components_register_inquiry_form_vue__ = __webpack_require__(313);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    openChat: function openChat(product) {
      ...
      var productName = product.main.subcategory_name + ' ' + product.main.product_name;
      var contact = {
        ...
        product_name: product.main.product_name
      };
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__carousel__ = __webpack_require__(483);
