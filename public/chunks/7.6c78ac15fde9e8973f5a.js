  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        "div",
        {
          staticClass: "report-modal modal fade",
          attrs: { id: "report-modal", tabindex: "-1", role: "dialog" }
        },
        [
          _c(
            "div",
            ...
            [
              _c("div", { staticClass: "modal-content" }, [
                ...
                _c(
                  ...
                  [
                    _vm.reportCurrentStep == 0 ? _c("ReportContent") : _vm._e(),
                    _vm._v(" "),
                    _vm.reportCurrentStep == 1
                      ? _c("ReportDescription")
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.reportCurrentStep == 2 ? _c("FinalStep") : _vm._e()
                  ],
                  1
                )
              ])
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "rate-filter-mobile-wrapper" }, [
      _c("div", { staticClass: "rate-filter" }, [
        _c("label", { attrs: { for: "filter-select" } }, [
          _vm._v("\n          مرتب سازی بر اساس\n        ")
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "filter-select-input-wrapper" }, [
          _c(
            "select",
            { staticClass: "active", attrs: { id: "filter-select" } },
            [
              _c("option", { attrs: { value: "0" } }, [
                _vm._v("احتمال پاسخ گویی")
              ]),
              _vm._v(" "),
              _c("option", { attrs: { value: "1" } }, [_vm._v("تاریخ")])
            ]
          )
        ])
      ]),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("section", { staticClass: "hidden-xs col-xs-12" }, [
      _c("div", { staticClass: "rate-filter-desktop-wrapper" }, [
        _c("ul", { staticClass: "list-unstiled list-inline" }, [
          _c("li", [
            _c("button", { staticClass: "text-green" }, [
              _vm._v("پربازدید ترین ها")
            ])
          ]),
          _vm._v(" "),
          _c("li", [_c("button", [_vm._v("بهترین ها")])]),
          _vm._v(" "),
          _c("li", [_c("button", [_vm._v("قیمت مناسب")])]),
          _vm._v(" "),
          _c("li", [_c("button", [_vm._v("مناسب ترین ها")])])
        ]),
        _vm._v(" "),
        _c(
          "button",
