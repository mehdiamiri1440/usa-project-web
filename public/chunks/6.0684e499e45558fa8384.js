  ...
  methods: {
    showAlert: function showAlert() {
      ...
      Swal.fire({
        ...
        icon: "warning",
        html: "Lorem ipsum <hr><button id='swal-confirm'>Return to editing</button> <button>Discard</button> <button>Save</button>",
        ...
        $("#swal-confirm").click(function () {
          Swal.fire("Confermed!", "Your file has been deleted.", "success");
        });
      });
    },
