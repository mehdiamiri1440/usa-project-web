...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    ImageLoaded: function ImageLoaded() {
      this.isImageLoad = true;
      this.imageLoadedUrl = this.base + "thumbnails/" + this.img;
    },
    getProductName: function getProductName() {
      var productName = "";
...
var render = function() {
  ...
  return _c("div", { staticClass: "main-article-image" }, [
    ...
    _c("div", { staticClass: "image-wrapper-contents" }, [
      ...
      _vm._v(" "),
      _c("img", {
        staticClass: "empty main-image-load",
        attrs: {
          src: "http://localhost:8000/assets/img/banners/mobile/banner-1.jpg",
          alt: _vm.alt,
          loading: "lazy"
        },
        on: { load: _vm.ImageLoaded }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__product_components_Product_grid_article__ = __webpack_require__(433);
