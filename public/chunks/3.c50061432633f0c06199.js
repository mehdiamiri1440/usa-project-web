...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    productFormData: function productFormData() {
      this.$parent.product.product_type = this.productName;
      this.$parent.product.stock = this.stock;
      this.$parent.product.min_sale_amount = this.minSaleAmount;
      this.$parent.product.min_sale_price = this.minSalePrice;
      this.$parent.product.max_sale_price = this.maxSalePrice;
    ...
    filledAllInput: function filledAllInput() {
      if (this.productName != "" && this.stock != "" && this.minSaleAmount != "" && this.minSalePrice != "" && this.maxSalePrice != "") {
        this.isActive = true;
        return true;
      } else {
        return false;
  ...
  watch: {
    "$parent.product.productName": function $parentProductProductName(e) {
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.stock,
              expression: "$parent.stock"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.stock },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent, "stock", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.minSaleAmount,
              expression: "$parent.minSaleAmount"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.minSaleAmount },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent, "minSaleAmount", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.minSalePrice,
              expression: "$parent.minSalePrice"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.minSalePrice },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent, "minSalePrice", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.maxSalePrice,
              expression: "$parent.maxSalePrice"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.maxSalePrice },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent, "maxSalePrice", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
