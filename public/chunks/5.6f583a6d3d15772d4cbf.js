            ...
            if (newFile && !oldFile) {
                ...
                if (newFile.file && newFile.type.substr(0, 6) === 'image/' && this.autoCompress > 0 && this.autoCompress < newFile.size) {
                    ...
                    imageCompressor.compress(newFile.file, Options).then(function (file) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_blueimp_load_image___default()(file, { meta: true, canvas: true, maxWidth: 800, orientation: 1 }).then(function (data) {
                            ...
                            console.log();
                            self.$refs.upload.update(blob, { error: '', file: file, size: file.size, type: file.type });
                        }).catch(function (err) {
                            console.error(err);
                        });
