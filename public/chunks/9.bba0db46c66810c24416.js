...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setProvince: function setProvince(provinceId) {
      ...
      if (!provinceCities || !Array.isArray(provinceCities) && !Object.entries(provinceCities).length) this.allCitiesList = {};

      if (!Array.isArray(provinceCities)) this.allCitiesList = Object.values(provinceCities);
  ...
  mounted: function mounted() {
    console.log(this.$parent.step3.provinceList);
            ...
            _c("div", { staticClass: "modal-content" }, [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm.currentStep == 5 ? _c("Location") : _vm._e()
                ],
                1
              )
            ])
