          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.product,
              expression: "$parent.product.product"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا: مضافتی" },
          domProps: { value: _vm.$parent.product.product },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "product", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
