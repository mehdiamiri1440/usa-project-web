    ...
    infiniteScrollHandler: function infiniteScrollHandler() {
      ...
      $(window).scroll(function () {
        ...
        if ($(window).scrollTop() + $(window).height() >= productsSection.offset().top) {
          console.log(_this2.products.length <= 12, !_this2.loadMoreActive, _this2.continueToLoadProducts, _this2.products.length <= 12 && !_this2.loadMoreActive && _this2.continueToLoadProducts);
