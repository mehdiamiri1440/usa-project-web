...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: _defineProperty({
    ...
    setScrollToBuyAd: function setScrollToBuyAd(id) {
      var element = $("#item-" + id);
      var elementTop = $("#item-" + id).scrollTop();
      var elementHeight = element.height();
      var windowHeight = $(window).height();

      console.log("elemetn : " + (152 + elementTop - (windowHeight - elementHeight) / 2), "elementHeight : " + elementHeight, "windowHeight : " + windowHeight, "elementTop : " + elementTop);
      $(".contact-body.my-contacts").animate({
        scrollTop: 152 + elementTop - (windowHeight - elementHeight) / 2
      }, 300);
    },
