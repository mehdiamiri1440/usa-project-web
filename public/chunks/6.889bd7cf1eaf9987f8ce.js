...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    handleBackForCustomModal: function handleBackForCustomModal(modalNode, className) {
      var classWithAnimation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
      ...
      $(window).on("popstate", function (e) {
        ...
        if (classWithAnimation) {
          setTimeout(function () {
            modalNode.removeClass(classWithAnimation);
          }, 300);
        }
      });
    },
    ...
    openPriceModal: function openPriceModal() {
      ...
      customModal.addClass("show-custom-modal").removeClass("height-0");
      this.handleBackForCustomModal(customModal, "show-custom-modal", "height-0");
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    closeModal: function closeModal() {
      ...
      setTimeout(function () {
        $(".price-modal").removeClass("height-0");
      }, 300);
    }
  }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "price-modal height-0" }, [
