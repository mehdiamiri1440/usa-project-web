...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("p", { staticClass: "section-image" }, [
      _c("img", {
        attrs: { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../img/hand-phone-icon-6.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }
      })
    ])
  },
  function() {
