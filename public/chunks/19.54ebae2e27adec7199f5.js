...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e20633be_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_profile_completation_vue__ = __webpack_require__(493);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
    ...
    [
      ...
      _c("div", { staticClass: "hidden", attrs: { id: "clone-box" } }, [
        _vm.$parent.profileDescription.length < 200
          ? _c("div", { staticClass: "pull-right" }, [_vm._m(1)])
          : _vm._e(),
        _vm._v(" "),
        _vm.$parent.profileDescription.length < 200
          ? _c("div", { staticClass: "pull-right" }, [_vm._m(2)])
          : _vm._e(),
        _vm._v(" "),
        !_vm.verification
      ...
      _vm._v(" "),
      _c("div", { staticClass: "owl-carousel item-wrapper col-xs-12" })
    ]
  )
}
var staticRenderFns = [
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__owl_carousel_min_js__ = __webpack_require__(194);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    resetCarousel: function resetCarousel() {
      ...
      //   $("#clone-box").empty();
      //   $("#clone-box").children().clone().appendTo(".owl-carousel");
      // } else {
      //   $("#clone-box").children().clone().appendTo(".owl-carousel");
      // }
      console.log($("#clone-box").children().clone());
