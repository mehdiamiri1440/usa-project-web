  ...
  methods: {
            ...
            axios.post("/dologin", {
              ...
              if (response.data.status) {
                if (self.isUserComeFromChatBoxOpen()) {
                  ...
                  if (response.data.is_seller && _this.checkIsMobile()) {
    ...
    getCategory: function getCategory() {
      ...
      axios.post("/get_category_list").then(function (response) {
        return _this2.step4.categoryList = response.data.categories;
      });
    },
    ...
    getCityList: function getCityList(provinceId) {
      ...
      axios.post("/location/get_location_info", {
        ...
        return _this4.step3.cityList = response.data.cities;
      });
    },
