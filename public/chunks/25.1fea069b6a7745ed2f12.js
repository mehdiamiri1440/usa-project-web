...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scripts_sweetalert_min_js__ = __webpack_require__(9);
            ...
            axios.post("/dologin", {
              ...
              if (response.data.status) {
                if (self.isUserComeFromChatBoxOpen()) {
                  __WEBPACK_IMPORTED_MODULE_5__scripts_sweetalert_min_js__["default"].close(); //close modal
