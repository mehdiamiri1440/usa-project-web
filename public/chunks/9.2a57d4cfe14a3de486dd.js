...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    textValidator: function textValidator() {
      this.toLatinNumbers(this.inquery.text);
      if (text) {
        this.errors.inqueryText = "";
      } else if (!this.validateRegx(this.inquery.text, /^[\u0600-\u06FF\s\d]+$/)) {
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.textValidator($event)
                      }
                    }
                  },
                  [_vm._v("\n              ثبت درخواست\n            ")]
