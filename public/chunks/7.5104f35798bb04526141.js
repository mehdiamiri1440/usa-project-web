...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: (_methods = {
  ...
  }), _defineProperty(_methods, "openSortModal", function openSortModal() {
  ...
  }), _defineProperty(_methods, "getSortOptionName", function getSortOptionName() {
  ...
  }), _defineProperty(_methods, "closeSortModal", function closeSortModal() {
    $("#filter-modal").modal("hide");
    history.go(-1);
  }), _defineProperty(_methods, "openFilterModal", function openFilterModal(category) {
    if (category) {
  ...
  }), _defineProperty(_methods, "closeFilterModal", function closeFilterModal() {
    $(".modal").modal("hide");
    history.go(-1);
  }), _defineProperty(_methods, "sidebarScroll", function sidebarScroll() {
  ...
  }), _defineProperty(_methods, "openStickyGuide", function openStickyGuide() {
    __WEBPACK_IMPORTED_MODULE_5__router_router__["b" /* eventBus */].$emit("modal", "guide");
  }), _defineProperty(_methods, "swithToListOnMobile", function swithToListOnMobile() {
    var _this3 = this;
    ...
    //   this.listIsGrid = true;
    // }
  }), _defineProperty(_methods, "checkSortOption", function checkSortOption() {
    var sortOption = localStorage.getItem("sortOption");
    if (sortOption) {
      this.sortOption = sortOption;
    }
  }), _defineProperty(_methods, "sedOptionAsDefault", function sedOptionAsDefault() {
    this.sortOption = "BM";
    localStorage.removeItem("sortOption");
    this.applyFilter();
  }), _defineProperty(_methods, "checkLocationFilter", function checkLocationFilter() {
    var province = localStorage.getItem("selectedProvince");
    var city = localStorage.getItem("selectedCity");
  ...
  }), _defineProperty(_methods, "getLocations", function getLocations() {
    var _this4 = this;
