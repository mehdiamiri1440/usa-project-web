...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: (0,vuex__WEBPACK_IMPORTED_MODULE_3__.mapState)({
    buyAdbuttonActive: function buyAdbuttonActive(state) {
      return state.routeStore.buyAdbuttonActive;
    }
  }),
  ...
  watch: {
    ...
    buyAdbuttonActive: function buyAdbuttonActive(value) {
      this.buttonActiveInSteps = value;
    }
  },
  mounted: function mounted() {
    this.init(); // eventBus.$on("paymentData", (event) => {
