  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      $(".product-pricing .item-wrapper").each(function () {
        $(this).prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + self.priceItem.priceItems[i].helpDescription + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        // console.log(, i);
        i++;
        console.log(self.priceItem.priceItems[i].helpDescription);
      });
      $(".item-guid").tooltip();
