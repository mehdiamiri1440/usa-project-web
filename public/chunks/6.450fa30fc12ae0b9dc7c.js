...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: ["productsInfo", "categoryId", "subCategoryId", "provinceId", "cityId", "categories"],
  data: function data() {
    return {
      provinceIdChild: "",
      cityIdChild: "",
...
/* harmony default export */ __webpack_exports__["a"] = (_data$methods$mounted = {
  data: function data() {
    return {
      selectedProvince: "",
      selectedCity: "",
  ...
  methods: {
    ...
    setProvinceFilter: function setProvinceFilter(provinceId) {
      var _this2 = this;
    ...
    filterProducts: function filterProducts() {
      if (this.selectedCity) {
        this.$parent.provinceIdChild = this.selectedProvince;
        this.$parent.cityIdChild = this.selectedCity;
        this.registerComponentStatistics("product-list", "sidebarSearch", "city");
        this.$parent.setCityFilterChild();
...
}, _defineProperty(_data$methods$mounted, "mounted", function mounted() {
  this.init();
  var self = this;
  // this.$parent.scrollSet();
  document.fonts.ready.then(function () {
...
}), _defineProperty(_data$methods$mounted, "watch", {
  selectedProvince: function selectedProvince(province) {
    this.selectedCity = "";
    if (province) {
      this.setProvinceFilter(province);
    }
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
        ...
        if (!data) {
          ...
          categoryItem.map(function (category, index) {
            ...
            if (data) {
              ...
              _this.selectedSubCategory = index + 1;
              console.log(_this.selectedCategory, _this.selectedSubCategory);
              return true;
            }
          });
        }
  ...
  watch: {
    ...
    selectedSubCategory: function selectedSubCategory() {
      console.log(this.selectedCategory, this.selectedSubCategory);
    }
  }
});
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "sidebar-buttons col-xs-12" }, [
      _c(
        "button",
        {
                            ...
                            directives: [
                              {
                                ...
                                value:
                                  ...
                                  _vm.selectedSubCategory ==
                                    subCategoryIndex + 1,
                                expression:
                                  "\n              selectedSubCategory == '' ||\n              selectedSubCategory == subCategoryIndex + 1\n            "
                              }
                            ],
                            key: subCategoryIndex,
                            class: {
                              "current-sub-category":
                                _vm.selectedSubCategory == subCategoryIndex + 1
                            }
                          },
                          [
                            _c(
