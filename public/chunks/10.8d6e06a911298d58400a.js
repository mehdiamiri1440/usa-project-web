    ...
    _c("div", { staticClass: "review-item-wrapper" }, [
      ...
      _c(
        ...
        [
          ...
          _c("p", [
            _vm._v(
              "\n        بنا بر گفته های اتحادیه صادرکنندگان برنج در پاکستان(REAP) که از افزایش\n        میزان عرضه و فروش برنج پاکستانی به کشورهای مختلف منطقه و همسایه از\n        جمله کشور جمهوری اسلامی ایران که از بزرگترین مشتریان است\n      "
            )
          ])
        ]
      ),
