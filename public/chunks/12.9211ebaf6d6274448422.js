          ...
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.$parent.step2.verifycode1,
                expression: "$parent.step2.verifycode1"
              }
            ],
            ...
            class: {
              error:
                ...
                this.$parent.errors.step2.verifycode1,
              active: _vm.verifycode1.length
            },
            attrs: { name: "code", placeholder: "_" },
            domProps: { value: _vm.$parent.step2.verifycode1 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.$parent.step2, "verifycode1", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.$parent.step2.verifycode2,
                expression: "$parent.step2.verifycode2"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.$parent.errors.step2.verifycode2,
              active: _vm.verifycode2.length
            },
            attrs: { name: "code", placeholder: "_" },
            domProps: { value: _vm.$parent.step2.verifycode2 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.$parent.step2, "verifycode2", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.$parent.step2.verifycode3,
                expression: "$parent.step2.verifycode3"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.$parent.errors.step2.verifycode3,
              active: _vm.verifycode3.length
            },
            attrs: { name: "code", placeholder: "_" },
            domProps: { value: _vm.$parent.step2.verifycode3 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.$parent.step2, "verifycode3", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.$parent.step2.verifycode4,
                expression: "$parent.step2.verifycode4"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.$parent.errors.step2.verifycode4,
              active: _vm.verifycode4.length
            },
            attrs: { name: "code", placeholder: "_" },
            domProps: { value: _vm.$parent.step2.verifycode4 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.$parent.step2, "verifycode4", $event.target.value)
              }
            }
          })
        ]),
