...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    activePhoneCall: function activePhoneCall(isGolde, buyAdUserId, buyAdId) {
      var _this = this;

      if (this.currentUser.user_info.active_pakage_type != 0 && isGolde) {
        ...
        this.openGoldenChatRestrictionModal();
      }
    },
