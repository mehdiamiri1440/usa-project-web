...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    console.log(this.verifiedUserContent);
  },
  created: function created() {
    var _this2 = this;

    __WEBPACK_IMPORTED_MODULE_0__router_router__["b" /* eventBus */].$on("globalVerifiedBadgeContents", function ($event) {
      _this2.verifiedUserContent = $event;
      console.log($event);
    });
  }
});
