...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cb882a9_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_my_buyad_list_vue__ = __webpack_require__(619);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__seller_product_register_product_steps_terms_vue__ = __webpack_require__(664);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: _defineProperty({
    ...
    getBuyAds: function getBuyAds() {
      ...
      axios.post("/get_my_buyAd_suggestions").then(function (response) {
        ...
        _this2.buyAdsGolden = [{
          id: 31,
          name: "برنج درجه یک 1121پاکستانی",
          updated_at: "2021-10-10 16:49:54",
          category_id: 6,
          requirement_amount: 1000,
          buyer_id: 75,
          subcategory_name: "برنج",
          category_name: "غلات",
          first_name: "برهان",
          last_name: "اعتمادی",
          is_golden: true,
          ...
          id: 34,
          name: "برنج عنبربو درجه ۱",
          updated_at: "2021-08-28 08:23:25",
          category_id: 6,
  ...
  mounted: function mounted() {
    ...
    $(".my-contacts").scroll(function (event) {
      ...
      var elementTop = $("#loader-phone-40").offset().top;
      var elementHeight = $(".contact-body.my-contacts").height();
      var windowHeight = $(window).height();

      elementTop - (windowHeight - elementHeight) / 2;
      console.log($(".contact-body.my-contacts").scrollTop());
      console.log($("#loader-phone-40").offset().top - $("#loader-phone-40").height() - $(window).height());
    });
  }
});
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("p", { staticClass: "section-image" }, [
      _c("img", {
        attrs: { src: __webpack_require__(304) }
      })
    ])
  },
  function() {
