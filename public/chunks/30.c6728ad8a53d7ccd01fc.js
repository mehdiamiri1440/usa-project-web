...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    prices: function prices() {
      ...
      var activePackagePercentage = this.referralUsers.wallet_balance / packagePrice * 100;
      console.log(activePackagePercentage, this.referralUsers.wallet_balance, this.prices["type-3"] / 10);
