...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    pushNotification: function pushNotification(header, body, link) {
      __WEBPACK_IMPORTED_MODULE_1_push_js__["default"].create(header, {
        body: body,
        timeout: 4000,
        link: link,
  ...
  created: function created() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_1_push_js__["default"].Permission.has() === false) {
      __WEBPACK_IMPORTED_MODULE_1_push_js__["default"].Permission.request(function () {}, function () {});
    }
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/apple/Desktop/buskool/incobac-new-cli/node_modules/push.js/bin/push.min.js'");
