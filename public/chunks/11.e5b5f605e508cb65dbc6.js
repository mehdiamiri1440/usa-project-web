  ...
  methods: {
    ...
    setPricingHeaderScroll: function setPricingHeaderScroll() {
      ...
      switch (this.$route.name) {
        case "dashboardPricingTableSeller":
          currectPage = true;
          break;
        case "dashboardProductPricing":
          currectPage = true;
          // spaces = 46;
          break;
        case "dashboardBuyAdPricing":
          currectPage = true;
          // spaces = 50;
          break;
      ...
      $(window).scroll(function () {
        ...
        if (currectPage) {
          if ($(window).scrollTop() >= pricingHeaderTop - spaces) {
