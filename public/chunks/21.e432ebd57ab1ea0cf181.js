  ...
  function() {
    ...
    return _c("div", { staticClass: "wrapper_no_pro" }, [
      _c("div", { staticClass: "content_no_pic" }, [
        _c("img", { attrs: { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../../img/my\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), alt: "" } })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "text_no_pic standard-line text-rtl" }, [
        _c("p", [_vm._v("شما محصولی را ثبت نکرده اید یا در انتظار تایید است.")])
      ])
    ])
  },
  function() {
