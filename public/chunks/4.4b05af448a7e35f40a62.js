...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SubMenu: __WEBPACK_IMPORTED_MODULE_0__sub_menu_sub_menu_vue___default.a,
    CountDown: __WEBPACK_IMPORTED_MODULE_1__count_down__["default"]
  },
  props: ["menuClosed", "photoLink", "storage", "username", "out", "routeHome", "isLoading"],
  methods: {
    init: function init() {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/apple/Desktop/buskool/incobac-new-cli/resources/assets/js/components/dashboard/seller/header/sub-com/count-down.vue'");
