  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      for (var i = 0; i < self.priceItem.priceItems.length; i++) {
        $(".product-pricing .item-wrapper").prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + self.priceItem.priceItems[index].helpDescription + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        $(".item-guid").tooltip();
      }
