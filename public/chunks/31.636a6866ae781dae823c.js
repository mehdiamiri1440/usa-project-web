...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_155b115c_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_invited_users_vue__ = __webpack_require__(511);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    prices: function prices() {
      var packagePrice = this.prices["type-3"] / 10;
      this.activePackagePercentage = Math.round(this.referralUsers.wallet_balance / packagePrice * 100);
        ...
        _c("div", { staticClass: "wallet-balance" }, [
          ...
          _c("p", { staticClass: "blue-text" }, [
            _vm._v(
              "\n          " +
                _vm._s(
                  _vm.getNumberWithCommas(_vm.referralUsers.wallet_balance)
                )
            ),
