...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getProductUrl: function getProductUrl() {
      return "/product-view/خرید-عمده-" + this.product.main.sub_category_name.replace(" ", "-") + this.product.main.province_name.replace(" ", "-") + "-" + this.main.city_name.replace(" ", "-") + "/" + this.product.main.category_name.replace(" ", "-") + "/" + this.product.main.id;
    },
