  ...
  methods: {
    ...
    checkStep3: function checkStep3() {
      ...
      if (this.errorFlag) {
        ...
        this.registerComponentStatistics("Invite-Register-Error", "step-3", "validation error in step 3");
      }
    },
    checkStep4: function checkStep4() {
      ...
      if (this.errorFlag) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "step-4", "validation error in step 4");
      }
    },
    ...
    firstNameValidator: function firstNameValidator(name) {
      ...
      if (this.errors.name) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "first-name", "input:" + name + " Error:" + this.errors.name);
      }
    },
    lastNameValidator: function lastNameValidator(family) {
      ...
      if (this.errors.family) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "last-name", "input:" + family + " Error:" + this.errors.family);
      }
    },
    ...
    provinceValidator: function provinceValidator(province) {
      ...
      if (this.errors.province) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "province", "input:" + province + " Error:" + this.errors.province);
      }
    },
    cityValidator: function cityValidator(city) {
      ...
      if (this.errors.city) {
        ...
        // update for analytics
        "Invite-Register-Error", "city", "input:" + city + " Error:" + this.errors.city);
      }
    },
    ...
    categoryIdValidator: function categoryIdValidator(categoryId) {
      ...
      if (this.errors.category_id) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "category-selection", "input:" + categoryId + " Error:" + this.errors.category_id);
      }
    },
    activityTypeValidator: function activityTypeValidator(activityType) {
      ...
      if (this.errors.activity_type) {
        // update for analytics
        this.registerComponentStatistics("Invite-Register-Error", "activity-type", "input:" + activityType + " Error:" + this.errors.activity_type);
      }
    },
