...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    "this.$parent.searchText": function this$parentSearchText(text) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["menuClosed", "photoLink", "storage", "username", "out", "routeHome", "isLoading", "searchValueText"],
  methods: {
    init: function init() {
      this.closeCollapses();
    },
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.searchValueText,
                        expression: "searchValueText"
                      }
                    ],
                    attrs: { type: "text", placeholder: "اینجا جستجو کنید" },
                    domProps: { value: _vm.searchValueText },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.searchValueText = $event.target.value
                      }
                    }
                  }),
                  _vm._v(" "),
