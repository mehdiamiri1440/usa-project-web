...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    postalCodeValidator: function postalCodeValidator() {
      this.errors.postalCode = "";
      if (this.postalCode) {
        if (!this.validateRegx(this.postalCode, /^[0-9٠-٩۰-۹\s]+$/)) {
          this.errors.postalCode = " کد پستی فقط می تواند اعداد فارسی یا لاتین باشد با فرمت مناسب باشد.";
        }
      }
    },
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { attrs: { for: "postal-code" } }, [
      _vm._v("\n              کد پستی وارد کنید\n              "),
