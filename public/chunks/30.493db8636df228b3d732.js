...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculatePrice: function calculatePrice() {
      // calculate unit price with selected amount
      this.$parent.totalPrice = this.amount * 3000000;
    },
    nextStep: function nextStep() {
      var confirmProduct = {
        product_id: this.product.main.id,
        product_stock: this.amount * 1000,
        product_unit_price: this.$parent.totalPrice,
        product_total_price: this.$parent.totalPrice
      };
      this.$parent.createCookie("confirmProduct", JSON.stringify(this.product), 30);
    }
  },
