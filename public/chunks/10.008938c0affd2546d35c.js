...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__router_js__ = __webpack_require__(4);
var _methods;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: (_methods = {
    init: function init() {
      ...
      axios.post("/get_total_unread_messages_for_current_user").then(function (response) {
        ...
        __WEBPACK_IMPORTED_MODULE_4__router_js__["b" /* eventBus */].$emit("messageCount", messageCount);
    ...
    checkGoldenBuyAd: function checkGoldenBuyAd() {
      ...
      axios.post("/get_my_buyAd_suggestions").then(function (response) {
        ...
        _this4.buyAdsGolden = [{
          id: 27822,
          name: "سیب سبز گرانی اسمیت",
          updated_at: "2021-06-24 09:08:07",
          category_id: 3,
          requirement_amount: 40000,
          buyer_id: 27501,
        ...
        console.log(_this4.buyAdsGolden);
        setTimeout(function () {
          $("#promotion-modal").modal("show");
        }, 4000);
      });
    ...
    __WEBPACK_IMPORTED_MODULE_4__router_js__["b" /* eventBus */].$emit("modal", "goldenBuyAdReplyLimit");
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_4__router_js__["b" /* eventBus */].$on("buyAdbuttonActive", function (event) {
      _this5.buttonActiveInSteps = event;
    });

    __WEBPACK_IMPORTED_MODULE_4__router_js__["b" /* eventBus */].$on("paymentData", function (event) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    "$parent.buyAdsGolden": function $parentBuyAdsGolden(goldens) {
      var buyAds = goldens;
      if (buyAds.length > 1) {
        var _randomBuyAd = Math.floor(Math.random() * buyAds.length - 1);
      }

      console.log(randomBuyAd);
