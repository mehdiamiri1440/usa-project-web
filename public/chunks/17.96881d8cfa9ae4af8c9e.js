...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_product_list_carousel__ = __webpack_require__(436);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_view_product__ = __webpack_require__(616);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_view_user_info__ = __webpack_require__(626);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_register_request__ = __webpack_require__(431);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_methods, "openChat", function openChat(product) {
    this.registerComponentStatistics("product", "openChat", "click on open chatBox");
  ...
  }), _defineProperty(_methods, "getProductUrl", function getProductUrl() {
    return "/product-view/خرید-عمده-" + this.product.main.sub_category_name.replace(" ", "-") + "/" + this.product.main.category_name.replace(" ", "-") + "/" + this.product.main.id;
  }), _defineProperty(_methods, "copyProductLinkToClipBoard", function copyProductLinkToClipBoard() {
    this.registerComponentStatistics("product", "copy-product-link", "click on copy poduct link");
  ...
  }), _defineProperty(_methods, "isDeviceMobile", function isDeviceMobile() {
    if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) {
      return true;
    } else {
      return false;
  ...
  }), _defineProperty(_methods, "editProduct", function editProduct(getProductWrapper) {
    this.submiting = true;
    this.errors = "";
  ...
  }), _defineProperty(_methods, "stopLoader", function stopLoader() {
    __WEBPACK_IMPORTED_MODULE_0__router_router__["b" /* eventBus */].$emit("isLoading", false);
  }), _defineProperty(_methods, "getRelatedProductUrl", function getRelatedProductUrl(product) {
    return "/product-view/خرید-عمده-" + product.subcategory_name.replace(" ", "-") + "/" + product.category_name.replace(" ", "-") + "/" + product.id;
  }), _defineProperty(_methods, "elevatorEvent", function elevatorEvent() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__carousel__ = __webpack_require__(622);
