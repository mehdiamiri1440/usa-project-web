...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    sumCodeNumbers: function sumCodeNumbers() {
      ...
      this.verification.currentCode = this.verifycode1 + this.verifycode2 + this.verifycode3 + this.verifycode4;
    },
            ...
            [
              _c("div", { staticClass: "row" }, [
                    ...
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "col-xs-3" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.verification.verifycode1,
                              expression: "verification.verifycode1"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                          ...
                          domProps: { value: _vm.verification.verifycode1 },
                          on: {
                      ...
                      _c("div", { staticClass: "col-xs-3" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.verification.verifycode2,
                              expression: "verification.verifycode2"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                          ...
                          domProps: { value: _vm.verification.verifycode2 },
                          on: {
                            keyup: function($event) {
                      ...
                      _c("div", { staticClass: "col-xs-3" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.verification.verifycode3,
                              expression: "verification.verifycode3"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                          ...
                          domProps: { value: _vm.verification.verifycode3 },
                          on: {
                            keyup: function($event) {
                      ...
                      _c("div", { staticClass: "col-xs-3" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.verification.verifycode4,
                              expression: "verification.verifycode4"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                          ...
                          domProps: { value: _vm.verification.verifycode4 },
                          on: {
                            keyup: function($event) {
                ...
                _c(
                  ...
                  {
                    staticClass: "submit-button disabled",
                    class: { active: _vm.verification.currentCode.length == 4 },
                    on: {
                      click: function($event) {
                        $event.preventDefault()
