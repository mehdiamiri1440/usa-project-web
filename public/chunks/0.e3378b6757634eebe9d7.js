...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    selectedSubCategory: function selectedSubCategory(index) {
      this.categoryName = this.categoryList[this.selectedCategoryIndex][index].category_name;
      this.mainCategories = this.categoryList[this.selectedCategoryIndex][index].subcategories;
    },
