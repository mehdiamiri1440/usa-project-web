  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "form-contents col-xs-12" }, [
      ...
      _c(
        "form",
        {
          staticClass: "col-xs-12 action-control-wrapper",
          on: {
            submit: function($event) {
              $event.preventDefault()
