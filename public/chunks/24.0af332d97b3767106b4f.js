...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SortContent: __WEBPACK_IMPORTED_MODULE_0__sort_modal_steps_step_listing__["default"]
    // FinalStep
  },
  data: function data() {
    return {
          ...
          [
            _c("div", { staticClass: "modal-content" }, [
              ...
              _c(
                ...
                [
                  _vm.sortCurrentStep == 0 ? _c("sort-content") : _vm._e(),
                  _vm._v(" "),
                  _vm.sortCurrentStep == 1
                    ? _c("sort-content-deep-two")
                    : _vm._e()
                ],
                1
              )
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/apple/Desktop/buskool/incobac-new-cli/resources/assets/js/components/dashboard/seller/request/sort-modal-steps/step-listing.vue'");
