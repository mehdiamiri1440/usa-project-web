...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      var i = 0;
      $(".product-pricing .item-wrapper").each(function () {
        $(this).prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + self.priceItem.helpDescription[i] + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        // console.log(, i);
        i++;
        console.log(self.priceItem);
      });
      $(".item-guid").tooltip();
      // console.log($(".product-pricing .item-wrapper"));
    });
  }
});
