...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      ...
      this.isRequiredFixAlert = getCookie("closeSellerFixModal");
    ...
    closeRequiredFixAlert: function closeRequiredFixAlert() {
      this.createCookie("closeSellerFixModal", "false", 10);
          ...
          _c(
            ...
            [
              _c(
                ...
                { attrs: { to: { name: "dashboardPricingTableSeller" } } },
                [
                  _vm._v("\n          فروشنده ویژه ما شوید\n          "),
                  _c("span", { staticClass: "button" }, [_vm._v("ارتقاعضویت")])
                ]
              ),
              _vm._v(" "),
              _c(
