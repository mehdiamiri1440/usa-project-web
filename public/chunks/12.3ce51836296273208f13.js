...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      var iconWrapper = document.getElementById("custom-upload-image-icons");
      var textWrapper = document.querySelector(".imageuploadify-message");
      var cameraIcon = document.createElement("i");
      var plusIcon = document.createElement("i");
      cameraIcon.classList = "fas fa-camera";
      cameraIcon.classList = "fa fa-plus-square";
      iconWrapper.appendChild(cameraIcon);
      iconWrapper.appendChild(plusIcon);

      textWrapper.innerHTML = "عکس کارت ملی شما";
    });
  },
