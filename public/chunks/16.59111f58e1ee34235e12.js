...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__blueimp_load_image_js_index__ = __webpack_require__(885);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__blueimp_load_image_js_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__blueimp_load_image_js_index__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_cropperjs__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__xkeshi_image_compressor__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__xkeshi_image_compressor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__xkeshi_image_compressor__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_upload_component__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_upload_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue_upload_component__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        FileUpload: __WEBPACK_IMPORTED_MODULE_3_vue_upload_component___default.a
    },
    data: function data() {
        return {
            // files: [],
        ...
        'editFile.show': function editFileShow(newValue, oldValue) {
            ...
            if (newValue) {
                this.$nextTick(function () {
                    ...
                    var cropper = new __WEBPACK_IMPORTED_MODULE_1_cropperjs__["a" /* default */](this.$refs.editImage, {
                        autoCrop: true,
                        aspectRatio: 1 / 1,
                        responsive: true,
                        center: true,
        ...
        inputFilter: function inputFilter(newFile, oldFile, prevent) {
            ...
            if (newFile && !oldFile) {
                ...
                if (newFile.file && newFile.type.substr(0, 6) === 'image/' && this.autoCompress > 0 && this.autoCompress < newFile.size) {
                    ...
                    var imageCompressor = new __WEBPACK_IMPORTED_MODULE_2__xkeshi_image_compressor___default.a(null, Options);

                    imageCompressor.compress(newFile.file, Options).then(function (file) {
                        __WEBPACK_IMPORTED_MODULE_0__blueimp_load_image_js_index___default()(newFile.file, function (img) {
                            console.log(img);
...
;(function (factory) {
  ...
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(879), __webpack_require__(881), __webpack_require__(882)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  var originalGetTransformedOptions = loadImage.getTransformedOptions;(function ($) {
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(879), __webpack_require__(883)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if ((typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object' && module.exports) {
  ...
  ExifMapProto.getName = function (tagCode) {
    ...
    if ((typeof name === 'undefined' ? 'undefined' : _typeof(name)) === 'object') return this.ifds[tagCode].name;
    return name;
  }
...
;(function (factory) {
  ...
  if (true) {
    // Register as an anonymous AMD module:
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(879), __webpack_require__(884)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if ((typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object' && module.exports) {
