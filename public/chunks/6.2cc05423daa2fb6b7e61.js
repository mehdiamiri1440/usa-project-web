...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props: ["productsInfo", "categoryId", "subCategoryId", "cityId", "categories"],
  data: function data() {
    return {
      provinceChild: "",
      cityChild: "",
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    resetLocationFilter: function resetLocationFilter() {
      this.province = "";
      this.city = "";
      __WEBPACK_IMPORTED_MODULE_4__router_router__["b" /* eventBus */].$emit("selectedProvince", "");
      __WEBPACK_IMPORTED_MODULE_4__router_router__["b" /* eventBus */].$emit("selectedCity", "");
