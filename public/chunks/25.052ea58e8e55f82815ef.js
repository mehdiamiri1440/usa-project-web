  ...
  methods: {
    ...
    sendVerificationCode: function sendVerificationCode() {
      ...
      axios.post("/send_verification_code", {
        ...
        _this3.step1.sendCode = false;
        _this3.goToStep(2);

        _this3.step2.verification_code = "";
        _this3.errors.verification_code = "";

        setTimeout(function () {
          _this3.step2.reSendCode = true;
        }, 120000);

        _this3.registerComponentStatistics("Register", "send-verification-code", "verification-code-sent-to-user");
      }).catch(function (err) {
        _this3.step1.sendCode = false;

        _this3.errors.phone = err.response.data.errors.phone;

        _this3.step1.sendCode = false;

        _this3.registerComponentStatistics("Register-Error", "phone-number-verification", "error:" + _this3.errors.phone);
      });
    },
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        _this4.step3.verifyCodeLoader = false;

        if (response.data.status === true) {
          if (response.data.redirected) {
            window.location.href = "/login";
          } else {
            _this4.getProvinceList();
            _this4.goToStep(3);
          }
        } else {
          _this4.errors.verification_code = response.data.msg;

          _this4.registerComponentStatistics("Register-Error", "verification-code-wrong", "error:" + _this4.errors.verification_code);
        }
      }).catch(function (error) {
        _this4.step3.verifyCodeLoader = false;

        _this4.goToStep(2);
        _this4.errors.verification_code = "وارد کردن کد الزامی است.";

        _this4.registerComponentStatistics("Register-Error", "verification-code-empty", "error:" + _this4.errors.verification_code);
      });
    },
    ...
    getProvinceList: function getProvinceList() {
      ...
      axios.post("/location/get_location_info", { cascade_list: true }).then(function (response) {
        return _this5.step3.provinceList = response.data.provinces;
      });
    },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_50cf06a1_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_loader_vue__ = __webpack_require__(956);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19845648_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_activity_type_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19845648_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_activity_type_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19845648_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_activity_type_vue__["render"],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19845648_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_activity_type_vue__["staticRenderFns"],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
