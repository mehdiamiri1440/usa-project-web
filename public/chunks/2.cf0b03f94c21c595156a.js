    ...
    imageParallax: function imageParallax() {
      ...
      $(window).scroll(function () {
        ...
        $bg_image1.each(function (i, el) {
          ...
          $(el).css("background-position", "50% " + ((dy - ot) * paralla2 + -70) + "px");
        });
        $bg_image2.each(function (i, el) {
          var ot = offset_tops[i];
          $(el).css("background-position", "50% " + ((dy - ot) * parallax + -110) + "px");
        });
        $bg_image3.each(function (i, el) {
          var ot = offset_tops[i];
          $(el).css("background-position", "50% " + ((dy - ot) * paralla2 + -70) + "px");
        ...
        $bg_image7.each(function (i, el) {
          var ot = offset_tops[i];
          $(el).css("background-position", "50% " + ((dy - ot) * paralla2 + -80) + "px");
        });
      });
    },
