...
var render = function() {
  ...
  return _vm.downloadAppButton &&
    ...
    ? _c(
        ...
        {
          staticClass:
            "android-download-alert-wrapper hidden-xs hidden-lg hidden-md",
          class: [{ hide: _vm.isClosed }, { test: _vm.isClosed == false }]
        },
        [
          _c(
            "div",
          ...
          _c(
            "div",
            {
              staticClass: "android-download-alert-content",
              on: {
                click: function($event) {
                  $event.preventDefault()
                  _vm.doDownload()
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "m-t-b" }, [
      _c("img", {
        attrs: {
          src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../img/logo/512-buskool-logo.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
