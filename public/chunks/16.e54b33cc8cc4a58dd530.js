...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      profileBasicFields: ["is_company", "company_name", "company_register_code", "public_phone", "address", "postal_code"],
  ...
  methods: {
    ...
    checkIsCompany: function checkIsCompany() {
      if (this.profile.company_name && !this.profile.company_register_code) {
        this.errors.company_register_code = ".لطفا شماره ثبت شرکت را وارد کنید";
      } else if (!this.profile.company_name && this.profile.company_register_code) {
        this.errors.company_name = ".لطفا  نام شرکت را وارد کنید";
      } else if (!this.profile.company_name && !this.profile.company_register_code) {
        this.profile.is_company = 0;
      }
    },
        ...
        _c(
          ...
          [
            _vm.currentUser.user_info.is_verified
              ...
              : _c("p", { staticClass: "pull-right info-text-fix" }, [
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-xs-12" }, [
        _c("div", { staticClass: "box-wrapper margin-15-auto" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "col-xs-12 col-sm-6 pull-left" }, [
            _c("div", { staticClass: "box-title" }, [_vm._v("تصاویر ثبت شده")]),
            _vm._v(" "),
            _c("div", { staticClass: "row margin-15-auto" }, [
              _c(
                "div",
                { staticClass: "images-content col-xs-12" },
                _vm._l(_vm.currentUser.certificates, function(photo, index) {
