...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__custom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__custom__);
...
/* harmony default export */ __webpack_exports__["a"] = (_components$props$dat = {
  ...
  methods: _defineProperty({
      ...
      axios.post("/get_seller_phone_number", {
        ...
        if (isModal) {
          _this.$nextTick(function () {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_6__sweetalert_min_js__["default"])({
              content: buskoolInfo,
              className: "custom-swal-with-cancel",
              buttons: {
                close: {
    ...
    getRelatedCategories: function getRelatedCategories(categroyId) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_8__custom__["isElementShownInView"])("#related-categories", function (isInView) {
        if (isInView) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    "$parent.product.main": function $parentProductMain() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_1__custom__["isElementShownInView"])("#related-products-wrapper", function (isInView) {
