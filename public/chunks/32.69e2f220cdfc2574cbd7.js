    ...
    isOsAndroid: function isOsAndroid() {
      ...
      if (this.isDeviceMobile() && !this.isOsIOS()) {
        ...
        if (parseInt(androidVersion) >= 5) {
          if (window.location.pathname != "/buyer/messenger/contacts" && window.location.pathname != "/seller/messenger/contacts" && window.location.pathname != "/seller/buyAd-requests" && !window.location.pathname.includes("product-view") && !this.iswebview) {
