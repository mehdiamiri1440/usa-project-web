  ...
  methods: {
    submitUserInformation: function submitUserInformation() {
      ...
      if (this.family && this.family.length < 2) {
        this.$parent.errors.family = "لطفا نام خود را به صورت کامل وارد کنید";
      } else if (!this.family) {
        this.$parent.errors.family = "لطفا نام خود را وارد کنید";
      }

      if (!this.$parent.errors.name && !this.$parent.errors.family) {
