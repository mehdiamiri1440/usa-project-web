...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_components_register_modal__ = __webpack_require__(970);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_register_number__ = __webpack_require__(975);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_modal_steps_verified_code__ = __webpack_require__(980);
  ...
  methods: {
    sendVerificationCode: function sendVerificationCode() {
      ...
      axios.post("/send_verification_code", {
        ...
        _this.verifyCodeBtnLoading = false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit(e) {
      e.preventDefault();
      var code = [].concat(_toConsumableArray(document.getElementsByTagName("input"))).filter(function (_ref) {
        var name = _ref.name;
        return name;
      }).map(function (_ref2) {
  ...
  watch: {
    "code.verifycode1": function codeVerifycode1(value) {
      this.errors.verifycode1 = false;
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode1 = true;
        this.errors.verification_code = error;
      }
    },
    "code.verifycode2": function codeVerifycode2(value) {
      this.errors.verifycode2 = false;
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode2 = true;
        this.errors.verification_code = error;
      }
    },
    "code.verifycode3": function codeVerifycode3(value) {
      this.errors.verifycode3 = false;
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode3 = true;
        this.errors.verification_code = error;
      }
    },
    "code.verifycode4": function codeVerifycode4(value) {
      this.errors.verifycode4 = false;
      if (value) {
        var error = this.validateVerifyNumber(value);
        if (error) this.errors.verifycode4 = true;
        this.errors.verification_code = error;
      }
    }
  }
      ...
      _c("div", { staticClass: "row" }, [
        ...
        _c("div", { staticClass: "input-wrapper" }, [
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.code.verifycode1,
                expression: "code.verifycode1"
              }
            ],
            ...
            class: {
              error:
                ...
                this.errors.verifycode1,
              active: _vm.code.verifycode1.length
            },
            attrs: {
              name: "code",
              placeholder: "_",
            ...
            domProps: { value: _vm.code.verifycode1 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.code, "verifycode1", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.code.verifycode2,
                expression: "code.verifycode2"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.errors.verifycode2,
              active: _vm.code.verifycode2.length
            },
            attrs: {
              name: "code",
              placeholder: "_",
            ...
            domProps: { value: _vm.code.verifycode2 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.code, "verifycode2", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.code.verifycode3,
                expression: "code.verifycode3"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.errors.verifycode3,
              active: _vm.code.verifycode3.length
            },
            attrs: {
              name: "code",
              placeholder: "_",
            ...
            domProps: { value: _vm.code.verifycode3 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.code, "verifycode3", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.code.verifycode4,
                expression: "code.verifycode4"
              }
            ],
            staticClass: "code-input",
            class: {
              error:
                this.$parent.errors.verification_code ||
                this.errors.verifycode4,
              active: _vm.code.verifycode4.length
            },
            attrs: {
              name: "code",
              placeholder: "_",
            ...
            domProps: { value: _vm.code.verifycode4 },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.code, "verifycode4", $event.target.value)
              }
            }
          })
        ]),
        ...
        _c("div", { staticClass: "step-action text-left" }, [
          _c(
            "button",
            {
              staticClass: "submit-button disabled",
              class: {
                active: !_vm.$parent.step1.sendCode && !_vm.$parent.errors.phone
              },
              attrs: { disabled: _vm.$parent.step1.sendCode },
              on: {
                click: function($event) {
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "count-down-timer" }, [
      _c("p", { staticClass: "gray-text text-center" }, [
        _vm._v("\n          ارسال مجدد کد تا\n          "),
        _c("span", { staticClass: "blue-text" }, [_vm._v("۰۲:۵۰")]),
        _vm._v("\n          دیگر\n        ")
      ])
    ])
  }
