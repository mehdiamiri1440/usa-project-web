...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      ...
      this.isRequiredFixAlert = this.getCookie("closeSellerFixModal") == "false" ? false : true;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    closeRequiredFixAlert: function closeRequiredFixAlert() {
      ...
      this.$parent.isRequiredFixAlert = false;
      console.log(this.$parent.isRequiredFixAlert);
    },
