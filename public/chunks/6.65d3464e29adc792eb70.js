...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_309343af_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_product_view_vue__ = __webpack_require__(912);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    activePhoneCall: function activePhoneCall(isModal) {
      ...
      this.registerComponentStatistics("product", "openPhoneCall", "click on open phone Call");
      this.isChat = false;
    ...
    shareProduct: function shareProduct() {
      ...
      if (this.isDeviceMobile()) {
        this.registerComponentStatistics("product", "open-share-product-link", "click on share product button");
        var linkElement = document.createElement("a");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setDescriptionStatistics: function setDescriptionStatistics() {
      var _this2 = this;

      $("#note-close.collapsed").on("click", function () {
        if (_this2.collapseFlag) {
          _this2.$parent.registerComponentStatistics("product", "user-more-info", "click on 'see more' in user info section");
          _this2.collapseFlag = false;
        }
      });
    }
  },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    relatedProductStatistics: function relatedProductStatistics() {
      // :nth-of-type(" + (this.productCountInPage - this.productCountInEachLoad + 1) + "
      var elements = "#related-products-item > .items-wrapper";

      $(elements).slice(2, 4).on("click", function () {
        console.log("click on relagted");
      });
    }
  },
  mounted: function mounted() {},
      ...
      _c("div", { staticClass: "row" }, [
        ...
        _c("div", { staticClass: "col-xs-6 item-button-wrapper pull-right" }, [
          _c(
            ...
            [
              _c("img", {
                attrs: { src: __webpack_require__(898) }
              }),
              _vm._v(" "),
