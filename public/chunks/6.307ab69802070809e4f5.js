...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    relatedProductStatistics: function relatedProductStatistics() {
      ...
      var from = this.productCountInPage == 12 ? 0 : this.productCountInPage - this.productCountInPage;
      var to = this.productCountInPage == 12 ? 12 : this.productCountInPage + this.productCountInEachLoad;
