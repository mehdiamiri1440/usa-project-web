...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle() {
      ...
      if (this.$parent.superCategoryIndex != "" && this.$parent.categoryIndex || this.$parent.superCategoryIndex && !this.$parent.categoryIndex) this.categoryTitle = this.$parent.superCategoryIndex && !this.$parent.categoryIndex ? this.$parent.superCategories[this.$parent.superCategoryIndex].category_name : this.$parent.categories[this.$parent.categoryIndex].category_name;
    },
