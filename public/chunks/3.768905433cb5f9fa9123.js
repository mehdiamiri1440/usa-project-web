  ...
  methods: (_methods = {
    ...
    stockValidator: function stockValidator(number) {
      ...
      if (!this.errors.stock) {
        ...
        this.stock_text = this.convertUnits(standardNumber);
      }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__upload_image_vue__ = __webpack_require__(192);
//
//
//
//
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.stock_text && !_vm.errors.stock,
              expression: "stock_text && !errors.stock"
            }
          ],
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_448bb634_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uploadImage_vue__ = __webpack_require__(963);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
