...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkButtonIsHide: function checkButtonIsHide() {
      ...
      console.log(this.isRequiredFixAlert, "in check button");
    },
    ...
    checkCookie: function checkCookie() {
      ...
      console.log(this.isRequiredFixAlert, "in check checkcookie");
    },
    checkPricingRoute: function checkPricingRoute() {
      var pageIsPricing = false;
      // console.log(this.urlIsPricing("dashboardPricingTableSeller"));
      ...
      console.log(pageIsPricing, "in check pricing route");
