...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_methods, "doPayment", function doPayment() {
    var self = this;
  ...
  }), _defineProperty(_methods, "setTotalPrice", function setTotalPrice() {
  ...
  }), _defineProperty(_methods, "selectCountInput", function selectCountInput(event) {
    event.target.select();
