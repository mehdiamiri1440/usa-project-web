                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.$parent.step3.activityType,
                        expression: "$parent.step3.activityType"
                      }
                    ],
                    attrs: { type: "radio", value: "1", name: "radio" },
                    domProps: {
                      checked: "0" == _vm.$parent.step3.activity_type,
                      checked: _vm._q(_vm.$parent.step3.activityType, "1")
                    },
                    on: {
                      change: function($event) {
                        _vm.$set(_vm.$parent.step3, "activityType", "1")
                      }
                    }
                  }),
                  _vm._v(" "),
