...
/* harmony default export */ __webpack_exports__["default"] = (_props$data$component = {
  props: ["isFixAlert"],
  data: function data() {
    return {
      messageCount: 0
...
}, _defineProperty(_props$data$component, "props", ["menuClosed", "photoLink", "storage", "username", "out", "routeHome", "isLoading"]), _defineProperty(_props$data$component, "methods", {
  init: function init() {
    this.closeCollapses();
  },
  logUserOut: function logUserOut() {
...
}), _defineProperty(_props$data$component, "registerComponentStatistics", function registerComponentStatistics(categoryName, actionName, labelName) {
  gtag("event", actionName, {
    event_category: categoryName,
    event_label: labelName
  });
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v("\n  " + _vm._s(_vm.$parent.isRequiredFixAlert) + "\n")
    ],
    1
  )
}
