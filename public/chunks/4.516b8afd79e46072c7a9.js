...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      searchText: "",
      setReviewUserPrfileId: ""
    };
  },
  methods: {
    getUserAutorizeForReview: function getUserAutorizeForReview() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["userId", "isSeller", "assets", "storagePath", "profilePhoto", "userFullName", "userLogoutPath", "userAllowedReviewData"],
  methods: {
    getUserAutorizeForReview: function getUserAutorizeForReview() {
      this.$parent.reviewUserPrfileId = this.setReviewUserPrfileId;
      this.$parent.isUserAuthorizedToPostComment();
