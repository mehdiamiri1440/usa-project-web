...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("65eed967", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_product_list_carousel__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_view_product__ = __webpack_require__(601);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_view_user_info__ = __webpack_require__(611);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_components_register_inquiry_form_vue__ = __webpack_require__(411);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__carousel__ = __webpack_require__(607);
        ...
        _c("div", { staticClass: "main-contents-wrapper" }, [
          _c("div", { staticClass: "main-contents" }, [
            ...
            _c("div", { staticClass: "actions" }, [
              _c(
                "div",
                { staticClass: "main-actions pull-right" },
                [
                  _c(
                    "router-link",
                    {
                      staticClass:
                        "buy-button green-button bg-red hover-effect",
                      attrs: {
                        to: {
                          name: "confirmProduct",
                          id: _vm.$parent.product.main.id
                        }
                      }
                    },
                    [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "default-actions pull-left" }, [
                _vm.$parent.isMyProfile
                  ? _c(
                      "button",
                      {
                        staticClass: "elevator-event green-button pull-right",
                        on: {
                          click: function($event) {
                            $event.preventDefault()
