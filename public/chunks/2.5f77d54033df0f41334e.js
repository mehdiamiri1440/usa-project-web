  ...
  methods: (_methods = {
    ...
    minSaleAmountValidator: function minSaleAmountValidator(number) {
      ...
      if (!this.errors.minSaleAmount) {
        this.$parent.product.minSaleAmount = this.getNumberWithCommas(standardNumber);
        this.min_sale_amount_text = this.convertUnits(standardNumber);
      }
      /*
    ...
    maxSalePriceValidator: function maxSalePriceValidator(number) {
      ...
      if (!this.errors.maxSalePrice) {
        ...
        this.max_sale_price_text = this.convertUnits(standardNumber);
      }
    ...
    minSalePriceValidator: function minSalePriceValidator(number) {
      ...
      if (!this.errors.minSalePrice) {
        ...
        this.min_sale_price_text = this.convertUnits(standardNumber);
      }
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.min_sale_amount_text && !_vm.errors.minSaleAmount,
              expression: "min_sale_amount_text && !errors.minSaleAmount"
            }
          ],
          staticClass: "custom-tooltip",
          domProps: { textContent: _vm._s(_vm.min_sale_amount_text) }
        }),
        _vm._v(" "),
        _c("input", {
          directives: [
