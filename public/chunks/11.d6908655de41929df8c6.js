...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_review_components_article_review__ = __webpack_require__(645);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    refreshProduct: function refreshProduct(productId) {
      ...
      axios.post("/refresh_my_product_by_id", {
        ...
        if (response.data.status === true) {
          ...
          __WEBPACK_IMPORTED_MODULE_2__router_router__["b" /* eventBus */].$emit("submitSuccess", self.popUpMsg);
          $("#custom-main-modal").modal("show");
        } else {
    ...
    openChat: function openChat() {
      ...
      if (this.currentUser.user_info) {
        __WEBPACK_IMPORTED_MODULE_2__router_router__["b" /* eventBus */].$emit("ChatInfo", contact);
      } else {
        window.localStorage.setItem("contact", JSON.stringify(contact));
        window.localStorage.setItem("pathname", window.location.pathname);

        __WEBPACK_IMPORTED_MODULE_2__router_router__["b" /* eventBus */].$emit("modal", "sendMsg");
      }
    },
    ...
    activeReviewModal: function activeReviewModal() {
      ...
      __WEBPACK_IMPORTED_MODULE_2__router_router__["b" /* eventBus */].$emit("reviewUserData", selectedUserData);
    }
  },
  mounted: function mounted() {
    this.init();
                ...
                [
                  ...
                  _c("div", { staticClass: "profile-rating-box-wrapper" }, [
                    _c("div", { staticClass: "profile-rating-box" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "rating-score pull-right" }, [
                        _vm._v("۴.۵")
                      ])
                    ])
                  ])
            ...
            _vm.profileDescription === true
              ...
              : _c("div", { staticClass: "contents" }, [
                  _c(
                    ...
                    { staticClass: "row" },
                    [
                      _c("div", { staticClass: "reviews-wrapper col-xs-12" }, [
                        _c(
                          "div",
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "review-count-wrapper" }, [
      _c("span", [_vm._v("۱۳۰۰")]),
      _vm._v("\n                    نظر\n                  ")
    ])
  },
  ...
  function() {
    ...
    return _c("div", { staticClass: "actions" }, [
      _c("button", { staticClass: "add-review hover-effect rtl" }, [
        _c("i", { staticClass: "fa fa-star yellow-text" }),
        _vm._v(" "),
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("329c2cd7", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-bda6dd62\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./article-review.vue", function() {
     var newContent = require("!!../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-bda6dd62\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./article-review.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
  ...
  return _c("div", { staticClass: "col-xs-12" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "review-wrapper" }, [
        ...
        _vm._m(1),
        _vm._v(" "),
        _c("div", { staticClass: "review-rate" }, [
          _c("div", { staticClass: "rate-stars" }, [
            _c(
              ...
              _vm._l(5, function(star, index) {
                return _c("span", { key: index }, [
                  _c("span", { domProps: { textContent: _vm._s(index + 1) } }),
                  _vm._v(" "),
                  _c("i", {
                    staticClass: "fa fa-star",
                    class: { "yellow-text": index < 5 }
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "reviewer-information-wrapper" }, [
      _c("p", { staticClass: "user-name" }, [_vm._v("ع*******ی")]),
      _vm._v(" "),
      _c("p", { staticClass: "user-city" }, [_vm._v("فارس - شیراز")]),
      _vm._v(" "),
      _c("p", { staticClass: "comment-date" }, [_vm._v("۱۵ شهریور ۱۳۹۹")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "review-message" }, [
      _c("p", [
        _vm._v(
          "بنا بر گفته های اتحادیه صادرکنندگان برنج در پاکستان(REAP) که از افزایش میزان عرضه و فروش برنج پاکستانی به کشورهای مختلف منطقه و همسایه از جمله کشور جمهوری اسلامی ایران که از بزرگترین مشتریان است"
        )
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "review-likes" }, [
      _c("span", [
        _vm._v("\n            5\n            "),
