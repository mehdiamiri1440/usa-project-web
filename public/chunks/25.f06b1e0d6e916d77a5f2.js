...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    validateErrors: function validateErrors() {
      if (this.step3name.length && this.step3family.length && this.errors.name == "" && this.errors.family == "" && this.step3.province && this.step3.city && this.step4.activity_type !== "" && this.step4.category_id !== "") {
