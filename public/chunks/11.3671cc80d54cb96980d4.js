...
throw new Error("Cannot find module \"../../../../sweetalert.min.js\"");
throw new Error("Cannot find module \"../../../layouts/main/main_components/categories-modal.vue\"");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ["storage"],
  components: {
    CategoriesModal: __WEBPACK_IMPORTED_MODULE_2__layouts_main_main_components_categories_modal_vue___default.a
  },
  data: function data() {
    return {
      currentUser: {
  ...
  methods: {
    ...
    openChat: function openChat(buyAd) {
      ...
      axios.post("/get_user_permission_for_buyAd_reply", {
        ...
        if (response.data.permission == true) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$emit("ChatInfo", contact);

          self.registerComponentStatistics("buyAdReply", "openChat", "click on open chatBox");
        } else {
          __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$emit("modal", "buyAdReplyLimit");
    ...
    openGoldenChatRestrictionModal: function openGoldenChatRestrictionModal() {
      __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$emit("modal", "goldenBuyAdReplyLimit");
  ...
  mounted: function mounted() {
    this.init();
    __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$emit("subHeader", false);
  },
