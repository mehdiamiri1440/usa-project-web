    ...
    _c(
      ...
      [
        _vm.currentUser.user_info.active_pakage_type == 0
          ? _c(
              "div",
              { staticClass: "fix-request-header-box shadow-content text-rtl" },
              [
                _c(
                  "div",
                  {
                    staticClass:
                      "col-xs-8 hidden-xs request-update pull-right text-right"
                  },
                  [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "col-xs-12 col-sm-4 request-update pull-left text-left" },
      [
        _c("button", { staticClass: "green-button bg-gray hover-effect" }, [
  ...
  function() {
    ...
    return _c(
      "div",
      {
        staticClass: "fix-request-bottom hidden-sm shadow-content text-center"
      },
      [
        _c("div", { staticClass: "col-xs-12 hidden-md hidden-lg text-right" }, [
          _c("button", { staticClass: "green-button bg-gray hover-effect" }, [
            _c("i", { staticClass: "fas fa-sort-amount-down-alt" }),
            _vm._v("\n          مرتب سازی\n        ")
          ])
