...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    feed: function feed() {
      ...
      var self = this;
      var categoryName = this.$parent.product.main.sub_category_name;
      if (!this.loadMoreActive && this.continueToLoadProducts) {
    ...
    infiniteScrollHandler: function infiniteScrollHandler() {
      ...
      $(window).scroll(function () {
        ...
        console.log(productsSection.offset().top, $(window).scrollTop() - $(window).height());
        // console.log(
        //   $(window).scrollTop(),
        //   ($(document).height() - $(window).height() - 100) * 0.35
        // );
        // console.log(
        //   $(window).scrollTop(),
        //   ($(document).height() - $(window).height() - 100) * 0.35
        // );
        if ($(window).scrollTop() >= ($(document).height() - $(window).height()) * 2.5 && !_this3.loadMoreActive && _this3.continueToLoadProducts) {
          _this3.feed();
        }
      });
    }
