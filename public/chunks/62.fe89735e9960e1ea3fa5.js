...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    send_verification_code: function send_verification_code() {
      ...
      axios.post("/send_verification_code", {
        ...
        self.registerComponentStatistics("Register-Error", "phone-number-verification", "error:" + self.errors.phoneNumber[0]);
      });
    },
    ...
    sumCodeNumbers: function sumCodeNumbers() {
      ...
      this.step2.verification.currentCode = this.step2.verification.verifycode1 + this.step2.verification.verifycode2 + this.step2.verification.verifycode3 + this.step2.verification.verifycode4;
    },
  ...
  watch: {
    ...
    "step2.verification.verifycode1": function step2VerificationVerifycode1(value) {
      this.sumCodeNumbers();
      this.step2.verification.verifycode1 = this.step2.verification.verifycode1.substring(0, 1);
    },
    "step2.verification.verifycode2": function step2VerificationVerifycode2(value) {
      this.sumCodeNumbers();
      this.step2.verification.verifycode2 = this.step2.verification.verifycode2.substring(0, 1);
    },
    "step2.verification.verifycode3": function step2VerificationVerifycode3(value) {
      this.sumCodeNumbers();
      this.step2.verification.verifycode3 = this.step2.verification.verifycode3.substring(0, 1);
    },
    "step2.verification.verifycode4": function step2VerificationVerifycode4(value) {
      this.sumCodeNumbers();
      this.step2.verification.verifycode4 = this.step2.verification.verifycode4.substring(0, 1);
    },
    ...
    _c("section", { staticClass: "product-section-wrapper" }, [
      ...
      this.currentStep == 0
        ? _c(
            ...
            {
              staticClass:
                "form-contents text-right col-md-4 col-md-offset-4 col-xs-12"
            },
            [
              ...
              _c("div", { staticClass: "row" }, [
                _c("label", { attrs: { for: "verify-code" } }, [
                  ...
                  _c("span", {
                    ...
                    domProps: { textContent: _vm._s(_vm.step1.phoneNumber) }
                  }),
                  _vm._v("\n          را وارد کنید\n        ")
                ]),
                _vm._v(" "),
                    ...
                    _c("div", { staticClass: "row" }, [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.step2.verification.verifycode1,
                              expression: "step2.verification.verifycode1"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                            error: this.errors.verification_code[0],
                            active: _vm.step2.verification.verifycode1.length
                          },
                          attrs: {
                            id: "verify-code-1",
                            type: "number",
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.step2.verification.verifycode2,
                              expression: "step2.verification.verifycode2"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                            error: this.errors.verification_code[0],
                            active: _vm.step2.verification.verifycode2.length
                          },
                          attrs: {
                            id: "verify-code-2",
                            type: "number",
                      ...
                      _c("div", { staticClass: "col-xs-3" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.step2.verification.verifycode3,
                          ...
                          class: {
                            error: this.errors.verification_code[0],
                            active: _vm.step2.verification.verifycode3.length
                          },
                          attrs: {
                            id: "verify-code-3",
                            type: "number",
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.step2.verification.verifycode4,
                              expression: "step2.verification.verifycode4"
                            }
                          ],
                          staticClass: "dire",
                          class: {
                            error: this.errors.verification_code[0],
                            active: _vm.step2.verification.verifycode4.length
                          },
                          attrs: {
                            id: "verify-code-4",
                            type: "number",
                ...
                _vm.step2.showTimer
                  ? _c(
                      "div",
                      {
                        staticClass: "timer-wrapper margin-15-auto text-center"
                      },
                      [
                ...
                _c(
                  "button",
                  {
                    staticClass: "submit-button disabled",
                    class: {
                      active: _vm.step2.verification.currentCode.length == 4
                    },
                    on: {
                      click: function($event) {
                        $event.preventDefault()
