...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    productNameValidator: function productNameValidator(name) {
      if (name == "") {
        _this.errors.productName = "لطفا نوع محصول را وارد کنید.";
      }
      if (!_this.validateRegx(name, /^[\u0600-\u06FF\s_,.:/;()+-\d]+$/)) {
        _this.errors.productName = "لطفا نوع محصول را فارسی وارد کنید.";
      }
    },
    stockValidator: function stockValidator(number) {
      _this.errors.stock = "";
      var standardNumber = _this.toLatinNumbers(number);
      if (standardNumber == "") {
        _this.errors.stock = "لطفا میزان موجودی را وارد کنید";
      } else if (!_this.validateRegx(standardNumber, /^\d*$/)) {
        _this.errors.stock = "لطفا فقط عدد وارد کنید";
      }
    ...
    minSaleAmountValidator: function minSaleAmountValidator(number) {
      _this.errors.min_sale_amount = "";
      var standardNumber = _this.toLatinNumbers(number);
      if (standardNumber == "") {
        _this.errors.minSaleAmount = "لطفا حداقل میزان فروش را وارد کنید";
      } else if (!_this.validateRegx(standardNumber, /^\d*$/)) {
        _this.errors.minSaleAmount = "لطفا فقط عدد وارد کنید ";
      }
      /*
    ...
    maxSalePriceValidator: function maxSalePriceValidator(number) {
      _this.errors.max_sale_price = "";
      var standardNumber = _this.toLatinNumbers(number);
      if (standardNumber == "") {
        _this.errors.max_sale_price = "لطفا حداکثر قیمت را وارد کنید";
      } else if (!_this.validateRegx(standardNumber, /^\d*$/)) {
        _this.errors.max_sale_price = "لطفا فقط عدد وارد کنید ";
      }
    ...
    minSalePriceValidator: function minSalePriceValidator(number) {
      _this.errors.minSalePrice = "";
      var standardNumber = _this.toLatinNumbers(number);
      if (standardNumber == "") {
        _this.errors.minSalePrice = "لطفا حداقل قیمت را وارد کنید";
      } else if (!_this.validateRegx(standardNumber, /^\d*$/)) {
        _this.errors.minSalePrice = "لطفا فقط عدد وارد کنید ";
      }
  ...
  watch: {
    "productName": function productName(e) {
      this.errors.productName = "";

      if (e != "") {
        this.productNameValidator(e);
      } else {

        this.productNameValidator(e);
      }
    },
    "stock": function stock(e) {
      if (e) {
        this.errors.stock = null;
      }
    },
    "minSaleAmount": function minSaleAmount(e) {
      if (e) {
        this.errors.minSaleAmount = null;
      }
    },
    "minSalePrice": function minSalePrice(e) {
      if (e) {
        this.errors.minSalePrice = null;
      }
    },
    "maxSalePrice": function maxSalePrice(e) {
      if (e) {
        this.errors.maxSalePrice = null;
      }
    }
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19760290_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_product_basic_new_vue__ = __webpack_require__(971);
