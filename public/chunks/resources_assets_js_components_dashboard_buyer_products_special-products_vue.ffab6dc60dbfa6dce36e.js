...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: (0,vuex__WEBPACK_IMPORTED_MODULE_1__.default)({
    specialSearchText: function specialSearchText(state) {
  ...
  methods: {
    init: function init() {
      var self = this;
      this.loading = true; // this.$store.state.dashboardStore.specialProductSearchText = "";
  ...
  watch: {
    specialSearchText: function specialSearchText(text) {
