...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_layouts_main_delsa_promotion_modal_vue__ = __webpack_require__(524);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_layouts_main_phone_locked_modal_vue__ = __webpack_require__(529);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__router_js__ = __webpack_require__(4);
var _methods;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    ...
    DelsaPromotionModal: __WEBPACK_IMPORTED_MODULE_5__components_layouts_main_delsa_promotion_modal_vue__["a" /* default */],
    PhoneLockedModal: __WEBPACK_IMPORTED_MODULE_6__components_layouts_main_phone_locked_modal_vue__["a" /* default */],
  ...
  methods: (_methods = {
    init: function init() {
      ...
      axios.post("/get_total_unread_messages_for_current_user").then(function (response) {
        ...
        __WEBPACK_IMPORTED_MODULE_7__router_js__["b" /* eventBus */].$emit("messageCount", messageCount);
    ...
    __WEBPACK_IMPORTED_MODULE_7__router_js__["b" /* eventBus */].$emit("modal", "goldenBuyAdReplyLimit");
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_7__router_js__["b" /* eventBus */].$on("buyAdbuttonActive", function (event) {
      _this5.buttonActiveInSteps = event;
    });

    __WEBPACK_IMPORTED_MODULE_7__router_js__["b" /* eventBus */].$on("paymentData", function (event) {
