...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    textValidator: function textValidator(text, isAddress) {
      isAddress ? this.errors.address = "" : this.errors.description = "";

      if (text != "") {
        if (!this.validateRegx(text, /^[\u0600-\u06FF\s_,.:/;()+-\d]+$/)) {
          isAddress ? this.errors.address = "آدرس شامل حروف غیرمجاز است" : this.errors.description = "توضیحات شامل حروف غیرمجاز است";
        }
      }
    },
  ...
  watch: {
    ...
    "currentUser.profile.description": function currentUserProfileDescription(value) {
      this.textValidator(value, false);
    }
  }
});
