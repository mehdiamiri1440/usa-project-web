...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_product_list_carousel__ = __webpack_require__(754);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product__ = __webpack_require__(758);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_info__ = __webpack_require__(774);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    loadCarousel: function loadCarousel() {
      ...
      $(this.$el).parent().parent().parent().magnificPopup((_$$parent$parent$pare = {
        delegate: "a",
        type: "image",
      ...
      }, _defineProperty(_$$parent$parent$pare, "mainClass", "mfp-fade"), _defineProperty(_$$parent$parent$pare, "zoom", {
        enabled: true,
        duration: 1000 // don't foget to change the duration also in CSS
      }), _defineProperty(_$$parent$parent$pare, "gallery", {
        enabled: true,
        navigateByImgClick: true,
        preload: [0, 1] // Will preload 0 - before current, and 1 after the current image
      }), _defineProperty(_$$parent$parent$pare, "callbacks", {
        open: function open() {
          if (!window.history.state) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_device_uuid_lib_device_uuid__ = __webpack_require__(277);
                ...
                ? _c(
                    "button",
                    {
                      ...
                      class: {
                        "send-message-button":
                          _vm.$parent.product.user_info.has_phone,
                        "green-button bg-gradient-green": !_vm.$parent.product
                          .user_info.has_phone
                      },
                      on: {
                        click: function($event) {
    ...
    _vm.$parent.product.user_info
      ? _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "user-data-wrapper text-rtl col-xs-12" }, [
              _c("ul", [
                ...
                _c("li", [
                  _vm._m(1),
                  _vm._v(" "),
                  _c("div", { staticClass: "content-wrapper rating-section" }, [
            ...
            _c(
              ...
              {
                staticClass:
                  "user-info-actions text-rtl hidden-xs hidden-sm hidden-md"
              },
              [
                !_vm.$parent.isMyProfile && _vm.$parent.currentUser.user_info
                  ? _c(
  ...
  function() {
    ...
    return _c("div", { staticClass: "user-description-wrapper text-right" }, [
      ...
      _c(
        ...
        [
          _vm._v(
            "\n        فروش برنج طارم هاشمی از شالیزارهای آمل به سفره و یا مراکز فروش شما به\n        صورت مستقیم با قیمت مناسب ..کشت اول آماده فروش به مقداری که نیاز دارید\n        کشت دوم دو ماه آینده آماده میشود در صورت نیاز اطلاع دهید.. حداقل\n        سفارش: 20..حداکثر:.....از شالیزار های آمل به سفره یا مغازه شما به صورت\n        جزئی و کلی .تبلیغ من برنج منه ک در صورت عدم رضایت پس گرفته\n        میشود.متاسفانه سودجویان باعث شدند اعتماد مردم از بین برود من در این\n        مجموعه کوچک سعی در اعتماد سازی دارم و میخواهم مشتریان عزیز تبلیغ کننده\n        محصولات من باشند.اعتقاد من این است کیفت وخالص بودن محصول و صداقت در\n        معامله باعث تدوام فروش است.برنج خالص طارم هاشمی..کلیه محصولات از\n        خانواده خودمه با خیال راحت خرید کنید..تخفیف و شرایط ویژه برای کسانی که\n        خرید بالای یک تن دارند.. برای ارتباط و خرید مستقیم پیام ارسال کنید\n      "
          )
        ]
      ),
      _vm._v(" "),
    ...
    [
      ...
      _c("main", { staticClass: "row", attrs: { id: "main" } }, [
        _c(
          ...
          {
            staticClass:
              "col-xs-12 text-rtl text-right bread-crumbs-wrapper hidden-xs"
          },
          [
            _vm.breadCrumbs
              ? _c(
        ...
        _c(
          "div",
          {
            staticClass: "col-xs-12 col-lg-8 product-section-wrapper pull-right"
          },
          [
