                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.$parent.سفثح۳.activityType,
                        expression: "$parent.سفثح۳.activityType"
                      }
                    ],
                    attrs: { type: "radio", value: "0", name: "radio" },
                    domProps: {
                      checked: "0" == _vm.$parent.step3.activity_type,
                      checked: _vm._q(_vm.$parent.سفثح۳.activityType, "0")
                    },
                    on: {
                      change: function($event) {
                        _vm.$set(_vm.$parent.سفثح۳, "activityType", "0")
                      }
                    }
                  }),
                  _vm._v(" "),
