...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__layouts_main_main_components_product_list_carousel__ = __webpack_require__(281);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    isThereInquiryToSend: function isThereInquiryToSend() {
      if (window.localStorage.getItem('contacnt') && window.localStorage.getItem('msgToSend')) {
        return true;
      }
