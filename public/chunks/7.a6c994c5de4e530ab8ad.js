  ...
  methods: {
    ...
    feed: function feed() {
      ...
      if (this.searchText === "" && this.province.id === "" && this.categoryId === "" && this.continueToLoadProducts) {
        ...
        console.log("in 2", searchObject, this.searchText === "" && this.province.id === "" && this.categoryId === "" && this.continueToLoadProducts, this.searchText === "", this.province.id === "", this.categoryId === "", this.continueToLoadProducts);
