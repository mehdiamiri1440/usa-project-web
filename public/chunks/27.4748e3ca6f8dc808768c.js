  ...
  methods: _defineProperty({
    ...
    filterBuyAdBySearch: function filterBuyAdBySearch() {
      ...
      this.buyAdsGoldenFilter = this.buyAdsGolden.filter(function (buyAd) {
        var text = _this3.filterBuyAd.split(" ");
        return text.every(function (el) {
          if (buyAd.first_name.indexOf(el) > -1 || buyAd.last_name.indexOf(el) > -1 || buyAd.subcategory_name.indexOf(el) > -1) {
            return true;
          } else return false;
        });
      });
  ...
  return _c("div", { staticClass: "contact-body my-contacts" }, [
    ...
    _c(
      "div",
      {
        directives: [
          {
            name: "else-if(!buyAdsGoldenFilter",
            rawName: "v-else-if(!buyAdsGoldenFilter.length)",
            modifiers: { "length)": true }
          }
        ],
        staticClass: "contact-items buyad-lists-wrapper"
      },
      [
                                ...
                                [
                                  _c("div", { staticClass: "row" }, [
                                    ...
                                    _c(
                                      "button",
                                      {
                                        staticClass: "hide-reply buyad-button",
                                        attrs: {
                                          id: "golden-loader-" + buyAd.id,
                                          disabled: ""
                                        }
                              ...
                              _c(
                                ...
                                [
                                  _c("div", { staticClass: "row" }, [
                                    ...
                                    _c(
                                      "button",
                                      { staticClass: "buyad-button disable" },
