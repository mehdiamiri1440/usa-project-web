    ...
    _c("div", { staticClass: "row wrapper-section" }, [
      _c("div", { staticClass: "main-section" }, [
        ...
        _c(
          ...
          [
            _vm.currentStep == 0 ? _c("IdCard") : _vm._e(),
            _vm._v(" "),
            _vm.currentStep == 1 ? _c("UserImage") : _vm._e()
          ],
          1
        )
      ]),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkImageErrors: function checkImageErrors() {
      ...
      if (imagesCount == 0) {
        this.errors.userImageFile = "لطفا تصویر کارت ملی خود را بارگذاری کنید";
      } else {
