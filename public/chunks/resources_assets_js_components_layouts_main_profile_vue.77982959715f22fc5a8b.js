...
/* harmony import */ var _router_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../router/router */ "./resources/assets/js/router/router.js");
...
/* harmony import */ var _jquery_magnific_popup_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../jquery.magnific-popup.min */ "./resources/assets/js/jquery.magnific-popup.min.js");
...
/* harmony import */ var _layouts_main_main_components_review_component_chat_review__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../layouts/main/main_components/review-component/chat-review */ "./resources/assets/js/components/layouts/main/main_components/review-component/chat-review.vue");
/* harmony import */ var _layouts_main_main_components_review_component_success_submit_chat_review__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../layouts/main/main_components/review-component/success-submit-chat-review */ "./resources/assets/js/components/layouts/main/main_components/review-component/success-submit-chat-review.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    SuccessReviewComponent: _layouts_main_main_components_review_component_success_submit_chat_review__WEBPACK_IMPORTED_MODULE_7__.default,
    ChatReviewComponent: _layouts_main_main_components_review_component_chat_review__WEBPACK_IMPORTED_MODULE_6__.default
  },
  props: ["assets", "str"],
  data: function data() {
    var _ref;
  ...
  methods: {
    stopLoader: function stopLoader() {
      _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("isLoading", false);
    },
    ...
    refreshProduct: function refreshProduct(productId) {
      ...
      axios.post("/refresh_my_product_by_id", {
        ...
        if (response.data.status === true) {
          ...
          _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("submitSuccess", self.popUpMsg);
          $("#custom-main-modal").modal("show");
        } else {
    ...
    copyProfileLinkToClipBoard: function copyProfileLinkToClipBoard(contentId) {
      ...
      if (this.isDeviceMobile()) {
        ...
        _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("shareModalUrl", _url);
      }
    },
    ...
    openChat: function openChat() {
      ...
      if (this.currentUser.user_info) {
        _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("ChatInfo", contact);
      } else {
        window.localStorage.setItem("contact", JSON.stringify(contact));
        window.localStorage.setItem("pathname", window.location.pathname);
        _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("modal", "sendMsg");
      }
    },
    ...
    activeReviewModal: function activeReviewModal() {
      ...
      _router_router__WEBPACK_IMPORTED_MODULE_3__.eventBus.$emit("reviewUserData", selectedUserData);
    },
  ...
  created: function created() {
    ...
    document.addEventListener("click", this.documentClick); // eventBus.$on("userAllowedReview", ($event) => {
