...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getCategoryName: function getCategoryName() {
      var routeName = this.$route.params.categoryName;
