...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pricing_tables_pricing_packages_vue__ = __webpack_require__(439);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    // console.log(self.priceItem.priceItems);
    // for (let i = 0; i < self.priceItem.priceItems.length; i++) {
    //   $(".product-pricing .item-wrapper").prepend(
    //     " <button" +
    //       ' class="item-guid"' +
    //       ' data-toggle="tooltip"' +
    //       ' data-placement="bottom"' +
    //       ' title="' +
    //       self.priceItem.priceItems[i].helpDescription +
    //       '"' +
    //       " >" +
    ...
    //   $(".item-guid").tooltip();
    // }
    $(".product-pricing .item-wrapper").each(function (index, element) {
      console.log(self.priceItem.priceItems[index].helpDescription, index);
      if (index <= 8) {
        $(element).prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + "this is text" + self.priceItem.priceItems[index].helpDescription + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        $(".item-guid").tooltip();
      }
    });
    // });
