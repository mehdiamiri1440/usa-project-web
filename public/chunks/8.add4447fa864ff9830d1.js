...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_register_number__ = __webpack_require__(801);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    openChatOrCall: function openChatOrCall() {
      var _this4 = this;

      setTimeout(function () {
        _this4.$parent.currentUser = response.data;
        if (_this4.$parent.currentUser.user_info) {
          if (_this4.$parent.currentUser.user_info.is_seller == true) {
            _this4.$parent.showRegisterRequestBox = false;
          }
        }
  ...
  mounted: function mounted() {
    alert("me", global.MediaDeviceInfo.deviceId);
