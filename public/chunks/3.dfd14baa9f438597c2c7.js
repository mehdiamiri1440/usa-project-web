          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.productype,
              expression: "$parent.product.productype"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا: مضافتی" },
          domProps: { value: _vm.$parent.product.productype },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "productype", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
