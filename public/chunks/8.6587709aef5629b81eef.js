  ...
  methods: {
    ...
    stockValidator: function stockValidator(number) {
      ...
      if (!this.$parent.errors.stock) {
        this.stock = this.$parent.getNumberWithCommas(value);
      }
      if (this.errors.stock) {
        this.$parent.registerComponentStatistics("product-register-error", "min-sale-price", "input:" + number + " error:" + this.errors.stock);
      }
    }
  },
  mounted: function mounted() {
