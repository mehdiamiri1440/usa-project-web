...
/* harmony import */ var _register_steps_register_number__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./register_steps/register_number */ "./resources/assets/js/components/register/register_steps/register_number.vue");
/* harmony import */ var _register_steps_verify_code__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register_steps/verify_code */ "./resources/assets/js/components/register/register_steps/verify_code.vue");
/* harmony import */ var _register_steps_personal_information__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register_steps/personal_information */ "./resources/assets/js/components/register/register_steps/personal_information.vue");
/* harmony import */ var _register_steps_location__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./register_steps/location */ "./resources/assets/js/components/register/register_steps/location.vue");
/* harmony import */ var _register_steps_user_account__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./register_steps/user_account */ "./resources/assets/js/components/register/register_steps/user_account.vue");
/* harmony import */ var _register_steps_activity_domain__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./register_steps/activity_domain */ "./resources/assets/js/components/register/register_steps/activity_domain.vue");
...
/* harmony import */ var _sweetalert_min_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../sweetalert.min.js */ "./resources/assets/js/sweetalert.min.js");
/* harmony import */ var _sweetalert_min_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_sweetalert_min_js__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    RegisterNumber: _register_steps_register_number__WEBPACK_IMPORTED_MODULE_1__.default,
    VerifyCode: _register_steps_verify_code__WEBPACK_IMPORTED_MODULE_2__.default,
    PersonalInformatin: _register_steps_personal_information__WEBPACK_IMPORTED_MODULE_3__.default,
    Location: _register_steps_location__WEBPACK_IMPORTED_MODULE_4__.default,
    UserAccount: _register_steps_user_account__WEBPACK_IMPORTED_MODULE_5__.default,
    ActivityDomain: _register_steps_activity_domain__WEBPACK_IMPORTED_MODULE_6__.default
  },
      ...
      if (this.errorFlag === false) {
        axios.post("api/v1/users", object).then(function (response) {
          if (response.status === 201) {
            _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("modal", "userRegisterSuccess");
            ...
            axios.post("/dologin", {
              ...
              if (response.data.status) {
                if (self.isUserComeFromChatBoxOpen()) {
                  _sweetalert_min_js__WEBPACK_IMPORTED_MODULE_8___default().close(); //close modal
