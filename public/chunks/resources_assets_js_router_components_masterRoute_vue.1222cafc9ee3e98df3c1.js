...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mounted: function mounted() {
    this.$store.state.routeStore.elevatorText = "htoaskdkfa";
    console.log(this.$store.state.routeStore.elevatorText);
  },
  methods: {
...
var render = /*#__PURE__*/_withId(function (_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <button\n    @click=\"\n      $store.commit('routeStore/deleteProductModal', {\n        productId: 1,\n      })\n    \"\n  > "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("button", {
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.$store.commit('routeStore/editProductModal');
    })
