...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_review_components_article_review__ = __webpack_require__(501);
  ...
  methods: {
    ...
    init: function init() {
      ...
      axios.post("/get_user_statistics_by_user_name", {
        ...
        self.starScore = Math.floor(response.data.rating_info.avg_score);
      }).catch(function (err) {
        //
      });
