              ...
              _c("p", { staticClass: "price-item" }, [
                ...
                _vm.product.main.id
                  ? _c("span", {
                      domProps: {
                        textContent: _vm._s(
                          _vm.$parent.getNumberWithCommas(_vm.totalPrice) +
                            " تومان"
                        )
                      }
                    })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkRouteActive: function checkRouteActive() {
      var progress = $(".progress-item.active");
      var level = 0;
              ...
              _c("div", { staticClass: "steps" }, [
                ...
                _c("p", { staticClass: "step-item" }, [
                  _c(
                    "span",
                    {
                      ...
                      class: { active: _vm.paymentStep > 0 }
                    },
                    [_vm._v("2")]
                  ),
                  _vm._v(" "),
                ...
                _c("p", { staticClass: "step-item" }, [
                  _c(
                    ...
                    {
                      staticClass: "step-index",
                      class: { active: _vm.paymentStep > 1 }
                    },
                    [_vm._v("3")]
                  ),
                  _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "step-item" }, [
