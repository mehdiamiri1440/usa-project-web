...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle() {
      ...
      this.categoryTitle = isSuperCategory ? this.$parent.superCategories[this.$parent.superCategoryIndex].category_name : this.$parent.categories[index].category_name;
    },
