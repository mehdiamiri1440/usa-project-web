  ...
  methods: {
    filterProducts: function filterProducts() {
      if (this.selectedCity) {
        ...
        localStorage.setItem("provinceIndex", JSON.stringify(this.provinceIndex));
    ...
    checkLocationFilter: function checkLocationFilter() {
      ...
      this.$nextTick(function () {
        _this.provinceIndex = index ? index : "";
        _this.selectedProvince = province ? JSON.parse(province) : "";
        _this.selectedCity = city ? JSON.parse(city) : "";
        console.log(_this.selectedProvince, _this.selectedCity);
      });
    }
  },
  watch: {
    ...
    provinceIndex: function provinceIndex(index) {
      if (index && this.provinceList) {
        ...
        this.selectedProvince = this.provinceList[parseInt(index)];
