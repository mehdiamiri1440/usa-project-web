...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle() {
      ...
      if (this.$parent.superCategoryIndex) this.categoryTitle = isSuperCategory ? this.$parent.superCategories[index].category_name : this.$parent.categories[index].category_name;
    },
