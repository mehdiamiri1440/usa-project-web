...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    //   if (name === "") {
    //     this.errors.name.push("فیلد الزامی است");
    //     this.errorFlag = true;
    //   }
    //   if (!this.validateRegx(name, /^[\u0600-\u06FF\s]+$/)) {
    //     this.errors.name.push("فیلد باید فارسی باشد");
    //     this.errorFlag = true;
    //   }
    ...
    //       "Register-Error",
    //       "first-name",
    //       "input:" + name + " Error:" + this.errors.name[0]
    //     );
    //   }
    // },
    ...
    //   if (name === "") {
    //     this.errors.family.push("فیلد الزامی است");
    //     this.errorFlag = true;
    //   }
    //   if (!this.validateRegx(name, /^[\u0600-\u06FF\s]+$/)) {
    //     this.errors.family.push("فیلد باید فارسی باشد");
    //     this.errorFlag = true;
    //   }

    //   if (this.errors.family[0]) {
    //     this.registerComponentStatistics(
    //       "Register-Error",
    //       "last-name",
    //       "input:" + name + " Error:" + this.errors.family[0]
    //     );
    //   }
    // },
