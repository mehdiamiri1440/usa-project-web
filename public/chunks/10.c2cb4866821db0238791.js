...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_review_components_article_review__ = __webpack_require__(505);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    userAutorizeForReview: function userAutorizeForReview() {
      this.$parent.reviewUserPrfileId = this.profileOwner.user_info.id;
      $parent.getUserAutorizeForReview();
    }
  },
  mounted: function mounted() {
    this.init();
                  ...
                  _c("div", { staticClass: "user-contents row" }, [
                    _c("div", { staticClass: "title_content col-xs-12" }, [
                      _c(
                        ...
                        {
                          staticClass:
                            "back_page first-back col-xs-12 col-sm-4 col-lg-3"
                        },
                        [
                          _c(
                            "a",
                    ...
                    _c("div", { staticClass: "reviews-wrapper col-xs-12" }, [
                      _c("div", { staticClass: "header-reviews text-center" }, [
                        _c("div", { staticClass: "actions" }, [
                          _vm.$parent.reviewUserPrfileId || !_vm.isMyProfile
                            ? _c(
                                "button",
                                {
                                  staticClass: "add-review hover-effect rtl",
                                  on: {
                                    click: function($event) {
                                      $event.preventDefault()
                                ...
                                [
                                  _c("i", {
                                    staticClass: "fa fa-star yellow-text"
                                  }),
                                  _vm._v(" "),
