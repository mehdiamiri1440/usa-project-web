...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "title" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-xs-12 text-right col-sm-4 pull-right" }, [
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sort_modal_steps_step_listing__ = __webpack_require__(762);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sort_modal_steps_step_listing___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__sort_modal_steps_step_listing__);
//
//
//
//
...
// import FinalStep from "./sort-steps/final-step";

/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["list"],
  components: {
    SortContent: __WEBPACK_IMPORTED_MODULE_0__sort_modal_steps_step_listing___default.a
    // FinalStep
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    sendsort: function sendsort() {
      var self = this;
      self.sendLinkActive = false;
      axios.post("/send_user_sort", {
        sorted_id: self.sortedUserId,
        option_id: self.sortData.sortTitle,
        description: self.sortData.sortText
      }).then(function (response) {
        self.sendLinkActive = true;
        self.sortCurrentStep = 2;
      });
    },
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-48ef0688"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/dashboard/seller/request/sort-modal-steps/step-listing.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48ef0688", Component.options)
  } else {
    hotAPI.reload("data-v-48ef0688", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("b7bba52e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48ef0688\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./step-listing.vue", function() {
     var newContent = require("!!../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48ef0688\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./step-listing.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.form-check-wrapper[data-v-48ef0688] {\n  direction: rtl;\n}\n.report-form textarea[data-v-48ef0688] {\n  max-width: 600px;\n\n  margin: 0px auto;\n\n  height: 110px;\n\n  max-height: 170px;\n\n  border-radius: 5px;\n\n  direction: rtl;\n}\n.main-text[data-v-48ef0688] {\n  text-align: center;\n  /* margin: 20px 0 40px; */\n}\n.form-check-wrapper button[data-v-48ef0688] {\n  width: 100%;\n\n  border: none;\n\n  background: none;\n\n  border-bottom: 1px solid #eee;\n\n  text-align: right;\n\n  padding: 12px 15px 13px;\n}\n.form-check-wrapper button[data-v-48ef0688]:hover {\n  background: #fafafa;\n  cursor: pointer;\n}\n.form-check-wrapper li[data-v-48ef0688] {\n  position: relative;\n}\n.form-check-wrapper li:last-of-type button[data-v-48ef0688] {\n  border: none;\n}\n.form-check-wrapper li i[data-v-48ef0688] {\n  position: absolute;\n\n  top: 15px;\n\n  left: 20px;\n\n  font-size: 18px;\n\n  color: #777;\n}\n.loading-list[data-v-48ef0688] {\n  padding: 90px 0 130px;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router_router_js__ = __webpack_require__(7);
//
//
//
//
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48ef0688", module.exports)
  }
}
