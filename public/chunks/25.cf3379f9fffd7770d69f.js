...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    validateErrors: function validateErrors() {
      ...
      console.log("flag : " + this.errorFlag);
    },
...
var render = function() {
  ...
  return _c("div", { staticClass: "form-contents col-xs-12" }, [
    _c("div", { staticClass: "row" }, [
      ...
      _c("br"),
      _vm._v("\n    family : " + _vm._s(_vm.family)),
      _c("br"),
      _vm._v("\n    province : " + _vm._s(_vm.$parent.step3.province)),
      _c("br"),
      _vm._v("\n    city : " + _vm._s(_vm.$parent.step3.city)),
      _c("br"),
      _vm._v(
        "\n    activity_type : " + _vm._s(_vm.$parent.step4.activity_type)
      ),
      _c("br"),
      _vm._v("\n    category_id : " + _vm._s(_vm.$parent.step4.category_id)),
      _c("br"),
      _vm._v(
        "\n    errorFlag : " + _vm._s(!_vm.$parent.errorFlag) + "\n\n    "
      ),
      _c(
        "button",
        {
