...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    setMetaInfo: function setMetaInfo() {
      var productSubCategory = props.product.main.sub_category_name;
      var productName = props.product.main.product_name;
      var productCity = props.product.main.city_name;
      var productProvince = props.product.main.province_name;
      var productOwnerFullName = props.product.user_info.first_name + " " + props.product.user_info.last_name;
      var productStock = props.product.main.stock;
      var productDescription = props.product.main.description ? props.product.main.description.split("<hr/>").join("") : "";
      var pageUrl = props.getProductUrl();
