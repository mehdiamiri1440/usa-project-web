              ...
              _c("div", { staticClass: "item-header text-center" }, [
                ...
                _vm.statusData.active_pakage_type < 3
                  ? _c(
                      ...
                      {
                        staticClass:
                          "main-button white-text hover-effect bg-orange text-rtl",
                        on: {
                          click: function($event) {
              ...
              _c("div", { staticClass: "item-action" }, [
                _vm.statusData.active_pakage_type == 3
                  ...
                  ? _c(
                      "a",
                      {
                        staticClass: "main-button bg-gradient text-rtl",
                        attrs: { href: "" },
                        on: {
                          click: function($event) {
                            $event.preventDefault()
