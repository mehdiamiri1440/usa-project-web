...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__register_invited_user_steps_activity_type__ = __webpack_require__(958);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__register_invited_user_steps_location__ = __webpack_require__(945);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_device_uuid_lib_device_uuid__ = __webpack_require__(279);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    ActivityType: __WEBPACK_IMPORTED_MODULE_3__register_invited_user_steps_activity_type__["a" /* default */]
  },
  data: function data() {
    return {
      isMobile: false,
      ...
      if (!this.currentUser.user_info) {
        ...
        axios.post("/api/v1/users", object).then(function (response) {
          if (response.status === 201) {
            ...
            var deviceInfo = new __WEBPACK_IMPORTED_MODULE_5_device_uuid_lib_device_uuid___default.a.DeviceUUID();
            var deviceId = null;
            if (deviceInfo.get()) {
