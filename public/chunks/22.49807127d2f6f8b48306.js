...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1147835c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_masterRoute_vue__ = __webpack_require__(704);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_layouts_main_main_components_categories_modal_vue__ = __webpack_require__(898);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_layouts_header_header__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_layouts_footer_footer__ = __webpack_require__(700);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    CategoriesModal: __WEBPACK_IMPORTED_MODULE_0__components_layouts_main_main_components_categories_modal_vue__["a" /* default */],
    HeaderMasterLayouts: __WEBPACK_IMPORTED_MODULE_1__components_layouts_header_header__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c3b2457c_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_header_vue__ = __webpack_require__(698);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "main-loader" }, [
          _vm.submiting
            ? _c("img", {
                attrs: { src: __webpack_require__(699) }
              })
            : _vm._e(),
          _vm._v(" "),
                          ...
                          _vm._l(subCategory.subcategories, function(
                            ...
                            return _c(
                              "li",
                              {
                                key: index + "last-sub-menu",
                                staticClass: "col-xs-12",
                                class: [_vm.setSubMenuClass(subCategory, true)]
                              },
                              [
                                _c("router-link", {
                                  staticClass: "sub-menu-title",
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_99a05cfc_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_footer_vue__ = __webpack_require__(703);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    SubCategories: __WEBPACK_IMPORTED_MODULE_1__categories_steps_sub_categories_vue__["a" /* default */],
    LastStep: __WEBPACK_IMPORTED_MODULE_2__categories_steps_last_step_vue__["a" /* default */]
  },
  data: function data() {
    return {
      selectedCategory: {
  ...
  methods: {
    ...
    selectedCategoryItem: function selectedCategoryItem(category) {
      ...
      this.lastStepCategories = category.subcategories;
      this.currentStep + 1;
    }
  },
  mounted: function mounted() {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__router_router_js__["b" /* eventBus */].$on("reoprtModal", function ($event) {
      if ($event) {
  ...
  watch: {
    "loadReportOptions": function loadReportOptions(value) {
      if (value) {
        this.init();
      }
    }
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_node_modules_vue_loader_lib_selector_type_script_index_0_sub_categories_vue__["a" /* default */],
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        _vm.$parent.checkReportSubmit(
                          item.id,
                          item.is_description_needed
                        )
                      }
                    }
                  },
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_node_modules_vue_loader_lib_selector_type_script_index_0_last_step_vue__["a" /* default */],
...
// module
exports.push([module.i, "\n.main-text p[data-v-49f51be6] {\n  font-weight: 800;\n  font-size: 16px;\n  color: #474747;\n  text-align: center;\n  margin: 15px auto;\n}\n.main-text[data-v-49f51be6] {\n  text-align: center;\n  margin: 20px 0 40px;\n}\n.success-icon i[data-v-49f51be6] {\n  display: inline-block;\n\n  font-size: 55px;\n\n  color: #00c569;\n\n  border: 1px solid;\n\n  border-radius: 50px;\n\n  width: 90px;\n\n  height: 90px;\n\n  padding-top: 18px;\n}\np.small-text[data-v-49f51be6] {\n  padding: 15px;\n\n  color: #777;\n\n  font-size: 14px;\n\n  font-weight: 400;\n\n  direction: rtl;\n}\n@media screen and (max-width: 768px) {\n.success-icon[data-v-49f51be6] {\n    margin-top: 80px;\n}\n}\n", ""]);
