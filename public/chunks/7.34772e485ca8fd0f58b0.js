...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    checkDownloadAppCard: function checkDownloadAppCard() {
      //eventBus.$emit("checkDownloadAppCard", this.showDownloadAppCard);
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_5__router_router__["b" /* eventBus */].$on("textSearch", function (event) {
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        _vm.checkDownloadAppCard() ? _c("DownloadAppCard") : _vm._e(),
        _vm._v(" "),
