...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    uploadFiles: function uploadFiles() {
      ...
      data.append("image_" + 0, this.idCardFile);
      data.append("image_" + 1, this.userImageFile);
      data.append("image_" + 2, this.documetFile);
    ...
    imageValidator: function imageValidator(files) {
      ...
      if (files.length) {
        ...
        if (!errorsStatus) {
          ...
          this.$parent.documetFile = this.documentImageFile[0];
        }
      }
    },
    checkImageErrors: function checkImageErrors() {
