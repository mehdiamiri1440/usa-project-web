...
throw new Error("Cannot find module \"./node_modules/device-id/lib/device-id.js\"");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    var uuid = new __WEBPACK_IMPORTED_MODULE_5__node_modules_device_id_lib_device_id_js___default.a().get();
    console.log(uuid);
    this.init();
    this.imageParallax();
    this.isLoading = true;
