...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_personal_information_vue__ = __webpack_require__(801);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_personal_information_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__register_modal_steps_personal_information_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_modal_steps_register_number__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_modal_steps_register_number___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__register_modal_steps_register_number__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register_modal_steps_verified_code__ = __webpack_require__(811);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register_modal_steps_verified_code___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__register_modal_steps_verified_code__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    RegisterNumber: __WEBPACK_IMPORTED_MODULE_1__register_modal_steps_register_number___default.a,
    VerifiedCode: __WEBPACK_IMPORTED_MODULE_2__register_modal_steps_verified_code___default.a,
    PersonalInformation: __WEBPACK_IMPORTED_MODULE_0__register_modal_steps_personal_information_vue___default.a
  },
  data: function data() {
    return {
      currentStep: 2,
  ...
  methods: {
    sendVerificationCode: function sendVerificationCode() {
      ...
      axios.post("/send_verification_code", {
        ...
        _this.step1.sendCode = false;
        _this.goToStep(1);

        _this.step2.verification_code = "";
        _this.errors.verification_code = "";

        setTimeout(function () {
          _this.step2.reSendCode = true;
        }, 120000);

        _this.registerComponentStatistics("Register", "send-verification-code", "verification-code-sent-to-user");
      }).catch(function (err) {
        _this.step1.sendCode = false;

        _this.errors.phone = err.response.data.errors.phone;

        _this.step1.sendCode = false;

        _this.registerComponentStatistics("Register-Error", "phone-number-verification", "error:" + _this.errors.phone);
      });
    },
    verifyCode: function verifyCode() {
      ...
      axios.post("/verify_code", {
        ...
        _this2.step3.verifyCodeLoader = false;
        ...
        if (response.data.status === true) {
          ...
          _this2.errors.verification_code = "کد وارد شده صحیح نیست یا منقضی شده است";

          _this2.registerComponentStatistics("Register-Error", "verification-code-wrong", "error:" + _this2.errors.verification_code);
        }
      }).catch(function (error) {
        _this2.step3.verifyCodeLoader = false;

        _this2.goToStep(1);
        _this2.errors.verification_code = "وارد کردن کد الزامی است.";

        _this2.registerComponentStatistics("Register-Error", "verification-code-empty", "error:" + _this2.errors.verification_code);
      });
    },
    registerComponentStatistics: function registerComponentStatistics(categoryName, actionName, labelName) {
      gtag("event", actionName, {
  ...
  methods: {
    submitUserInformation: function submitUserInformation() {
      if (this.name && this.name.length < 2) {
        this.$parent.errors.name = "لطفا نام خود را به صورت کامل وارد کنید";
      } else if (!this.name) {
        this.$parent.errors.name = "لطفا نام خود را وارد کنید";
      }
      if (this.family && this.family.length < 2) {
        this.$parent.errors.family = "لطفا نام خانوادگی خود را به صورت کامل وارد کنید";
      } else if (!this.family) {
        this.$parent.errors.family = "لطفا نام خانوادگی خود را وارد کنید";
      }

      if (!this.$parent.errors.name && !this.$parent.errors.family && this.family.length >= 2 && this.name.length >= 3) {
    ...
    name: function name(text) {
      ...
      if (text) {
        ...
        if (error) {
          ...
          if (text == "باسکول" || text == "پشتیبانی" || text == "پشتیبان") {
            this.$parent.errors.name = "لطفا نام را به صورت صحیح وارد کنید";
          } else {
    ...
    family: function family(text) {
      ...
      if (text) {
        ...
        if (error) {
          ...
          if (text == "باسکول" || text == "پشتیبانی") {
            this.$parent.errors.family = "لطفا نام خانوادگی را به صورت صحیح وارد کنید";
          } else {
            ...
            _c("div", { staticClass: "col-xs-12 col-sm-6 pull-right" }, [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  this.name.length >= 3 && !_vm.$parent.errors.name
            ...
            _c("div", { staticClass: "col-xs-12 col-sm-6 pull-right" }, [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  this.family.length >= 2 && !_vm.$parent.errors.family
                    ? _c("i", { staticClass: "fa fa-check-circle" })
            ...
            _c("div", { staticClass: "modal-content" }, [
              ...
              _c(
                ...
                [
                  _vm.currentStep == 0
                    ? _c("RegisterNumber")
                    : _vm.currentStep == 1 ? _c("VerifiedCode") : _vm._e(),
                  _vm._v(" "),
                  _vm.currentStep == 2 ? _c("PersonalInformation") : _vm._e()
                ],
                1
              )
            ])
