...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router_router__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_components_main_register_request_form__ = __webpack_require__(471);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_components_landing_page_buyAds__ = __webpack_require__(767);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_components_landing_page_product_grid_article__ = __webpack_require__(772);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    checkPageWidth: function checkPageWidth() {
    ...
    productInViewPort: function productInViewPort() {
      ...
      $(window).scroll(function (scroll) {
        console.log($(window).scrollTop() + $(window).height() >= _this3.isElementOutViewport($("#product-section")), $(window).scrollTop() + $(window).height(), _this3.isElementOutViewport($("#product-section")));
        if (200 + $(window).scrollTop() + $(window).height() >= _this3.isElementOutViewport($("#product-section"))) {
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "green-button bg-light-green main-cta-page",
                        attrs: { to: { name: "productList" } }
                      },
                      [
