...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      ...
      console.log(this.currentUser.user_info.id, this.product.main.myuser_id);
      this.$nextTick(function () {
        if (_this.currentUser.user_info) {
          if (_this.currentUser.user_info.id === _this.product.main.myuser_id) {
            _this.isMyProfile = true;
            _this.$emit("isMyProfile", _this.isMyProfile);
          }
        }
      });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__layouts_main_product_components_product_article__ = __webpack_require__(393);
