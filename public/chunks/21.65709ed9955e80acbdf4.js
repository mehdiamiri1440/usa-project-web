            ...
            if (newFile && !oldFile) {
                ...
                if (newFile.file && newFile.type.substr(0, 6) === 'image/' && this.autoCompress > 0 && this.autoCompress < newFile.size) {
                    ...
                    imageCompressor.compress(newFile.file, Options).then(function (file) {
                        console.log(file);
                        self.$refs.upload.update(file, { error: '', file: file, size: file.size, type: file.type });

                        // console.log('file',file);
                        //     loadImage(
                        //     file,
                        //     { meta: true, canvas: true, maxWidth: 800,orientation:1 }
                        // ).then(function (data) {
                        ...
                        //     // console.log();
                        //     self.$refs.upload.update(blob, {error: '', file, size: file.size, type: file.type});
