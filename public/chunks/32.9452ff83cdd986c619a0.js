...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    filterBuyAd: function (_filterBuyAd) {
      function filterBuyAd() {
        return _filterBuyAd.apply(this, arguments);
      }

      filterBuyAd.toString = function () {
        return _filterBuyAd.toString();
      };
  ...
  return _c("div", { staticClass: "contact-body my-contacts" }, [
    ...
    _vm.buyAds.length === 0
      ...
      : _c("div", { staticClass: "contact-items buyad-lists-wrapper" }, [
          _vm.isSearchingBuyAds == true && _vm.buyAds.length === 0
            ? _c("div", [_vm._m(3)])
            : _c("div", [
                _c(
                  "ul",
