...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$on("messageCount", function (event) {
      _this2.messageCount += event;
    });
    __WEBPACK_IMPORTED_MODULE_0__router_router__["eventBus"].$on("active", function (event) {
            ...
            [
              _c(
                ...
                [
                  _c("img", {
                    attrs: {
                      src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../../img/vertical-promotion-text.gif\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
                      alt: "promotion text"
                    }
                  })
                ]
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "invite-box" }, [
      _c("div", { staticClass: "invite-image-wrapper pull-left" }, [
        _c("img", {
          attrs: {
            src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../../img/alert-image.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
            alt: "promotion text"
          }
        })
      ]),
  ...
  function() {
    ...
    return _c("div", { staticClass: "image-wrapper" }, [
      _c("img", {
        attrs: {
          src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../../../img/my-buskool.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
          alt: "my buskool"
        }
      })
    ])
