...
/* harmony import */ var _register_request_steps_start_register_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./register-request-steps/start-register-request */ "./resources/assets/js/components/dashboard/buyer/request/register-request-steps/start-register-request.vue");
/* harmony import */ var _register_request_steps_register_request_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register-request-steps/register-request-content */ "./resources/assets/js/components/dashboard/buyer/request/register-request-steps/register-request-content.vue");
/* harmony import */ var _register_request_steps_fnish_register_request_related__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register-request-steps/fnish-register-request-related */ "./resources/assets/js/components/dashboard/buyer/request/register-request-steps/fnish-register-request-related.vue");
/* harmony import */ var _register_request_steps_fnish_register_request__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./register-request-steps/fnish-register-request */ "./resources/assets/js/components/dashboard/buyer/request/register-request-steps/fnish-register-request.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    StartRegisterRequest: _register_request_steps_start_register_request__WEBPACK_IMPORTED_MODULE_1__.default,
    RegisterRequest: _register_request_steps_register_request_content__WEBPACK_IMPORTED_MODULE_2__.default,
    FinishRegisterRequestRelated: _register_request_steps_fnish_register_request_related__WEBPACK_IMPORTED_MODULE_3__.default,
    FinishRegisterRequest: _register_request_steps_fnish_register_request__WEBPACK_IMPORTED_MODULE_4__.default
  },
  data: function data() {
    return {
      currentStep: 1,
  ...
  methods: {
    ...
    submitBuyAd: function submitBuyAd() {
      this.errors = "";
      var self = this;
      _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("submitingEvent", true);
      var formData = this.getBuyAdFormFields();
      axios.post("/user/add_buyAd", formData).then(function (response) {
        if (response.status === 201) {
          self.disableSubmit = true;
          window.localStorage.removeItem("buyAd");
          _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("submitingEvent", false);
