...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["uploadName", "uploadAccept", "uploadMinSize", "uploadSize", "uploadMultiple", "uploadDropDirectory", "uploadAddIndex", "uploadThread", "uploadUploadAuto", "imageWrapperSize", "isCompressor", "isImageReset", "imageAccessUploadCount"],
  components: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__upload_image__ = __webpack_require__(373);
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("p", {
      staticClass: "upload-error margin-10-0 red-text col-xs-12",
      domProps: { textContent: _vm._s(_vm.errors.autorizationFiles) }
    }),
    _vm._v(" "),
    _c("div", { staticClass: "col-xs-12 text-left action-button-wrapper" }, [
      _c(
        "button",
        {
          ...
          class: {
            disabled:
              _vm.autorizationFiles.length < 1 || _vm.errors.autorizationFiles
          },
          on: {
            click: function($event) {
              $event.preventDefault()
