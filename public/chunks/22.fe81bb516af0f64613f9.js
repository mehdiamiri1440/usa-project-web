...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__category_filter__ = __webpack_require__(523);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    openChat: function openChat(buyAd, id) {
      var self = this;

      // let id = "#loader-" + buyAd.id;
      console.log(buyAd.id);
    ...
    hideReplyBtn: function hideReplyBtn(e, id) {
      ...
      //   $(id).show();
      // });
      console.log(id + " span:first-of-child", id);
      // $(id + " span:first-of-child").hide();
    },
  ...
  }), _defineProperty(_methods, "openCategoryModal", function openCategoryModal() {
    this.categoryModal = true;
    setTimeout(function () {
      $("#fitler-modal").modal("show");
    }, 200);
  }), _defineProperty(_methods, "filterBuyAdByCategory", function filterBuyAdByCategory() {
    var _this = this;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__filter_modal_steps_filter_content__ = __webpack_require__(527);
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { staticClass: "hover-effect" }, [
      _vm._v("\n                  پیام به خریدار\n                  "),
