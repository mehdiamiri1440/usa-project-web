...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      for (var i = 0; i < self.priceItem.priceItems.length; i++) {
        $(".product-pricing .item-wrapper").prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + self.priceItem.priceItems[i].helpDescription + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
        $(".item-guid").tooltip();
      }
      $(".product-pricing .item-wrapper").each(function (index) {
        // console.log(self.priceItem, index);
        // $(this).prepend(
        //   " <button" +
        //     ' class="item-guid"' +
        //     ' data-toggle="tooltip"' +
