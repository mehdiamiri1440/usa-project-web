...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteComment: function deleteComment() {
      ...
      this.$parent.doDeleteComment = true;
      axios.post("/profile/delete-user-comment", {
        c_id: this.review.c_id
      }).then(function (response) {
        console.log("delete");
        _this.$parent.doDeleteComment = false;
                  ...
                  _c("div", { staticClass: "delete-comment-wrapper" }, [
                    _c(
                      "button",
                      {
                        ...
                        class: { "disable-text ": _vm.$parent.doDeleteComment },
                        attrs: { disabled: _vm.$parent.doDeleteComment },
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            _vm.deleteComment()
