...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    $(".product-pricing .item-wrapper").each(function (index, element) {
      console.log(self.priceItem.priceItems[index], index);

      $(element).prepend(" <button" + ' class="item-guid"' + ' data-toggle="tooltip"' + ' data-placement="bottom"' + ' title="' + "this is text" + '"' + " >" + ' <i class="fa fa-question"></i>' + " </button>");
      $(".item-guid").tooltip();
    });
    // });
  }
