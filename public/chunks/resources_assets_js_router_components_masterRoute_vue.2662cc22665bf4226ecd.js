...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {// elevatorText: {
    //   get() {
    //     return this.$state.routeStore.elevatorText;
    //   },
    //   set(newValue) {
    //     this.$state.commit("routeStore/elevatorText",newValue);
    //   },
    // },
  },
  methods: {
