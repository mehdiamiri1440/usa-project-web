...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    "currentUser.profile.address": function currentUserProfileAddress(value) {
      ...
      if (this.textValidator(value) == true) this.errors.address = "آدرس شامل حروف غیرمجاز است";
    },
    "currentUser.profile.description": function currentUserProfileDescription(value) {
      this.errors.description = "";

      if (this.textValidator(value) == true) this.errors.description = "توضیحات شامل حروف غیرمجاز است";
    }
  }
});
