...
/* harmony import */ var _register_product_steps_product_category__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./register-product-steps/product_category */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/product_category.vue");
/* harmony import */ var _register_product_steps_start_register_product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register-product-steps/start_register_product */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/start_register_product.vue");
/* harmony import */ var _register_product_steps_stock_and_price__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register-product-steps/stock_and_price */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/stock_and_price.vue");
/* harmony import */ var _register_product_steps_location__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./register-product-steps/location */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/location.vue");
/* harmony import */ var _register_product_steps_product_image__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./register-product-steps/product_image */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/product_image.vue");
/* harmony import */ var _register_product_steps_terms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./register-product-steps/terms */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/terms.vue");
/* harmony import */ var _register_product_steps_more_details__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./register-product-steps/more_details */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/more_details.vue");
/* harmony import */ var _register_product_steps_finish_stage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./register-product-steps/finish_stage */ "./resources/assets/js/components/dashboard/seller/product/register-product-steps/finish_stage.vue");
/* harmony import */ var _imageuploadify_min__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../imageuploadify.min */ "./resources/assets/js/imageuploadify.min.js");
/* harmony import */ var _imageuploadify_min__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_imageuploadify_min__WEBPACK_IMPORTED_MODULE_9__);
var _methods;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ProductCategory: _register_product_steps_product_category__WEBPACK_IMPORTED_MODULE_1__.default,
    StartRegisterProduct: _register_product_steps_start_register_product__WEBPACK_IMPORTED_MODULE_2__.default,
    StockAndPrice: _register_product_steps_stock_and_price__WEBPACK_IMPORTED_MODULE_3__.default,
    Location: _register_product_steps_location__WEBPACK_IMPORTED_MODULE_4__.default,
    ProductImage: _register_product_steps_product_image__WEBPACK_IMPORTED_MODULE_5__.default,
    Terms: _register_product_steps_terms__WEBPACK_IMPORTED_MODULE_6__.default,
    MoreDetails: _register_product_steps_more_details__WEBPACK_IMPORTED_MODULE_7__.default,
    FinishStage: _register_product_steps_finish_stage__WEBPACK_IMPORTED_MODULE_8__.default
  },
  data: function data() {
    return {
      currentStep: 0,
  ...
  methods: (_methods = {
    ...
    startRegisterProductSubmited: function startRegisterProductSubmited() {
      ...
      axios.post("/is_user_allowed_to_register_product").then(function (response) {
        ...
        if (self.limited.isLimited) {
          _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("modal", "registerProductLimit");
        } else {
          _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("buyAdbuttonActive", false);
          self.goToStep(1);
        }
      });
    },
    ...
    submitProduct: function submitProduct() {
      _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("submiting", true);
      var self = this;
      ...
      if (this.product.rules !== true) {
        ...
        _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("submiting", false);
  ...
  watch: {
    uploadPercentage: function uploadPercentage() {
      _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("uploadPercentage", this.uploadPercentage);
    },
