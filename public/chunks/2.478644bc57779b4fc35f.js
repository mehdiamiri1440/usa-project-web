  ...
  return _c("div", { staticClass: "register-product" }, [
    ...
    _c("div", { staticClass: "register-product-content" }, [
      _c("ul", { staticClass: "progressbar" }, [
        _vm._v('" :class="[{\'is-active\' : currentStep > 0}]">'),
        _vm._v(" "),
        _c("li", { class: [{ active: _vm.currentStep >= 1 }] }),
        _vm._v(" "),
