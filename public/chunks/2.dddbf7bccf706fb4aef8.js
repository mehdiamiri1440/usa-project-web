...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle(index, isCategory) {

      this.categoryTitle = isCategory ? this.$parent.superCategories[index] : this.$parent.categories[index];
    },
