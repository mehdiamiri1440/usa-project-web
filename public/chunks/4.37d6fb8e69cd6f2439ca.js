...
var map = {
	...
	"./masterRoute.vue": 557,
	"./review-component/review-steps/review-step copy.vue": 634,
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7120e0e2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/router/components/review-component/review-steps/review-step copy.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7120e0e2", Component.options)
  } else {
    hotAPI.reload("data-v-7120e0e2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("e822f08a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7120e0e2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./review-step copy.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7120e0e2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./review-step copy.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.rate[data-v-7120e0e2] {\n  padding: 0px;\n\n  margin: 0 auto;\n\n  overflow: hidden;\n\n  width: 361px;\n}\n.rate:not(:checked) > input[data-v-7120e0e2] {\n  position: absolute;\n  top: -9999px;\n}\n.rate:not(:checked) > label[data-v-7120e0e2] {\n  float: left;\n\n  width: 1.1em;\n\n  overflow: hidden;\n\n  white-space: nowrap;\n\n  cursor: pointer;\n\n  font-size: 32px;\n\n  color: #ccc;\n\n  text-align: center;\n\n  height: 36px;\n\n  /* margin-left: 3px; */\n}\n.rate:not(:checked) > label[data-v-7120e0e2]:before {\n  /* content: '★ '; */\n  content: \"\\F005\";\n  font-family: \"Font Awesome 5 Free\";\n  font-weight: 900;\n}\n.rate > input:checked ~ label[data-v-7120e0e2] {\n  color: #ffc700;\n}\n.rate:not(:checked) > label[data-v-7120e0e2]:hover,\n.rate:not(:checked) > label:hover ~ label[data-v-7120e0e2] {\n  color: #deb217;\n}\n.rate > input:checked + label[data-v-7120e0e2]:hover,\n.rate > input:checked + label:hover ~ label[data-v-7120e0e2],\n.rate > label:hover ~ input:checked ~ label[data-v-7120e0e2] {\n  color: #c59b08;\n}\n.rate label[data-v-7120e0e2]::after {\n  position: relative;\n\n  color: #777;\n\n  font-size: 15px;\n\n  top: -27px;\n\n  width: 100%;\n\n  text-align: center;\n\n  display: block;\n}\n#lable-star10[data-v-7120e0e2]::after {\n  content: \"10\";\n}\n#lable-star9[data-v-7120e0e2]::after {\n  content: \"9\";\n}\n#lable-star8[data-v-7120e0e2]::after {\n  content: \"8\";\n}\n#lable-star7[data-v-7120e0e2]::after {\n  content: \"7\";\n}\n#lable-star6[data-v-7120e0e2]::after {\n  content: \"6\";\n}\n#lable-star5[data-v-7120e0e2]::after {\n  content: \"5\";\n}\n#lable-star4[data-v-7120e0e2]::after {\n  content: \"4\";\n}\n#lable-star3[data-v-7120e0e2]::after {\n  content: \"3\";\n}\n#lable-star2[data-v-7120e0e2]::after {\n  content: \"2\";\n}\n#lable-star1[data-v-7120e0e2]::after {\n  content: \"1\";\n}\n.report-form[data-v-7120e0e2] {\n  background: #fafafa;\n  padding: 15px;\n  direction: rtl;\n}\n.report-form textarea[data-v-7120e0e2] {\n  max-width: 450px;\n  margin: 0px auto;\n  height: 90px;\n  max-height: 150px;\n  border-radius: 5px;\n}\n.main-text p[data-v-7120e0e2] {\n  font-weight: 800;\n  font-size: 16px;\n  color: #474747;\n  text-align: center;\n  margin: 15px auto;\n}\n.main-text[data-v-7120e0e2] {\n  text-align: center;\n  margin: 20px 0 40px;\n}\n.buttons-wrapper .green-button[data-v-7120e0e2] {\n  background: #fff;\n\n  color: #777;\n\n  border: 1px solid #00c569;\n\n  font-size: 16px;\n\n  font-weight: bold;\n\n  padding: 5px 40px;\n\n  margin: 15px;\n}\n.buttons-wrapper .green-button[data-v-7120e0e2]:hover {\n  background: #00c569;\n\n  color: #fff;\n\n  border: 1px solid #00c569;\n}\n.buttons-wrapper .review-button[data-v-7120e0e2] {\n  background: #00c569;\n  color: #fff;\n}\n.review-button i[data-v-7120e0e2] {\n  color: #ffbb00;\n}\n", ""]);
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.reportFormData,
                expression: "reportFormData"
              }
            ],
            attrs: { placeholder: "شکایت خود را بنویسید" },
            domProps: { value: _vm.reportFormData },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.reportFormData = $event.target.value
              }
            }
          }),
          _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "rate" }, [
      _c("input", {
        attrs: { type: "radio", id: "star10", name: "rate", value: "10" }
      }),
      _vm._v(" "),
      _c(
        "label",
        { attrs: { id: "lable-star10", for: "star10", title: "text" } },
        [_vm._v("10 stars")]
      ),
      _vm._v(" "),
      _c("input", {
        attrs: { type: "radio", id: "star9", name: "rate", value: "9" }
      }),
      _vm._v(" "),
      _c(
        "label",
        { attrs: { id: "lable-star9", for: "star9", title: "text" } },
        [_vm._v("9 stars")]
      ),
      _vm._v(" "),
      _c("input", {
        attrs: { type: "radio", id: "star8", name: "rate", value: "8" }
      }),
      _vm._v(" "),
      _c(
        "label",
        { attrs: { id: "lable-star8", for: "star8", title: "text" } },
        [_vm._v("8 stars")]
      ),
      _vm._v(" "),
      _c("input", {
        attrs: { type: "radio", id: "star7", name: "rate", value: "7" }
      }),
      _vm._v(" "),
      _c(
        "label",
        { attrs: { id: "lable-star7", for: "star7", title: "text" } },
        [_vm._v("7 stars")]
      ),
      _vm._v(" "),
      _c("input", {
        attrs: { type: "radio", id: "star6", name: "rate", value: "6" }
      }),
      _vm._v(" "),
      _c(
        "label",
        { attrs: { id: "lable-star6", for: "star6", title: "text" } },
        [_vm._v("6 stars")]
      ),
      _vm._v(" "),
      _c("input", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7120e0e2", module.exports)
  }
}
