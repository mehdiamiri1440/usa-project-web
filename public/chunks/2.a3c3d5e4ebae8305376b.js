...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_wow__ = __webpack_require__(491);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_components_main_register_request_form__ = __webpack_require__(442);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_components_product_list_carousel__ = __webpack_require__(406);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    init: function init() {
      ...
      axios.post("/get-phone-number", {}).then(function (response) {
        // self.lastProducts = response.data.products;
      });
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "main-loader" }, [
      _c("img", { attrs: { src: __webpack_require__(399) } })
    ])
  },
  function() {
    var _vm = this
