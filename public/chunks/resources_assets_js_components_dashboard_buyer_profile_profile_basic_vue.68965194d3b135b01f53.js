...
/* harmony import */ var _upload_image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../upload-image */ "./resources/assets/js/components/dashboard/upload-image.vue");
...
/* harmony import */ var _imageuploadify_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../imageuploadify.min */ "./resources/assets/js/imageuploadify.min.js");
/* harmony import */ var _imageuploadify_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_imageuploadify_min__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ["str", "assets"],
  components: {
    UploadFile: _upload_image__WEBPACK_IMPORTED_MODULE_1__.default
  },
  data: function data() {
    return {
      currentUser: {
      ...
      if (!formError) {
        ...
        axios.post("/user/profile_modification", data, {
          ...
          if (response.status === 200) {
            ...
            _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("modal", "profileEditSuccess");
  ...
  mounted: function mounted() {
    this.init();
    _router_router__WEBPACK_IMPORTED_MODULE_0__.eventBus.$emit("subHeader", this.items);
    var self = this;
