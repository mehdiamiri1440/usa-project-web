...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle(index) {
      var isSuperCategory = false;
      this.categoryTitle = isSuperCategory ? this.$parent.superCategories[index].category_name : this.$parent.categories[index].category_name;
    },
