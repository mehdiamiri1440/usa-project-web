    ...
    infiniteScrollHandler: function infiniteScrollHandler() {
      ...
      $(window).scroll(function () {
        ...
        if ($(window).scrollTop() + $(window).height() >= productsSection.offset().top) {
          console.log(_this3.products.length <= 12, !_this3.loadMoreActive, _this3.continueToLoadProducts, _this3.products.length <= 12 && !_this3.loadMoreActive && _this3.continueToLoadProducts);
