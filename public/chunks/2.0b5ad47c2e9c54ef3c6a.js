...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    formValidator: function formValidator() {
      ...
      console.log(!this.errors.categorySelected && !this.errors.selectedMainSubCategory && !this.errors.sub_category_id && !this.errors.name && !this.errors.requirement_amount);
