...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_methods, "getSubCategoryUrl", function getSubCategoryUrl(t) {
    var url = "/product-list/category/" + t.category_name.split(" ").join("-");
    return url;
  }), _defineProperty(_methods, "openCategoriesModal", function openCategoriesModal(categoryId) {
                          ...
                          return _c(
                            ...
                            [
                              _c("router-link", {
                                ...
                                attrs: {
                                  tag: "button",
                                  to: _vm.getSubCategoryUrl(_vm.subCategory)
                                },
                                domProps: {
