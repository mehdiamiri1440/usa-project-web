...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_658de808_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_vue__ = __webpack_require__(967);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_steps_register_number__ = __webpack_require__(955);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register_steps_verify_code__ = __webpack_require__(959);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__register_steps_complementary_info_vue__ = __webpack_require__(963);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    validateErrors: function validateErrors() {
      if (this.step3.name.length && this.step3.family.length && this.errors.name == "" && this.errors.family == "" && this.step3.province && this.step3.city && this.step4.activity_type !== "" && this.step4.category_id !== "") {
    ...
    firstNameValidator: function firstNameValidator(name) {
      ...
      if (this.errors.name) {
        this.registerComponentStatistics("Register-Error", "first-name", "input:" + name + " Error:" + this.errors.name);
      }
    },
    lastNameValidator: function lastNameValidator(family) {
      ...
      if (this.errors.family) {
        this.registerComponentStatistics("Register-Error", "last-name", "input:" + family + " Error:" + this.errors.family);
      }
    },
    ...
    provinceValidator: function provinceValidator(province) {
      ...
      if (this.errors.province) {
        this.registerComponentStatistics("Register-Error", "province", "input:" + province + " Error:" + this.errors.province);
      }
    },
    cityValidator: function cityValidator(city) {
      ...
      if (this.errors.city) {
        this.registerComponentStatistics("Register-Error", "city", "input:" + city + " Error:" + this.errors.city);
      }
    },
    ...
    categoryIdValidator: function categoryIdValidator(categoryId) {
      ...
      if (this.errors.category_id) {
        this.registerComponentStatistics("Register-Error", "category-selection", "input:" + categoryId + " Error:" + this.errors.category_id);
      }
    },
    activityTypeValidator: function activityTypeValidator(activityType) {
      ...
      if (this.errors.activity_type) {
        this.registerComponentStatistics("Register-Error", "activity-type", "input:" + activityType + " Error:" + this.errors.activity_type);
      }
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3ff8bdc6_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_register_number_vue__ = __webpack_require__(958);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7016fd54_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_verify_code_vue__ = __webpack_require__(962);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8e3cdb54_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_complementary_info_vue__ = __webpack_require__(966);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
    ...
    _c("div", { staticClass: "row" }, [
      ...
      _vm._v(
        "\n    " +
          ...
          _vm._s(_vm.family) +
          "\n    " +
          _vm._s(_vm.$parent.errors.name) +
          "\n    " +
          _vm._s(_vm.$parent.errors.family) +
          "\n    " +
          _vm._s(_vm.$parent.step3) +
          "\n    " +
          _vm._s(_vm.$parent.step3) +
          "\n    " +
          _vm._s(_vm.$parent.step4.activity_type) +
          "\n    " +
          _vm._s(_vm.$parent.step4.category_id) +
          "\n\n    "
      ),
      _c(
        "button",
