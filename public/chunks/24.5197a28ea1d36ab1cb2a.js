...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9d851ee8_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_dashboard_pricing_table_vue__ = __webpack_require__(567);
    ...
    setPricingHeaderScroll: function setPricingHeaderScroll() {
      ...
      $(window).scroll(function () {
        if (_this.$route.name == "dashboardPricingTableSeller" || _this.$route.name == "dashboardProductPricing" || _this.$route.name == "dashboardBuyAdPricing") {
          if ($(window).scrollTop() >= pricingHeaderTop) {
            console.log('yeesss this is ssss');
          }
        }
      });
    },
