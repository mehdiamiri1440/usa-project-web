...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    "profileOwnerStatistics.rating_info.avg_score": function profileOwnerStatisticsRating_infoAvg_score(value) {
      this.profileOwnerStatistics.rating_info.avg_score = Math.floor(value);
    }
  },
