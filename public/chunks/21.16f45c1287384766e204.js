...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: { pricingUserCarowsel: __WEBPACK_IMPORTED_MODULE_0__pricing_user_carowsel___default.a },
  data: function data() {
    return {
      statusData: "",
...
var render = function() {
  ...
  return _c("div", { staticClass: "col-xs-12" }, [
    _c("div", { staticClass: "row" }, [
      ...
      _c(
        "div",
        { staticClass: "users-review-carowsel-wrapper" },
        _vm._l(1, function(item, index) {
          return _c("pricing-user-carowsel", {
            key: index,
            attrs: { img: "image", title: "محمدامین دلداری", city: "iran" }
          })
        })
      ),
      _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["img", "title", "city", "column", "autoPlay"],
  mounted: function mounted() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "carousel-img", attrs: { to: _vm.link } }, [
        _c(
          "div",
          {
            directives: [
