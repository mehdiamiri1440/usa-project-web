...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["uploadName", "uploadAccept", "uploadMinSize", "uploadSize", "uploadMultiple", "uploadDropDirectory", "uploadAddIndex", "uploadThread", "uploadUploadAuto", "imageWrapperSize", "isCompressor"],
  components: {
  ...
  watch: {
    ...
    "this.$parent[this.uploadName]": function this$parentThisUploadName(value) {
      if (!value) {
        this.files = [];
      }
    },
