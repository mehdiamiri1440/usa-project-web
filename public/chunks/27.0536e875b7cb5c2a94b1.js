...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_737cf44b_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_buyad_pricing_vue__ = __webpack_require__(573);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setPricingHeaderScroll: function setPricingHeaderScroll() {
      ...
      var pricingHeaderTop = $(".tab-action-wrapper.page-type").offset().top;
      ...
      $(window).scroll(function () {
        if (_this.$route.name == "dashboardPricingTableSeller" || _this.$route.name == "dashboardProductPricing" || _this.$route.name == "dashboardBuyAdPricing") {
          if ($(window).scrollTop() >= ($(document).height() - $(window).height() - 100) / 2 && !_this.loadMoreActive && _this.continueToLoadProducts) {
            _this.feed();
          }
        }
      });
