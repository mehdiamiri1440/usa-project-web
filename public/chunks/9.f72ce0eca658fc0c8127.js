...
var update = __webpack_require__(6)("62d56b6f", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_steps_register_number__ = __webpack_require__(518);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register_steps_verify_code__ = __webpack_require__(523);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__register_steps_personal_information__ = __webpack_require__(528);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__register_steps_location__ = __webpack_require__(533);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__register_steps_user_account__ = __webpack_require__(538);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__register_steps_activity_domain__ = __webpack_require__(543);
            ...
            if (this.errorFlag === false) {
                axios.post("api/v1/users", object).then(function (response) {
                    if (response.status === 201) {
                        self.popUpMsg = "ثبت نام با موفقیت انجام شد.کمی صبر کنید ...";
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("fd1330a0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("35b1f762", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("54cc8c78", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("6b4ec7f0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("39f761f9", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    rePassword: function rePassword(value) {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "form-contents col-xs-12" }, [
      _c("div", { staticClass: "row" }, [
        ...
        _c(
          "div",
          { staticClass: "input-wrapper col-xs-12 user-name-wrapper" },
          [
            _c("div", { staticClass: "row" }, [
              _c("input", {
                directives: [
                ...
                staticClass: "dire",
                class: {
                  error: _vm.$parent.errors.user_name[0],
                  active: _vm.userName.length >= 3
                },
                attrs: {
                  id: "user-name",
                  type: "text",
            ...
            _vm._v(" "),
            _c("p", { staticClass: "error-message" }, [
              _vm.$parent.errors.user_name[0]
                ? _c("span", {
                    domProps: {
                      textContent: _vm._s(_vm.$parent.errors.user_name[0])
                    }
                  })
                : _vm._e()
            ])
          ...
          _c("div", { staticClass: "col-xs-6" }, [
            ...
            _c("div", { staticClass: "input-wrapper password-wrapper" }, [
              _c("input", {
                ...
                staticClass: "dire",
                class: {
                  error: _vm.$parent.errors.password_conf[0],
                  active: _vm.rePassword.length
                },
                attrs: {
                  id: "re-password",
                  type: "password",
              ...
              _vm._v(" "),
              _c("p", { staticClass: "error-message" }, [
                _vm.$parent.errors.password_conf[0]
                  ? _c("span", {
                      domProps: {
                        textContent: _vm._s(_vm.$parent.errors.password_conf[0])
                      }
                    })
                  : _vm._e()
              ])
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("3e5ecfc6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
