...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["defultimg", "logo", "storage", "logout", "userId", "searchText"],
  data: function data() {
    return {
      menuClosed: false,
      isLoading: true,
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["assets", "user_id", "is_seller", "profile_photo", "user_full_name", "user_logout_path", "storage_path", "login_page_path", "finish_load_img"],
  methods: {
    // jQuery
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "main-loader" }, [
      _c("img", { attrs: { src: __webpack_require__(743) } }),
      _vm._v(" "),
      _c("p", { attrs: { dir: "rtl" } }, [_vm._v("در حال بارگذاری...")])
    ])
  },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["defultimg", "logo", "storage", "logout", "userId"],
  data: function data() {
    return {
      showSnapShot: false,
      menuClosed: false,
