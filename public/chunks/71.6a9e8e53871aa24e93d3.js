...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    price: function (_price) {
      ...
      _this.priceError = "";
      var number = _this.toLatinNumbers(price);
      if (_this.validateRegx(number, /^\d*$/)) {
        _this.priceError = "لطفا  فقط عدد وارد کنید";
      } else {
        _this.price = _this.getNumberWithCommas(number);
      }
    })
  }
});
