          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.product.max_alePrice,
              expression: "$parent.product.max_alePrice"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "مثلا : ۵۰٬۰۰۰" },
          domProps: { value: _vm.$parent.product.max_alePrice },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent.product, "max_alePrice", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
