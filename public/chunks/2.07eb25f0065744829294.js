...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    setCategoryTitle: function setCategoryTitle() {
      this.categoryTitle = this.$parent.superCategoryIndex || this.$parent.superCategoryIndex == 0 ? this.$parent.superCategories[this.$parent.superCategoryIndex].category_name : this.$parent.categories[this.$parent.categoryIndex].category_name;
    },
