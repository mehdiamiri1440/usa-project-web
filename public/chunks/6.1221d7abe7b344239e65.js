...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    openChatModal: function openChatModal(product) {
      ...
      console.log("in open modal chat");
      console.log(this.isUserLogin, product.user_info.id);
      console.log(this.isUserLogin !== product.user_info.id);
  ...
  return _c(
    ...
    [
      !_vm.updatedCurrentUser.user_info
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("h1", { attrs: { id: "test-view-detail" } }, [
        _vm._v("\n    " + _vm._s(_vm.isUserLogin) + "\n  ")
      ]),
      _vm._v(" "),
