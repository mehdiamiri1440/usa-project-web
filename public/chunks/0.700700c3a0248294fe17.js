  ...
  data: function data() {
    return {
      ...
      step2: {
        ...
        now: null,
        verification: {
          verifycode1: this.$parent.verification_code.substring(0, 1),
          verifycode2: this.$parent.verification_code.substring(1, 2),
          verifycode3: this.$parent.verification_code.substring(2, 3),
          verifycode4: this.$parent.verification_code.substring(3, 4),
          currentCode: ""
        }
      },
  ...
  methods: {
    ...
    verify_code: function verify_code() {
      ...
      axios.post("/verify_code", {
        verification_code: this.toLatinNumbers(this.$parent.verification_code),
        phone: this.toLatinNumbers(this.step1.phoneNumber)
      }).then(function (response) {
        self.verifyCodeBtnLoading = false;
