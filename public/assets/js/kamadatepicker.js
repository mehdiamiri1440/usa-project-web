...
var kamaDatepicker = function (elementID, opt) {
    ...
    titleDiv.append("<button id='bd-next-" + elementID + "' class='bd-next' type='button' title='ماه بعدی' data-toggle='tooltip'><i class='fa fa-angle-right'> </i></button>");
    ...
    titleDiv.append("<button id='bd-prev-" + elementID + "' class='bd-prev' type='button' title='ماه قبلی' data-toggle='tooltip'><i class='fa fa-angle-left'> </i></button>");
