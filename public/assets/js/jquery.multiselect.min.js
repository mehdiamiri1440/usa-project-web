...
(function ($, undefined) {
    ...
    $.widget("ech.multiselect", {
        options: {
            ...
            noneSelectedText: "لطفا انتخاب کنید",
            showCheckAll: true,
            showUncheckAll: true,
            ...
            this.menu = $("<div />").addClass("ui-multiselect-menu ui-widget ui-widget-content ui-corner-all").addClass(o.classes).appendTo(this._getAppendEl());
